var is=Object.defineProperty;var xt=e=>{throw TypeError(e)};var ls=(e,t,s)=>t in e?is(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var k=(e,t,s)=>ls(e,typeof t!="symbol"?t+"":t,s),gt=(e,t,s)=>t.has(e)||xt("Cannot "+s);var p=(e,t,s)=>(gt(e,t,"read from private field"),s?s.call(e):t.get(e)),C=(e,t,s)=>t.has(e)?xt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w=(e,t,s,a)=>(gt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),R=(e,t,s)=>(gt(e,t,"access private method"),s);var vt=(e,t,s,a)=>({set _(n){w(e,t,n,s)},get _(){return p(e,t,a)}});var wt=(e,t,s)=>(a,n)=>{let o=-1;return r(0);async function r(i){if(i<=o)throw new Error("next() called multiple times");o=i;let l,d=!1,c;if(e[i]?(c=e[i][0][0],a.req.routeIndex=i):c=i===e.length&&n||void 0,c)try{l=await c(a,()=>r(i+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&s&&(l=await s(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},ds=Symbol(),cs=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,o=(e instanceof jt?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?ms(e,{all:s,dot:a}):{}};async function ms(e,t){const s=await e.formData();return s?ps(s,t):{}}function ps(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?gs(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(us(s,a,n),delete s[a])}),s}var gs=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},us=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((o,r)=>{r===n.length-1?a[o]=s:((!a[o]||typeof a[o]!="object"||Array.isArray(a[o])||a[o]instanceof File)&&(a[o]=Object.create(null)),a=a[o])})},Dt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},hs=e=>{const{groups:t,path:s}=fs(e),a=Dt(s);return ys(a,t)},fs=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},ys=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},ot={},bs=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return ot[a]||(s[2]?ot[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:ot[a]=[e,s[1],!0]),ot[a]}return null},yt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},xs=e=>yt(e,decodeURI),Pt=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const o=t.indexOf("?",a),r=t.slice(s,o===-1?void 0:o);return xs(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(n===63)break}return t.slice(s,a)},vs=e=>{const t=Pt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},je=(e,t,...s)=>(s.length&&(t=je(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ot=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const o=n.replace("?","");a+="/"+o,s.push(a)}else a+="/"+n}),s.filter((n,o,r)=>r.indexOf(n)===o)},ut=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?yt(e,Ut):e):e,Bt=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const i=e.charCodeAt(r+t.length+1);if(i===61){const l=r+t.length+2,d=e.indexOf("&",l);return ut(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";r=e.indexOf(`&${t}`,r+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const r=e.indexOf("&",o+1);let i=e.indexOf("=",o);i>r&&r!==-1&&(i=-1);let l=e.slice(o+1,i===-1?r===-1?void 0:r:i);if(a&&(l=ut(l)),o=r,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,r===-1?void 0:r),a&&(d=ut(d))),s?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},ws=Bt,ks=(e,t)=>Bt(e,t,!0),Ut=decodeURIComponent,kt=e=>yt(e,Ut),We,ne,ye,Ft,Ht,ft,xe,Lt,jt=(Lt=class{constructor(e,t="/",s=[[]]){C(this,ye);k(this,"raw");C(this,We);C(this,ne);k(this,"routeIndex",0);k(this,"path");k(this,"bodyCache",{});C(this,xe,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,w(this,ne,s),w(this,We,{})}param(e){return e?R(this,ye,Ft).call(this,e):R(this,ye,Ht).call(this)}query(e){return ws(this.url,e)}queries(e){return ks(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await cs(this,e))}json(){return p(this,xe).call(this,"text").then(e=>JSON.parse(e))}text(){return p(this,xe).call(this,"text")}arrayBuffer(){return p(this,xe).call(this,"arrayBuffer")}blob(){return p(this,xe).call(this,"blob")}formData(){return p(this,xe).call(this,"formData")}addValidatedData(e,t){p(this,We)[e]=t}valid(e){return p(this,We)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ds](){return p(this,ne)}get matchedRoutes(){return p(this,ne)[0].map(([[,e]])=>e)}get routePath(){return p(this,ne)[0].map(([[,e]])=>e)[this.routeIndex].path}},We=new WeakMap,ne=new WeakMap,ye=new WeakSet,Ft=function(e){const t=p(this,ne)[0][this.routeIndex][1][e],s=R(this,ye,ft).call(this,t);return s&&/\%/.test(s)?kt(s):s},Ht=function(){const e={},t=Object.keys(p(this,ne)[0][this.routeIndex][1]);for(const s of t){const a=R(this,ye,ft).call(this,p(this,ne)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?kt(a):a)}return e},ft=function(e){return p(this,ne)[1]?p(this,ne)[1][e]:e},xe=new WeakMap,Lt),Es={Stringify:1},Wt=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(n?n[0]+=e:n=[e],Promise.all(o.map(i=>i({phase:t,buffer:n,context:a}))).then(i=>Promise.all(i.filter(Boolean).map(l=>Wt(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},Cs="text/plain; charset=UTF-8",ht=(e,t)=>({"Content-Type":e,...t}),Xe,Je,ge,$e,ue,X,et,Ge,Ke,Ne,tt,st,ve,Fe,At,Ss=(At=class{constructor(e,t){C(this,ve);C(this,Xe);C(this,Je);k(this,"env",{});C(this,ge);k(this,"finalized",!1);k(this,"error");C(this,$e);C(this,ue);C(this,X);C(this,et);C(this,Ge);C(this,Ke);C(this,Ne);C(this,tt);C(this,st);k(this,"render",(...e)=>(p(this,Ge)??w(this,Ge,t=>this.html(t)),p(this,Ge).call(this,...e)));k(this,"setLayout",e=>w(this,et,e));k(this,"getLayout",()=>p(this,et));k(this,"setRenderer",e=>{w(this,Ge,e)});k(this,"header",(e,t,s)=>{this.finalized&&w(this,X,new Response(p(this,X).body,p(this,X)));const a=p(this,X)?p(this,X).headers:p(this,Ne)??w(this,Ne,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});k(this,"status",e=>{w(this,$e,e)});k(this,"set",(e,t)=>{p(this,ge)??w(this,ge,new Map),p(this,ge).set(e,t)});k(this,"get",e=>p(this,ge)?p(this,ge).get(e):void 0);k(this,"newResponse",(...e)=>R(this,ve,Fe).call(this,...e));k(this,"body",(e,t,s)=>R(this,ve,Fe).call(this,e,t,s));k(this,"text",(e,t,s)=>!p(this,Ne)&&!p(this,$e)&&!t&&!s&&!this.finalized?new Response(e):R(this,ve,Fe).call(this,e,t,ht(Cs,s)));k(this,"json",(e,t,s)=>R(this,ve,Fe).call(this,JSON.stringify(e),t,ht("application/json",s)));k(this,"html",(e,t,s)=>{const a=n=>R(this,ve,Fe).call(this,n,t,ht("text/html; charset=UTF-8",s));return typeof e=="object"?Wt(e,Es.Stringify,!1,{}).then(a):a(e)});k(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});k(this,"notFound",()=>(p(this,Ke)??w(this,Ke,()=>new Response),p(this,Ke).call(this,this)));w(this,Xe,e),t&&(w(this,ue,t.executionCtx),this.env=t.env,w(this,Ke,t.notFoundHandler),w(this,st,t.path),w(this,tt,t.matchResult))}get req(){return p(this,Je)??w(this,Je,new jt(p(this,Xe),p(this,st),p(this,tt))),p(this,Je)}get event(){if(p(this,ue)&&"respondWith"in p(this,ue))return p(this,ue);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,ue))return p(this,ue);throw Error("This context has no ExecutionContext")}get res(){return p(this,X)||w(this,X,new Response(null,{headers:p(this,Ne)??w(this,Ne,new Headers)}))}set res(e){if(p(this,X)&&e){e=new Response(e.body,e);for(const[t,s]of p(this,X).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=p(this,X).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}w(this,X,e),this.finalized=!0}get var(){return p(this,ge)?Object.fromEntries(p(this,ge)):{}}},Xe=new WeakMap,Je=new WeakMap,ge=new WeakMap,$e=new WeakMap,ue=new WeakMap,X=new WeakMap,et=new WeakMap,Ge=new WeakMap,Ke=new WeakMap,Ne=new WeakMap,tt=new WeakMap,st=new WeakMap,ve=new WeakSet,Fe=function(e,t,s){const a=p(this,X)?new Headers(p(this,X).headers):p(this,Ne)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,i]of o)r.toLowerCase()==="set-cookie"?a.append(r,i):a.set(r,i)}if(s)for(const[o,r]of Object.entries(s))if(typeof r=="string")a.set(o,r);else{a.delete(o);for(const i of r)a.append(o,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??p(this,$e);return new Response(e,{status:n,headers:a})},At),K="ALL",Is="all",Ls=["get","post","put","delete","options","patch"],$t="Can not add a route since the matcher is already built.",Gt=class extends Error{},As="__COMPOSED_HANDLER",Ms=e=>e.text("404 Not Found",404),Et=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},ce,V,Kt,me,Me,rt,it,Ve,Rs=(Ve=class{constructor(t={}){C(this,V);k(this,"get");k(this,"post");k(this,"put");k(this,"delete");k(this,"options");k(this,"patch");k(this,"all");k(this,"on");k(this,"use");k(this,"router");k(this,"getPath");k(this,"_basePath","/");C(this,ce,"/");k(this,"routes",[]);C(this,me,Ms);k(this,"errorHandler",Et);k(this,"onError",t=>(this.errorHandler=t,this));k(this,"notFound",t=>(w(this,me,t),this));k(this,"fetch",(t,...s)=>R(this,V,it).call(this,t,s[1],s[0],t.method));k(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${je("/",t)}`,s),a,n)));k(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(R(this,V,it).call(this,t.request,t,void 0,t.request.method))})});[...Ls,Is].forEach(o=>{this[o]=(r,...i)=>(typeof r=="string"?w(this,ce,r):R(this,V,Me).call(this,o,p(this,ce),r),i.forEach(l=>{R(this,V,Me).call(this,o,p(this,ce),l)}),this)}),this.on=(o,r,...i)=>{for(const l of[r].flat()){w(this,ce,l);for(const d of[o].flat())i.map(c=>{R(this,V,Me).call(this,d.toUpperCase(),p(this,ce),c)})}return this},this.use=(o,...r)=>(typeof o=="string"?w(this,ce,o):(w(this,ce,"*"),r.unshift(o)),r.forEach(i=>{R(this,V,Me).call(this,K,p(this,ce),i)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Pt:vs}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var r;let o;s.errorHandler===Et?o=n.handler:(o=async(i,l)=>(await wt([],s.errorHandler)(i,()=>n.handler(i,l))).res,o[As]=n.handler),R(r=a,V,Me).call(r,n.method,n.path,o)}),this}basePath(t){const s=R(this,V,Kt).call(this);return s._basePath=je(this._basePath,t),s}mount(t,s,a){let n,o;a&&(typeof a=="function"?o=a:(o=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const r=o?l=>{const d=o(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=je(this._basePath,t),d=l==="/"?0:l.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,c)}})());const i=async(l,d)=>{const c=await s(n(l.req.raw),...r(l));if(c)return c;await d()};return R(this,V,Me).call(this,K,je(t,"*"),i),this}},ce=new WeakMap,V=new WeakSet,Kt=function(){const t=new Ve({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,w(t,me,p(this,me)),t.routes=this.routes,t},me=new WeakMap,Me=function(t,s,a){t=t.toUpperCase(),s=je(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},rt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},it=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await R(this,V,it).call(this,t,s,a,"GET")))();const o=this.getPath(t,{env:a}),r=this.router.match(n,o),i=new Ss(t,{path:o,matchResult:r,env:a,executionCtx:s,notFoundHandler:p(this,me)});if(r[0].length===1){let d;try{d=r[0][0][0][0](i,async()=>{i.res=await p(this,me).call(this,i)})}catch(c){return R(this,V,rt).call(this,c,i)}return d instanceof Promise?d.then(c=>c||(i.finalized?i.res:p(this,me).call(this,i))).catch(c=>R(this,V,rt).call(this,c,i)):d??p(this,me).call(this,i)}const l=wt(r[0],this.errorHandler,p(this,me));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return R(this,V,rt).call(this,d,i)}})()},Ve),Vt=[];function Ns(e,t){const s=this.buildAllMatchers(),a=((n,o)=>{const r=s[n]||s[K],i=r[2][o];if(i)return i;const l=o.match(r[0]);if(!l)return[[],Vt];const d=l.indexOf("",1);return[r[1][d],l]});return this.match=a,a(e,t)}var ct="[^/]+",qe=".*",Qe="(?:|/.*)",He=Symbol(),Ts=new Set(".\\+*[^]$()");function Ds(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===qe||e===Qe?1:t===qe||t===Qe?-1:e===ct?1:t===ct?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Te,De,pe,Be,Ps=(Be=class{constructor(){C(this,Te);C(this,De);C(this,pe,Object.create(null))}insert(t,s,a,n,o){if(t.length===0){if(p(this,Te)!==void 0)throw He;if(o)return;w(this,Te,s);return}const[r,...i]=t,l=r==="*"?i.length===0?["","",qe]:["","",ct]:r==="/*"?["","",Qe]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let m=l[2]||ct;if(c&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw He;if(d=p(this,pe)[m],!d){if(Object.keys(p(this,pe)).some(h=>h!==qe&&h!==Qe))throw He;if(o)return;d=p(this,pe)[m]=new Be,c!==""&&w(d,De,n.varIndex++)}!o&&c!==""&&a.push([c,p(d,De)])}else if(d=p(this,pe)[r],!d){if(Object.keys(p(this,pe)).some(c=>c.length>1&&c!==qe&&c!==Qe))throw He;if(o)return;d=p(this,pe)[r]=new Be}d.insert(i,s,a,n,o)}buildRegExpStr(){const s=Object.keys(p(this,pe)).sort(Ds).map(a=>{const n=p(this,pe)[a];return(typeof p(n,De)=="number"?`(${a})@${p(n,De)}`:Ts.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof p(this,Te)=="number"&&s.unshift(`#${p(this,Te)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Te=new WeakMap,De=new WeakMap,pe=new WeakMap,Be),mt,at,Mt,Os=(Mt=class{constructor(){C(this,mt,{varIndex:0});C(this,at,new Ps)}insert(e,t,s){const a=[],n=[];for(let r=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${r}`;return n[r]=[d,l],r++,i=!0,d}),!i)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[i]=n[r];for(let l=o.length-1;l>=0;l--)if(o[l].indexOf(i)!==-1){o[l]=o[l].replace(i,n[r][1]);break}}return p(this,at).insert(o,t,a,p(this,mt),s),a}buildRegExp(){let e=p(this,at).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,r)=>o!==void 0?(s[++t]=Number(o),"$()"):(r!==void 0&&(a[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,a]}},mt=new WeakMap,at=new WeakMap,Mt),Bs=[/^$/,[],Object.create(null)],lt=Object.create(null);function Yt(e){return lt[e]??(lt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Us(){lt=Object.create(null)}function js(e){var d;const t=new Os,s=[];if(e.length===0)return Bs;const a=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[h,y])=>c?1:h?-1:m.length-y.length),n=Object.create(null);for(let c=0,m=-1,h=a.length;c<h;c++){const[y,b,v]=a[c];y?n[b]=[v.map(([f])=>[f,Object.create(null)]),Vt]:m++;let g;try{g=t.insert(b,m,y)}catch(f){throw f===He?new Gt(b):f}y||(s[m]=v.map(([f,N])=>{const A=Object.create(null);for(N-=1;N>=0;N--){const[x,L]=g[N];A[x]=L}return[f,A]}))}const[o,r,i]=t.buildRegExp();for(let c=0,m=s.length;c<m;c++)for(let h=0,y=s[c].length;h<y;h++){const b=(d=s[c][h])==null?void 0:d[1];if(!b)continue;const v=Object.keys(b);for(let g=0,f=v.length;g<f;g++)b[v[g]]=i[b[v[g]]]}const l=[];for(const c in r)l[c]=s[r[c]];return[o,l,n]}function Ue(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(Yt(s).test(t))return[...e[s]]}}var we,ke,pt,_t,Rt,Fs=(Rt=class{constructor(){C(this,pt);k(this,"name","RegExpRouter");C(this,we);C(this,ke);k(this,"match",Ns);w(this,we,{[K]:Object.create(null)}),w(this,ke,{[K]:Object.create(null)})}add(e,t,s){var i;const a=p(this,we),n=p(this,ke);if(!a||!n)throw new Error($t);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[K]).forEach(d=>{l[e][d]=[...l[K][d]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Yt(t);e===K?Object.keys(a).forEach(d=>{var c;(c=a[d])[t]||(c[t]=Ue(a[d],t)||Ue(a[K],t)||[])}):(i=a[e])[t]||(i[t]=Ue(a[e],t)||Ue(a[K],t)||[]),Object.keys(a).forEach(d=>{(e===K||e===d)&&Object.keys(a[d]).forEach(c=>{l.test(c)&&a[d][c].push([s,o])})}),Object.keys(n).forEach(d=>{(e===K||e===d)&&Object.keys(n[d]).forEach(c=>l.test(c)&&n[d][c].push([s,o]))});return}const r=Ot(t)||[t];for(let l=0,d=r.length;l<d;l++){const c=r[l];Object.keys(n).forEach(m=>{var h;(e===K||e===m)&&((h=n[m])[c]||(h[c]=[...Ue(a[m],c)||Ue(a[K],c)||[]]),n[m][c].push([s,o-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(p(this,ke)).concat(Object.keys(p(this,we))).forEach(t=>{e[t]||(e[t]=R(this,pt,_t).call(this,t))}),w(this,we,w(this,ke,void 0)),Us(),e}},we=new WeakMap,ke=new WeakMap,pt=new WeakSet,_t=function(e){const t=[];let s=e===K;return[p(this,we),p(this,ke)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(o=>[o,a[e][o]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==K&&t.push(...Object.keys(a[K]).map(o=>[o,a[K][o]]))}),s?js(t):null},Rt),Ee,he,Nt,Hs=(Nt=class{constructor(e){k(this,"name","SmartRouter");C(this,Ee,[]);C(this,he,[]);w(this,Ee,e.routers)}add(e,t,s){if(!p(this,he))throw new Error($t);p(this,he).push([e,t,s])}match(e,t){if(!p(this,he))throw new Error("Fatal error");const s=p(this,Ee),a=p(this,he),n=s.length;let o=0,r;for(;o<n;o++){const i=s[o];try{for(let l=0,d=a.length;l<d;l++)i.add(...a[l]);r=i.match(e,t)}catch(l){if(l instanceof Gt)continue;throw l}this.match=i.match.bind(i),w(this,Ee,[i]),w(this,he,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(p(this,he)||p(this,Ee).length!==1)throw new Error("No active router has been determined yet.");return p(this,Ee)[0]}},Ee=new WeakMap,he=new WeakMap,Nt),ze=Object.create(null),Ce,Z,Pe,Ye,Q,fe,Re,_e,Ws=(_e=class{constructor(t,s,a){C(this,fe);C(this,Ce);C(this,Z);C(this,Pe);C(this,Ye,0);C(this,Q,ze);if(w(this,Z,a||Object.create(null)),w(this,Ce,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},w(this,Ce,[n])}w(this,Pe,[])}insert(t,s,a){w(this,Ye,++vt(this,Ye)._);let n=this;const o=hs(s),r=[];for(let i=0,l=o.length;i<l;i++){const d=o[i],c=o[i+1],m=bs(d,c),h=Array.isArray(m)?m[0]:d;if(h in p(n,Z)){n=p(n,Z)[h],m&&r.push(m[1]);continue}p(n,Z)[h]=new _e,m&&(p(n,Pe).push(m),r.push(m[1])),n=p(n,Z)[h]}return p(n,Ce).push({[t]:{handler:a,possibleKeys:r.filter((i,l,d)=>d.indexOf(i)===l),score:p(this,Ye)}}),n}search(t,s){var l;const a=[];w(this,Q,ze);let o=[this];const r=Dt(s),i=[];for(let d=0,c=r.length;d<c;d++){const m=r[d],h=d===c-1,y=[];for(let b=0,v=o.length;b<v;b++){const g=o[b],f=p(g,Z)[m];f&&(w(f,Q,p(g,Q)),h?(p(f,Z)["*"]&&a.push(...R(this,fe,Re).call(this,p(f,Z)["*"],t,p(g,Q))),a.push(...R(this,fe,Re).call(this,f,t,p(g,Q)))):y.push(f));for(let N=0,A=p(g,Pe).length;N<A;N++){const x=p(g,Pe)[N],L=p(g,Q)===ze?{}:{...p(g,Q)};if(x==="*"){const $=p(g,Z)["*"];$&&(a.push(...R(this,fe,Re).call(this,$,t,p(g,Q))),w($,Q,L),y.push($));continue}const[M,W,J]=x;if(!m&&!(J instanceof RegExp))continue;const j=p(g,Z)[M],te=r.slice(d).join("/");if(J instanceof RegExp){const $=J.exec(te);if($){if(L[W]=$[0],a.push(...R(this,fe,Re).call(this,j,t,p(g,Q),L)),Object.keys(p(j,Z)).length){w(j,Q,L);const Y=((l=$[0].match(/\//))==null?void 0:l.length)??0;(i[Y]||(i[Y]=[])).push(j)}continue}}(J===!0||J.test(m))&&(L[W]=m,h?(a.push(...R(this,fe,Re).call(this,j,t,L,p(g,Q))),p(j,Z)["*"]&&a.push(...R(this,fe,Re).call(this,p(j,Z)["*"],t,L,p(g,Q)))):(w(j,Q,L),y.push(j)))}}o=y.concat(i.shift()??[])}return a.length>1&&a.sort((d,c)=>d.score-c.score),[a.map(({handler:d,params:c})=>[d,c])]}},Ce=new WeakMap,Z=new WeakMap,Pe=new WeakMap,Ye=new WeakMap,Q=new WeakMap,fe=new WeakSet,Re=function(t,s,a,n){const o=[];for(let r=0,i=p(t,Ce).length;r<i;r++){const l=p(t,Ce)[r],d=l[s]||l[K],c={};if(d!==void 0&&(d.params=Object.create(null),o.push(d),a!==ze||n&&n!==ze))for(let m=0,h=d.possibleKeys.length;m<h;m++){const y=d.possibleKeys[m],b=c[d.score];d.params[y]=n!=null&&n[y]&&!b?n[y]:a[y]??(n==null?void 0:n[y]),c[d.score]=!0}}return o},_e),Oe,Tt,$s=(Tt=class{constructor(){k(this,"name","TrieRouter");C(this,Oe);w(this,Oe,new Ws)}add(e,t,s){const a=Ot(t);if(a){for(let n=0,o=a.length;n<o;n++)p(this,Oe).insert(e,a[n],s);return}p(this,Oe).insert(e,t,s)}match(e,t){return p(this,Oe).search(e,t)}},Oe=new WeakMap,Tt),zt=class extends Rs{constructor(e={}){super(e),this.router=e.router??new Hs({routers:[new Fs,new $s]})}},Gs=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(o=>typeof o=="string"?o==="*"?()=>o:r=>o===r?r:null:typeof o=="function"?o:r=>o.includes(r)?r:null)(s.origin),n=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(s.allowMethods);return async function(r,i){var c;function l(m,h){r.res.headers.set(m,h)}const d=await a(r.req.header("origin")||"",r);if(d&&l("Access-Control-Allow-Origin",d),s.credentials&&l("Access-Control-Allow-Credentials","true"),(c=s.exposeHeaders)!=null&&c.length&&l("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),r.req.method==="OPTIONS"){s.origin!=="*"&&l("Vary","Origin"),s.maxAge!=null&&l("Access-Control-Max-Age",s.maxAge.toString());const m=await n(r.req.header("origin")||"",r);m.length&&l("Access-Control-Allow-Methods",m.join(","));let h=s.allowHeaders;if(!(h!=null&&h.length)){const y=r.req.header("Access-Control-Request-Headers");y&&(h=y.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await i(),s.origin!=="*"&&r.header("Vary","Origin",{append:!0})}},Ks=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Ct=(e,t=Ys)=>{const s=/\.([a-zA-Z0-9]+?)$/,a=e.match(s);if(!a)return;let n=t[a[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},Vs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ys=Vs,_s=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),a=[];for(const n of s)n===".."&&a.length>0&&a.at(-1)!==".."?a.pop():n!=="."&&a.push(n);return a.join("/")||"."},qt={br:".br",zstd:".zst",gzip:".gz"},zs=Object.keys(qt),qs="index.html",Qs=e=>{const t=e.root??"./",s=e.path,a=e.join??_s;return async(n,o)=>{var c,m,h,y;if(n.finalized)return o();let r;if(e.path)r=e.path;else try{if(r=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(r))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),o()}let i=a(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(i)&&(i=a(i,qs));const l=e.getContent;let d=await l(i,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const b=e.mimes&&Ct(i,e.mimes)||Ct(i);if(n.header("Content-Type",b||"application/octet-stream"),e.precompressed&&(!b||Ks.test(b))){const v=new Set((m=n.req.header("Accept-Encoding"))==null?void 0:m.split(",").map(g=>g.trim()));for(const g of zs){if(!v.has(g))continue;const f=await l(i+qt[g],n);if(f){d=f,n.header("Content-Encoding",g),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((h=e.onFound)==null?void 0:h.call(e,i,n)),n.body(d)}await((y=e.onNotFound)==null?void 0:y.call(e,i,n)),await o()}},Zs=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const n=s[e]||e;if(!n)return null;const o=await a.get(n,{type:"stream"});return o||null},Xs=e=>async function(s,a){return Qs({...e,getContent:async o=>Zs(o,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,a)},Js=e=>Xs(e);const S=new zt;S.use("/api/*",Gs());S.use("*",async(e,t)=>{try{const s=await e.env.COMPANIES_KV.get("__streak_api_key__");s&&e.env.ENCRYPTION_KEY?dt=await Xt(s,e.env.ENCRYPTION_KEY):e.env.STREAK_API_KEY&&(dt=e.env.STREAK_API_KEY)}catch{e.env.STREAK_API_KEY&&(dt=e.env.STREAK_API_KEY)}await t()});S.use("/static/*",Js({root:"./public"}));let dt="";const ea="https://www.streak.com/api/v1",Qt=["oattia@gmail.com","aina.andriamangason@gmail.com","winnielauren3@gmail.com","zakaria.omahdi@mabsilico.com"];async function Zt(e){const t=new TextEncoder,s=await crypto.subtle.digest("SHA-256",t.encode(e));return crypto.subtle.importKey("raw",s,{name:"AES-GCM"},!1,["encrypt","decrypt"])}async function ta(e,t){const s=new TextEncoder,a=await Zt(t),n=crypto.getRandomValues(new Uint8Array(12)),o=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},a,s.encode(e)),r=new Uint8Array(n.length+new Uint8Array(o).length);r.set(n),r.set(new Uint8Array(o),n.length);let i="";for(let l=0;l<r.length;l++)i+=String.fromCharCode(r[l]);return btoa(i)}async function Xt(e,t){const s=atob(e),a=new Uint8Array(s.length);for(let l=0;l<s.length;l++)a[l]=s.charCodeAt(l);const n=a.slice(0,12),o=a.slice(12),r=await Zt(t),i=await crypto.subtle.decrypt({name:"AES-GCM",iv:n},r,o);return new TextDecoder().decode(i)}async function Jt(e,t){try{const s=await fetch("https://oauth2.googleapis.com/tokeninfo?id_token="+encodeURIComponent(e));if(!s.ok)return null;const a=await s.json();return a.aud!==t||!a.email||a.email_verified!=="true"?null:{email:a.email,name:a.name||a.email}}catch{return null}}const Ze={mabsilico:{name:"MabSilico",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",networkSheetGid:"910674612",sources:{promote:"",network:"https://docs.google.com/spreadsheets/d/1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw/edit?gid=910674612#gid=910674612",engage:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw"}},"finance-montreal":{name:"Finance Montreal (Steve)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw"},"apm-music":{name:"APM Music",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM"},ducrocq:{name:"Ducrocq",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww"},milvue:{name:"Milvue",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw"},seekyo:{name:"Seekyo Therapeutics",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww"},altavia:{name:"Altavia",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM"},valos:{name:"Valos",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM"},"dab-embedded":{name:"DAB-Embedded",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww"},"finance-montreal-noza":{name:"Finance Montreal (Noza)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw"}},ee=Ze.mabsilico.pipelineKey,es="Fit",ts="Interest",St="1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw";async function O(e){const t=btoa(`${dt}:`),s=await fetch(`${ea}${e}`,{headers:{Authorization:`Basic ${t}`,"Content-Type":"application/json"}});if(!s.ok)throw new Error(`Streak API error: ${s.statusText}`);return s.json()}function bt(e){if(e.includes("docs.google.com")){const t=e.match(/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/),s=e.match(/[?&#]gid=(\d+)/),a=t?t[1]:St,n=s?s[1]:"0";return{sheetId:a,gid:n}}return{sheetId:St,gid:e}}async function ss(e){try{const{sheetId:t,gid:s}=bt(e),a=`https://docs.google.com/spreadsheets/d/${t}/export?format=csv&gid=${s}`,n=await fetch(a);if(!n.ok)throw new Error(`Google Sheets error: ${n.statusText}`);const r=(await n.text()).split(`
`).filter(x=>x.trim()),i=[];if(r.length<2)return{totalInvitations:0,totalAccepted:0,avgAcceptanceRate:0,thisWeek:{invitations:0,acceptance:0},lastWeek:{invitations:0,acceptance:0},recentWeeks:[],allData:[]};const l=r[0].split(",").map(x=>x.trim().toLowerCase()),d=l[0]==="w"||l[0]==="week",c=d?0:-1;for(let x=1;x<r.length;x++){const M=r[x].split(","),W=3+c,J=4+c,j=7+c,te=8+c,$=1+c,Y=2+c;if(M.length>=(d?9:8)&&M[W]&&M[W].trim()){const Ie=parseInt(M[W])||0,_=parseInt(M[J])||0,be=M[j]?M[j].replace("%","").trim():"0",oe=parseFloat(be)||0;i.push({week:d?M[0]:String(x),from:M[$],to:M[Y],invitations:Ie,messages:_,acceptance:oe,opportunities:te<M.length&&parseInt(M[te])||0})}}const m=i.reduce((x,L)=>x+L.invitations,0),h=i.reduce((x,L)=>{const M=Math.min(L.acceptance,100);return x+Math.round(L.invitations*M/100)},0),y=i.map(x=>Math.min(x.acceptance,100)),b=y.length>0?y.reduce((x,L)=>x+L,0)/y.length:0,v=20,g=b>0?b/v*100:0,f=i.slice(-4),N=i[i.length-1]||{invitations:0,acceptance:0},A=i[i.length-2]||{invitations:0,acceptance:0};return{totalInvitations:m,totalAccepted:h,avgAcceptanceRate:Math.round(b*10)/10,networkObjective:v,objectiveAchievement:Math.round(g*10)/10,thisWeek:{invitations:N.invitations,acceptance:Math.min(N.acceptance,100)},lastWeek:{invitations:A.invitations,acceptance:Math.min(A.acceptance,100)},recentWeeks:f.map(x=>({...x,acceptance:Math.min(x.acceptance,100)})),allData:i}}catch(t){return console.error("Error fetching network data:",t),{totalInvitations:0,totalAccepted:0,avgAcceptanceRate:0,thisWeek:{invitations:0,acceptance:0},lastWeek:{invitations:0,acceptance:0},recentWeeks:[],allData:[]}}}async function sa(e){try{let t=function(c){const m=[];let h="",y=!1;for(let b=0;b<c.length;b++){const v=c[b];v==='"'?y=!y:v===","&&!y?(m.push(h.trim()),h=""):h+=v}return m.push(h.trim()),m};const{sheetId:s,gid:a}=bt(e),n=`https://docs.google.com/spreadsheets/d/${s}/export?format=csv&gid=${a}`,o=await fetch(n);if(!o.ok)throw new Error(`Google Sheets error: ${o.statusText}`);const i=(await o.text()).split(`
`).filter(c=>c.trim());if(i.length<2)return{campaigns:[],totals:{emailsSent:0,allReplies:0,humanReplies:0,positiveReplies:0,humanReplyRate:0,positiveReplyRate:0}};const l=[];for(let c=1;c<i.length;c++){const m=t(i[c]);m.length<10||l.push({id:m[0],name:m[1],account:m[2],company:m[3],emailsSent:parseInt(m[4])||0,allReplies:parseInt(m[5])||0,humanReplies:parseInt(m[6])||0,positiveReplies:parseInt(m[7])||0,humanReplyRate:parseFloat(m[8])||0,positiveReplyRate:parseFloat(m[9])||0,targeting:m.length>10?m[10]:"",leads:m.length>11&&parseInt(m[11])||0})}const d={emailsSent:l.reduce((c,m)=>c+m.emailsSent,0),allReplies:l.reduce((c,m)=>c+m.allReplies,0),humanReplies:l.reduce((c,m)=>c+m.humanReplies,0),positiveReplies:l.reduce((c,m)=>c+m.positiveReplies,0),humanReplyRate:0,positiveReplyRate:0,leads:l.reduce((c,m)=>c+m.leads,0),campaignCount:l.length};return d.allReplies>0&&(d.humanReplyRate=d.humanReplies/d.allReplies*100,d.positiveReplyRate=d.positiveReplies/d.allReplies*100),{campaigns:l,totals:d}}catch(t){return console.error("Error fetching emailing data:",t),{campaigns:[],totals:{emailsSent:0,allReplies:0,humanReplies:0,positiveReplies:0,humanReplyRate:0,positiveReplyRate:0,leads:0,campaignCount:0}}}}S.get("/api/pipeline",async e=>{try{const t=await O(`/pipelines/${ee}`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});S.get("/api/boxes",async e=>{try{const t=await O(`/pipelines/${ee}/boxes`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});S.get("/api/boxes/:boxKey",async e=>{try{const t=e.req.param("boxKey"),s=await O(`/boxes/${t}`);return e.json(s)}catch(t){return e.json({error:t.message},500)}});S.get("/api/sheets/stage/:stageName/count",async e=>{try{const t=e.req.param("stageName"),[s,a]=await Promise.all([O(`/pipelines/${ee}`),O(`/pipelines/${ee}/boxes`)]),n=s.stageOrder||[],o=Array.isArray(n)?n.map(i=>{var l,d;return{key:i,name:((d=(l=s.stages)==null?void 0:l[i])==null?void 0:d.name)||"Unknown"}}):[],r=Array.isArray(a)?a.filter(i=>{const l=o.find(d=>d&&d.key===i.stageKey);return l&&l.name.toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/priority/:priorityName/count",async e=>{try{const t=e.req.param("priorityName"),[s,a]=await Promise.all([O(`/pipelines/${ee}`),O(`/pipelines/${ee}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name==="Priority"),r=Array.isArray(a)?a.filter(i=>{var h;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="no priority";const l=i.fields[o.key],d=(h=o.dropdownSettings)==null?void 0:h.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"No Priority").toLowerCase().includes(t.toLowerCase())}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/country/:countryName/count",async e=>{try{const t=e.req.param("countryName"),[s,a]=await Promise.all([O(`/pipelines/${ee}`),O(`/pipelines/${ee}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name==="Country"),r=Array.isArray(a)?a.filter(i=>{var h;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="unknown";const l=i.fields[o.key],d=(h=o.dropdownSettings)==null?void 0:h.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"Unknown").toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/total",async e=>{try{const t=await O(`/pipelines/${ee}/boxes`),s=Array.isArray(t)?t.length:0;return e.text(s.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/freshness/:level/count",async e=>{try{const t=e.req.param("level").toLowerCase(),s=await O(`/pipelines/${ee}/boxes`),a=Array.isArray(s)?s.filter(n=>{const o=n.freshness||0;return t==="high"?o>.5:t==="medium"?o>=.2&&o<=.5:t==="low"?o<.2:!1}).length:0;return e.text(a.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/fit/:fitLevel/count",async e=>{try{const t=e.req.param("fitLevel"),[s,a]=await Promise.all([O(`/pipelines/${ee}`),O(`/pipelines/${ee}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name===es),r=Array.isArray(a)?a.filter(i=>{var h;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="not set";const l=i.fields[o.key],d=(h=o.dropdownSettings)==null?void 0:h.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/interest/:interestLevel/count",async e=>{try{const t=e.req.param("interestLevel"),[s,a]=await Promise.all([O(`/pipelines/${ee}`),O(`/pipelines/${ee}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name===ts),r=Array.isArray(a)?a.filter(i=>{var h;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="not set";const l=i.fields[o.key],d=(h=o.dropdownSettings)==null?void 0:h.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});function as(e,t){if(e&&e.startsWith("strk_")&&t){const s=t.match(/\/pipelines\/([a-zA-Z0-9_-]{20,})/);if(s)return s[1]}if(e&&e.includes("/pipelines/")){const s=e.match(/\/pipelines\/([a-zA-Z0-9_-]{20,})/);if(s)return s[1]}return e}async function Se(e,t){const s=await e.get(`company:${t}`);if(s)return JSON.parse(s);if(Ze[t]){const a=Ze[t];return{key:t,name:a.name,pipelineKey:a.pipelineKey,url:a.url||"",networkSheetGid:a.networkSheetGid||"",sources:a.sources||{}}}return null}async function nt(e,t=!1){const s={};for(const o of Object.keys(Ze)){const r=Ze[o];s[o]={key:o,name:r.name,pipelineKey:r.pipelineKey,url:r.url||"",networkSheetGid:r.networkSheetGid||"",sources:r.sources||{},archived:!1}}const a=await e.list({prefix:"company:"});for(const o of a.keys){const r=await e.get(o.name);if(r){const i=JSON.parse(r);s[i.key]=i}}const n=Object.values(s);return t?n:n.filter(o=>!o.archived)}S.get("/api/companies",async e=>{const t=e.req.query("includeArchived")==="true",s=await nt(e.env.COMPANIES_KV,t);return e.json({companies:s,count:s.length})});S.post("/api/companies",async e=>{try{const t=await e.req.json(),{name:s,pipelineKey:a,networkUrl:n,promoteUrl:o,engageUrl:r,notionUrl:i,networkGid:l,key:d,googleChatUrl:c,googleChatWebhookUrl:m,emailingUrl:h,messages:y}=t;if(!s||!a)return e.json({error:"name and pipelineKey are required"},400);const b=d||s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""),v=as(a,r),g={key:b,name:s,pipelineKey:v,url:r||`https://www.streak.com/a/pipelines/${a}`,sources:{promote:o||"",network:n||"",engage:r||`https://www.streak.com/a/pipelines/${a}`,notion:i||""}};return l&&(g.networkSheetGid=l),c&&(g.googleChatUrl=c),m&&(g.googleChatWebhookUrl=m),y&&y.length>0&&(g.messages=y),h&&(g.emailingUrl=h),await e.env.COMPANIES_KV.put(`company:${b}`,JSON.stringify(g)),e.json({success:!0,company:g})}catch{return e.json({error:"Failed to save company"},500)}});async function ns(e,t){var d,c;const s=/\[leads:([^\]]+)\]/gi,a=[...e.matchAll(s)];if(a.length===0)return e;const[n,o]=await Promise.all([O(`/pipelines/${t}`),O(`/pipelines/${t}/boxes`)]),r=n.stageOrder||[],i={};for(const m of r)i[m]=((c=(d=n.stages)==null?void 0:d[m])==null?void 0:c.name)||"Unknown";let l=e;for(const m of a){const h=m[1],y=Array.isArray(o)?o.filter(b=>(i[b.stageKey]||"").toLowerCase()===h.toLowerCase()).length:0;l=l.replace(m[0],y.toString())}return l}function aa(){const e=new Date,t=-300;e.getUTCHours()*60+e.getUTCMinutes();const s=new Date(e);return s.setUTCMinutes(s.getUTCMinutes()+t),["sunday","monday","tuesday","wednesday","thursday","friday","saturday"][s.getUTCDay()]}S.get("/api/chat/send-messages",async e=>{try{const t=[],s=await nt(e.env.COMPANIES_KV),a=aa();for(const n of s){if(!n.googleChatWebhookUrl||!n.messages||!n.pipelineKey)continue;const o=n.messages.filter(r=>r.enabled&&r.dayOfWeek===a);for(const r of o)try{const i=await ns(r.text,n.pipelineKey),l=await fetch(n.googleChatWebhookUrl,{method:"POST",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify({text:i})});t.push({company:n.name,messageId:r.id,sent:l.ok,status:l.status,resolvedText:i})}catch(i){t.push({company:n.name,messageId:r.id,error:i.message,sent:!1})}}return e.json({success:!0,day:a,results:t,timestamp:new Date().toISOString()})}catch(t){return e.json({error:t.message},500)}});S.get("/api/chat/weekly-reminder",async e=>{var t,s;try{const a=[],n=await nt(e.env.COMPANIES_KV);for(const o of n)if(!(!o.googleChatWebhookUrl||!o.pipelineKey))try{const[r,i]=await Promise.all([O(`/pipelines/${o.pipelineKey}`),O(`/pipelines/${o.pipelineKey}/boxes`)]),l=r.stageOrder||[],d={};for(const y of l)d[y]=((s=(t=r.stages)==null?void 0:t[y])==null?void 0:s.name)||"Unknown";const c=Array.isArray(i)?i.filter(y=>(d[y.stageKey]||"").toLowerCase()==="lead").length:0,m=`As a reminder, you still have ${c} leads in your Streak that are still at the stage of LEAD, they should be CONTACTED or better. Also, a FIT would be important to share for future campaigns. Thanks.`,h=await fetch(o.googleChatWebhookUrl,{method:"POST",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify({text:m})});a.push({company:o.name,leadCount:c,sent:h.ok,status:h.status})}catch(r){a.push({company:o.name,error:r.message,sent:!1})}return e.json({success:!0,results:a,timestamp:new Date().toISOString()})}catch(a){return e.json({error:a.message},500)}});S.get("/api/chat/send-messages/:companyKey",async e=>{try{const t=e.req.param("companyKey").toLowerCase(),s=await Se(e.env.COMPANIES_KV,t);if(!s)return e.json({error:"Company not found"},404);if(!s.googleChatWebhookUrl)return e.json({error:`No Google Chat webhook configured for ${s.name}`},400);if(!s.pipelineKey)return e.json({error:`No pipeline key configured for ${s.name}`},400);if(!s.messages||s.messages.length===0)return e.json({error:`No messages configured for ${s.name}`},400);const a=[];for(const n of s.messages)if(n.enabled)try{const o=await ns(n.text,s.pipelineKey),r=await fetch(s.googleChatWebhookUrl,{method:"POST",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify({text:o})});a.push({messageId:n.id,dayOfWeek:n.dayOfWeek,time:n.time,sent:r.ok,resolvedText:o})}catch(o){a.push({messageId:n.id,error:o.message,sent:!1})}return e.json({success:!0,company:s.name,results:a,timestamp:new Date().toISOString()})}catch(t){return e.json({error:t.message},500)}});S.delete("/api/companies/:key",async e=>{try{const t=e.req.param("key");return await e.env.COMPANIES_KV.delete(`company:${t}`),e.json({success:!0})}catch{return e.json({error:"Failed to delete company"},500)}});S.put("/api/companies/:key",async e=>{var t,s,a;try{const n=e.req.param("key"),o=await e.req.json(),{name:r,pipelineKey:i,networkUrl:l,promoteUrl:d,engageUrl:c,networkGid:m,googleChatUrl:h,googleChatWebhookUrl:y,emailingUrl:b,messages:v}=o,f=(await nt(e.env.COMPANIES_KV,!0)).find(L=>L.key===n);if(!f)return e.json({error:"Company not found"},404);const{archived:N}=o,A=i?as(i,c||f.url):f.pipelineKey,x={...f,key:n,name:r||f.name,pipelineKey:A,sources:{promote:d!==void 0?d:((t=f.sources)==null?void 0:t.promote)||"",network:l!==void 0?l:((s=f.sources)==null?void 0:s.network)||"",engage:c!==void 0?c:((a=f.sources)==null?void 0:a.engage)||f.url||""}};return m!==void 0&&(m?x.networkSheetGid=m:delete x.networkSheetGid),c&&(x.url=c),N!==void 0&&(x.archived=N),h!==void 0&&(x.googleChatUrl=h),y!==void 0&&(x.googleChatWebhookUrl=y),v!==void 0&&(x.messages=v),o.emailingUrl!==void 0&&(x.emailingUrl=o.emailingUrl),await e.env.COMPANIES_KV.put(`company:${n}`,JSON.stringify(x)),e.json({success:!0,company:x})}catch{return e.json({error:"Failed to update company"},500)}});S.get("/api/sheets/:companyName/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Se(e.env.COMPANIES_KV,t);if(!s)return e.text("COMPANY_NOT_FOUND");const a=await O(`/pipelines/${s.pipelineKey}/boxes`),n=Array.isArray(a)?a.length:0;return e.text(n.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/:companyName/month/:yearMonth/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=e.req.param("yearMonth"),a=await Se(e.env.COMPANIES_KV,t);if(!a)return e.text("COMPANY_NOT_FOUND");const n=await O(`/pipelines/${a.pipelineKey}/boxes`),[o,r]=s.split("-").map(Number),i=Array.isArray(n)?n.filter(l=>{const d=new Date(l.creationTimestamp);return d.getFullYear()===o&&d.getMonth()+1===r}).length:0;return e.text(i.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/:companyName/week/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Se(e.env.COMPANIES_KV,t);if(!s)return e.text("ERROR");const a=await O(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a))return e.text("0");const o=Date.now()-10080*60*1e3,r=a.filter(i=>(i.creationTimestamp||0)>=o).length;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/:companyName/duration/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Se(e.env.COMPANIES_KV,t);if(!s)return e.text("0");const a=await O(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a)||a.length===0)return e.text("0");const n=a.map(m=>m.creationTimestamp).filter(m=>m);if(n.length===0)return e.text("0");const o=Math.min(...n),r=new Date(o),i=new Date,l=i.getFullYear()-r.getFullYear(),d=i.getMonth()-r.getMonth(),c=l*12+d+1;return e.text(c.toString())}catch{return e.text("0")}});S.get("/api/sheets/:companyName/monthly-stats",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Se(e.env.COMPANIES_KV,t);if(!s)return e.json({error:"Company not found"},404);const a=await O(`/pipelines/${s.pipelineKey}/boxes`),n=Array.isArray(a)?a:[],o=new Date,r=[];for(let c=11;c>=0;c--){const m=new Date(o.getFullYear(),o.getMonth()-c,1),h=m.getFullYear(),y=m.getMonth()+1,b=n.filter(g=>{const f=new Date(g.creationTimestamp);return f.getFullYear()===h&&f.getMonth()+1===y}).length,v=(b/10*100).toFixed(1);r.push({month:`${h}-${String(y).padStart(2,"0")}`,count:b,objective:10,percentage:parseFloat(v)})}const i=r.reduce((c,m)=>c+m.count,0),l=(i/12).toFixed(1),d=(parseFloat(l)/10*100).toFixed(1);return e.json({company:s.name,companyKey:t,objective:10,monthlyStats:r,summary:{totalLeads:i,average:parseFloat(l),averagePercentage:parseFloat(d)}})}catch(t){return e.json({error:t.message},500)}});S.get("/api/analytics",async e=>{var t;try{const s=e.req.query("company")||"mabsilico",a=await Se(e.env.COMPANIES_KV,s);if(!a)return e.json({error:"Invalid company key"},400);const n=a.pipelineKey;if(!n)return e.json({error:`No Streak pipeline key configured for "${a.name}". Please set it in the Admin Panel.`},400);const[o,r]=await Promise.all([O(`/pipelines/${n}`),O(`/pipelines/${n}/boxes`)]),i=Array.isArray(r)?r.length:0,l={},d={},c={},m={},h={},y={},b={"High (>0.5)":0,"Medium (0.2-0.5)":0,"Low (<0.2)":0},v=o.stageOrder||[],g=Array.isArray(v)?v.map(u=>{var I,z;return{key:u,name:((z=(I=o.stages)==null?void 0:I[u])==null?void 0:z.name)||"Unknown"}}):[],f=Array.isArray(o.fields)?o.fields:[],N=f.find(u=>u&&u.name==="Origin"),A=f.find(u=>u&&u.name===es),x=f.find(u=>u&&u.name===ts),L=f.find(u=>u&&u.name==="Est Start Date"),M=f.find(u=>u&&u.name==="Country"),W=f.find(u=>u&&u.name==="Language");Array.isArray(r)&&r.forEach(u=>{var D,G,ae,re,ie;if(!u)return;const I=g.find(H=>H&&H.key===u.stageKey),z=I?I.name:"Unknown";if(l[z]=(l[z]||0)+1,N&&u.fields&&u.fields[N.key]){const H=u.fields[N.key],F=(D=N.dropdownSettings)==null?void 0:D.items,q=Array.isArray(F)?F.find(B=>B&&B.key===H):null,U=q?q.name:"Unknown";d[U]=(d[U]||0)+1}if(A&&u.fields&&u.fields[A.key]){const H=u.fields[A.key],F=(G=A.dropdownSettings)==null?void 0:G.items,q=Array.isArray(F)?F.find(B=>B&&B.key===H):null,U=q?q.name:"Not Set";c[U]=(c[U]||0)+1}else c["Not Set"]=(c["Not Set"]||0)+1;if(x&&u.fields&&u.fields[x.key]){const H=u.fields[x.key],F=(ae=x.dropdownSettings)==null?void 0:ae.items,q=Array.isArray(F)?F.find(B=>B&&B.key===H):null,U=q?q.name:"Not Set";m[U]=(m[U]||0)+1}else m["Not Set"]=(m["Not Set"]||0)+1;if(M&&u.fields&&u.fields[M.key]){const H=u.fields[M.key],F=(re=M.dropdownSettings)==null?void 0:re.items,q=Array.isArray(F)?F.find(B=>B&&B.key===H):null,U=q?q.name:"Unknown";h[U]=(h[U]||0)+1}else h.Unknown=(h.Unknown||0)+1;if(W&&u.fields&&u.fields[W.key]){const H=u.fields[W.key],F=(ie=W.dropdownSettings)==null?void 0:ie.items,q=Array.isArray(F)?F.find(B=>B&&B.key===H):null,U=q?q.name:"Unknown";y[U]=(y[U]||0)+1}else y.Unknown=(y.Unknown||0)+1;const P=u.freshness||0;P>.5?b["High (>0.5)"]++:P>=.2?b["Medium (0.2-0.5)"]++:b["Low (<0.2)"]++});const J={};Object.keys(c).forEach(u=>{J[u]=i>0?(c[u]/i*100).toFixed(1):0});const j={};Object.keys(m).forEach(u=>{j[u]=i>0?(m[u]/i*100).toFixed(1):0});const te=new Date,$=[],Y=10;for(let u=11;u>=0;u--){const I=new Date(te.getFullYear(),te.getMonth()-u,1),z=I.getFullYear(),P=I.getMonth()+1,D=Array.isArray(r)?r.filter(ae=>{const re=new Date(ae.creationTimestamp);return re.getFullYear()===z&&re.getMonth()+1===P}).length:0,G=(D/Y*100).toFixed(1);$.push({month:`${z}-${String(P).padStart(2,"0")}`,monthName:I.toLocaleString("en-US",{month:"short",year:"numeric"}),count:D,objective:Y,percentage:parseFloat(G),status:D>=Y?"achieved":"pending"})}const _=($.reduce((u,I)=>u+I.count,0)/12).toFixed(1),be=(parseFloat(_)/Y*100).toFixed(1);let oe=0,se=null;if(Array.isArray(r)&&r.length>0){const u=r.map(I=>I.creationTimestamp).filter(I=>I);if(u.length>0){const I=Math.min(...u);se=new Date(I);const z=te.getFullYear()-se.getFullYear(),P=te.getMonth()-se.getMonth();oe=z*12+P+1}}let Le=null;const E=a.networkSheetGid||((t=a.sources)==null?void 0:t.network);E&&(Le=await ss(E));let T=null;const Ae=a.emailingUrl;return Ae&&(T=await sa(Ae)),e.json({company:a.name,companyKey:s,totalBoxes:i,campaignDurationMonths:oe,firstLeadDate:se?se.toISOString():null,networkData:Le,emailingData:T,stageDistribution:l,originDistribution:d,fitDistribution:c,fitPercentages:J,interestDistribution:m,interestPercentages:j,countryDistribution:h,languageDistribution:y,freshnessDistribution:b,monthlyLeads:$,leadObjective:Y,averageLeadsPerMonth:parseFloat(_),averagePercentage:parseFloat(be),recentBoxes:Array.isArray(r)?r.filter(u=>{var G,ae;const I=A&&u.fields&&u.fields[A.key],z=x&&u.fields&&u.fields[x.key];let P="Not Set";if(I){const re=u.fields[A.key],ie=(G=A.dropdownSettings)==null?void 0:G.items,H=Array.isArray(ie)?ie.find(F=>F&&F.key===re):null;P=H?H.name:"Not Set"}let D="Not Set";if(z){const re=u.fields[x.key],ie=(ae=x.dropdownSettings)==null?void 0:ae.items,H=Array.isArray(ie)?ie.find(F=>F&&F.key===re):null;D=H?H.name:"Not Set"}return P==="High"||D==="High"}).slice(0,10).map(u=>{var ie,H,F,q;const I=g.find(U=>U&&U.key===u.stageKey);let z="Not Set";if(A&&u.fields&&u.fields[A.key]){const U=u.fields[A.key],B=(ie=A.dropdownSettings)==null?void 0:ie.items,le=Array.isArray(B)?B.find(de=>de&&de.key===U):null;z=le?le.name:"Not Set"}let P="Not Set";if(x&&u.fields&&u.fields[x.key]){const U=u.fields[x.key],B=(H=x.dropdownSettings)==null?void 0:H.items,le=Array.isArray(B)?B.find(de=>de&&de.key===U):null;P=le?le.name:"Not Set"}let D=null;L&&u.fields&&u.fields[L.key]&&(D=new Date(u.fields[L.key]).toISOString());let G="Unknown";if(M&&u.fields&&u.fields[M.key]){const U=u.fields[M.key],B=(F=M.dropdownSettings)==null?void 0:F.items,le=Array.isArray(B)?B.find(de=>de&&de.key===U):null;G=le?le.name:"Unknown"}let ae="Unknown";if(W&&u.fields&&u.fields[W.key]){const U=u.fields[W.key],B=(q=W.dropdownSettings)==null?void 0:q.items,le=Array.isArray(B)?B.find(de=>de&&de.key===U):null;ae=le?le.name:"Unknown"}const re=u.freshness||0;return{name:u.name||"Unnamed",key:u.boxKey,stage:I?I.name:"Unknown",fit:z,interest:P,dueDate:D,country:G,language:ae,freshness:re.toFixed(3),lastUpdated:new Date(u.lastUpdatedTimestamp).toISOString()}}):[]})}catch(s){return e.json({error:s.message},500)}});async function os(e){var h,y;const{sheetId:t,gid:s}=bt(e),a=`https://docs.google.com/spreadsheets/d/${t}/export?format=csv&gid=${s}`,n=await fetch(a);if(!n.ok)throw new Error(`Google Sheets error: ${n.statusText}`);const r=(await n.text()).split(`
`).filter(b=>b.trim());if(r.length<2)return{platforms:{}};const i=r[0].split(",").map(b=>b.trim().toLowerCase().replace(/\s+/g,"_")),l=b=>i.indexOf(b),d=[];for(let b=1;b<r.length;b++){const v=r[b].split(",");v.length<5||d.push({date:((h=v[l("date")])==null?void 0:h.trim())||"",platform:(((y=v[l("platform")])==null?void 0:y.trim())||"linkedin").toLowerCase(),followers:parseInt(v[l("follower_count")])||0,impressions:parseFloat(v[l("impressions")])||0,reach:parseInt(v[l("reach")])||0,likes:parseInt(v[l("like_count")])||0,comments:parseInt(v[l("comment_count")])||0,shares:parseInt(v[l("share_count")])||0,clicks:parseInt(v[l("click_count")])||0,engagements:parseInt(v[l("overall_engagements")])||0,engRate:parseFloat(v[l("engagement_rate")])||0,netGrowth:parseInt(v[l("net_audience_growth")])||0,posts:parseInt(v[l("post_count")])||0})}const c={};d.forEach(b=>{c[b.platform]||(c[b.platform]=[]),c[b.platform].push(b)});const m={};for(const[b,v]of Object.entries(c)){const g=[...v].sort((E,T)=>E.date.localeCompare(T.date)),f=g[0].followers,N=g[g.length-1].followers,A=N-f,x=f>0?+(A/f*100).toFixed(1):0,L=g.reduce((E,T)=>E+T.posts,0),M=Math.round(g.reduce((E,T)=>E+T.impressions,0)),W=g.reduce((E,T)=>E+T.reach,0),J=g.reduce((E,T)=>E+T.engagements,0),j=g.reduce((E,T)=>E+T.likes,0),te=g.reduce((E,T)=>E+T.comments,0),$=g.reduce((E,T)=>E+T.shares,0),Y=g.filter(E=>E.impressions>0&&E.engRate>0).map(E=>E.engRate),Ie=Y.length>0?+(Y.reduce((E,T)=>E+T,0)/Y.length*100).toFixed(2):0,_={};g.forEach(E=>{const T=new Date(E.date),Ae=T.getDay(),u=new Date(T);u.setDate(T.getDate()-(Ae===0?6:Ae-1));const I=u.toISOString().split("T")[0];_[I]||(_[I]={week:I,posts:0,impressions:0,engagements:0,reach:0,netGrowth:0}),_[I].posts+=E.posts,_[I].impressions+=Math.round(E.impressions),_[I].engagements+=E.engagements,_[I].reach+=E.reach,_[I].netGrowth+=E.netGrowth});const be=Object.values(_).sort((E,T)=>E.week.localeCompare(T.week)),oe=be.length||1,se=+(L/oe).toFixed(1),Le=g.map(E=>({date:E.date,followers:E.followers,posts:E.posts,impressions:Math.round(E.impressions),engagements:E.engagements,reach:E.reach}));m[b]={followersStart:f,followersEnd:N,followersGrowth:A,followersGrowthPct:x,totalPosts:L,avgPostsPerWeek:se,totalImpressions:M,totalReach:W,totalEngagements:J,totalLikes:j,totalComments:te,totalShares:$,avgEngRate:Ie,weeklyBreakdown:be,dailyData:Le,dateRange:{from:g[0].date,to:g[g.length-1].date}}}return{platforms:m}}S.get("/api/promote",async e=>{var t;try{const s=e.req.query("company")||"mabsilico",a=await Se(e.env.COMPANIES_KV,s);if(!a)return e.json({error:"Company not found"},404);const n=((t=a.sources)==null?void 0:t.promote)||"";if(!n)return e.json({error:"No promote URL configured for this company"},404);const o=await os(n);return e.json(o)}catch(s){return e.json({error:s.message},500)}});S.get("/api/overview",async e=>{try{let t=function(g){let f=0,N=a;return g==="week"?f=a-6048e5:g==="last-month"?(f=new Date(n.getFullYear(),n.getMonth()-1,1).getTime(),N=new Date(n.getFullYear(),n.getMonth(),1).getTime()):g==="this-month"?f=new Date(n.getFullYear(),n.getMonth(),1).getTime():g==="year"&&(f=new Date(n.getFullYear(),0,1).getTime()),{start:f,end:N}};const s=e.req.query("period")||"this-month",a=Date.now(),n=new Date,o={start:a-10080*60*1e3,end:a},r={start:new Date(n.getFullYear(),n.getMonth()-1,1).getTime(),end:new Date(n.getFullYear(),n.getMonth(),1).getTime()},i=t(s),l=await nt(e.env.COMPANIES_KV),d=await Promise.all(l.map(async g=>{var f,N;try{let A=function(P,D){return j.filter(G=>{const ae=G.creationTimestamp||0;return ae>=P&&ae<D}).length};const x=((f=g.sources)==null?void 0:f.promote)||"",L=g.networkSheetGid||((N=g.sources)==null?void 0:N.network)||"",[M,W,J]=await Promise.all([O(`/pipelines/${g.pipelineKey}/boxes`).catch(()=>[]),x?os(x).catch(()=>({platforms:{}})):Promise.resolve({platforms:{}}),L?ss(L).catch(()=>({avgAcceptanceRate:0,totalInvitations:0})):Promise.resolve({avgAcceptanceRate:0,totalInvitations:0})]),j=Array.isArray(M)?M:[],te=j.length,$=A(i.start,i.end),Y=A(o.start,o.end),Ie=A(r.start,r.end),_={};j.forEach(P=>{const D=P.stageKey||"Unknown";_[D]=(_[D]||0)+1});const be=j.filter(P=>(P.lastUpdatedTimestamp||0)>=o.start).length,oe=10;let se=oe;if(s==="week")se=Math.round(oe/30*7);else if(s==="year")se=oe*12;else if(s==="all"){const P=j.map(D=>D.creationTimestamp).filter(Boolean);if(P.length>0){const D=new Date(Math.min(...P)),G=(n.getFullYear()-D.getFullYear())*12+(n.getMonth()-D.getMonth())+1;se=oe*Math.max(G,1)}}let Le=0,E=!1;if(x&&W.platforms){E=!0;let P=0,D=0;for(const G of Object.values(W.platforms))P+=G.totalPosts||0,G.dailyData&&G.dailyData.length>D&&(D=G.dailyData.length);Le=D>0?Math.round(P/D*10)/10:0}const T=J.avgAcceptanceRate||0,Ae=!!L,u=new Date(n.getFullYear(),n.getMonth(),1).getTime(),I=j.filter(P=>(P.creationTimestamp||0)>=u).length,z=Math.round(I/10*100);return{key:g.key,name:g.name,periodLeads:$,totalLeads:te,weekLeads:Y,lastMonthLeads:Ie,recentActivity:be,stageCount:Object.keys(_).length,goalPct:se>0?Math.round($/se*100):0,promotePostsPerDay:Le,promoteConfigured:E,networkAcceptanceRate:T,networkConfigured:Ae,engageMeetingsPct:z,engageThisMonthLeads:I,error:!1}}catch{return{key:g.key,name:g.name,periodLeads:0,totalLeads:0,weekLeads:0,lastMonthLeads:0,recentActivity:0,stageCount:0,goalPct:0,promotePostsPerDay:0,promoteConfigured:!1,networkAcceptanceRate:0,networkConfigured:!1,engageMeetingsPct:0,engageThisMonthLeads:0,error:!0}}}));d.sort((g,f)=>f.periodLeads-g.periodLeads);const c=d.filter(g=>!g.error).length||1,m=Math.round(d.reduce((g,f)=>g+f.weekLeads,0)/c*10)/10,h=Math.round(d.reduce((g,f)=>g+f.lastMonthLeads,0)/c*10)/10,y=Math.round(d.reduce((g,f)=>g+f.periodLeads,0)/c*10)/10,b=Math.round(d.reduce((g,f)=>g+f.totalLeads,0)/c*10)/10,v=Math.round(d.reduce((g,f)=>g+f.recentActivity,0)/c*10)/10;return e.json({period:s,totalPeriodLeads:d.reduce((g,f)=>g+f.periodLeads,0),totalAllLeads:d.reduce((g,f)=>g+f.totalLeads,0),totalWeekLeads:d.reduce((g,f)=>g+f.weekLeads,0),totalLastMonthLeads:d.reduce((g,f)=>g+f.lastMonthLeads,0),averages:{weekLeads:m,lastMonthLeads:h,periodLeads:y,totalLeads:b,recentActivity:v},companies:d})}catch(t){return e.json({error:t.message},500)}});S.post("/api/admin/verify-google",async e=>{try{const t=await e.req.json();if(!t.token)return e.json({authorized:!1,error:"No token provided"},400);const s=await Jt(t.token,e.env.GOOGLE_CLIENT_ID);if(!s)return e.json({authorized:!1,error:"Invalid token"},401);const a=Qt.includes(s.email.toLowerCase());return e.json({authorized:a,email:s.email,name:s.name})}catch{return e.json({authorized:!1,error:"Verification failed"},500)}});S.get("/api/admin/streak-key/status",async e=>{try{const t=await e.env.COMPANIES_KV.get("__streak_api_key__");if(t&&e.env.ENCRYPTION_KEY){const s=await Xt(t,e.env.ENCRYPTION_KEY),a=s.length>8?s.substring(0,4)+"****"+s.substring(s.length-4):"****";return e.json({configured:!0,maskedKey:a})}else if(e.env.STREAK_API_KEY){const s=e.env.STREAK_API_KEY,a=s.length>8?s.substring(0,4)+"****"+s.substring(s.length-4):"****";return e.json({configured:!0,maskedKey:a,source:"env"})}return e.json({configured:!1,maskedKey:null})}catch{return e.json({configured:!1,maskedKey:null,error:"Failed to check status"})}});S.post("/api/admin/streak-key",async e=>{try{const t=await e.req.json();if(!t.token||!t.key)return e.json({success:!1,error:"Token and key are required"},400);const s=await Jt(t.token,e.env.GOOGLE_CLIENT_ID);if(!s)return e.json({success:!1,error:"Invalid Google token"},401);if(!Qt.includes(s.email.toLowerCase()))return e.json({success:!1,error:"Unauthorized email"},403);if(!e.env.ENCRYPTION_KEY)return e.json({success:!1,error:"Encryption key not configured on server"},500);const a=await ta(t.key,e.env.ENCRYPTION_KEY);return await e.env.COMPANIES_KV.put("__streak_api_key__",a),e.json({success:!0,message:"Streak API key saved successfully"})}catch{return e.json({success:!1,error:"Failed to save key"},500)}});S.get("/admin",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `):e.redirect("/overview"));const It=new zt,na=Object.assign({"/src/index.tsx":S});let rs=!1;for(const[,e]of Object.entries(na))e&&(It.route("/",e),It.notFound(e.notFoundHandler),rs=!0);if(!rs)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{It as default};
