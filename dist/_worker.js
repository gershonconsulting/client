var bs=Object.defineProperty;var Et=e=>{throw TypeError(e)};var vs=(e,t,s)=>t in e?bs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var k=(e,t,s)=>vs(e,typeof t!="symbol"?t+"":t,s),ht=(e,t,s)=>t.has(e)||Et("Cannot "+s);var p=(e,t,s)=>(ht(e,t,"read from private field"),s?s.call(e):t.get(e)),C=(e,t,s)=>t.has(e)?Et("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w=(e,t,s,a)=>(ht(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),R=(e,t,s)=>(ht(e,t,"access private method"),s);var Ct=(e,t,s,a)=>({set _(n){w(e,t,n,s)},get _(){return p(e,t,a)}});var St=(e,t,s)=>(a,n)=>{let o=-1;return r(0);async function r(i){if(i<=o)throw new Error("next() called multiple times");o=i;let l,d=!1,c;if(e[i]?(c=e[i][0][0],a.req.routeIndex=i):c=i===e.length&&n||void 0,c)try{l=await c(a,()=>r(i+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&s&&(l=await s(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},ws=Symbol(),ks=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,o=(e instanceof $t?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?Es(e,{all:s,dot:a}):{}};async function Es(e,t){const s=await e.formData();return s?Cs(s,t):{}}function Cs(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Ss(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(Is(s,a,n),delete s[a])}),s}var Ss=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Is=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((o,r)=>{r===n.length-1?a[o]=s:((!a[o]||typeof a[o]!="object"||Array.isArray(a[o])||a[o]instanceof File)&&(a[o]=Object.create(null)),a=a[o])})},jt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},As=e=>{const{groups:t,path:s}=Ls(e),a=jt(s);return Ms(a,t)},Ls=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},Ms=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},lt={},Rs=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return lt[a]||(s[2]?lt[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:lt[a]=[e,s[1],!0]),lt[a]}return null},vt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},Ns=e=>vt(e,decodeURI),Ut=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const o=t.indexOf("?",a),r=t.slice(s,o===-1?void 0:o);return Ns(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(n===63)break}return t.slice(s,a)},Ts=e=>{const t=Ut(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},We=(e,t,...s)=>(s.length&&(t=We(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ft=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const o=n.replace("?","");a+="/"+o,s.push(a)}else a+="/"+n}),s.filter((n,o,r)=>r.indexOf(n)===o)},yt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?vt(e,Wt):e):e,Ht=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const i=e.charCodeAt(r+t.length+1);if(i===61){const l=r+t.length+2,d=e.indexOf("&",l);return yt(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";r=e.indexOf(`&${t}`,r+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const r=e.indexOf("&",o+1);let i=e.indexOf("=",o);i>r&&r!==-1&&(i=-1);let l=e.slice(o+1,i===-1?r===-1?void 0:r:i);if(a&&(l=yt(l)),o=r,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,r===-1?void 0:r),a&&(d=yt(d))),s?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},Ds=Ht,Ps=(e,t)=>Ht(e,t,!0),Wt=decodeURIComponent,It=e=>vt(e,Wt),Ke,ce,we,Gt,Kt,bt,Se,Nt,$t=(Nt=class{constructor(e,t="/",s=[[]]){C(this,we);k(this,"raw");C(this,Ke);C(this,ce);k(this,"routeIndex",0);k(this,"path");k(this,"bodyCache",{});C(this,Se,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,w(this,ce,s),w(this,Ke,{})}param(e){return e?R(this,we,Gt).call(this,e):R(this,we,Kt).call(this)}query(e){return Ds(this.url,e)}queries(e){return Ps(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ks(this,e))}json(){return p(this,Se).call(this,"text").then(e=>JSON.parse(e))}text(){return p(this,Se).call(this,"text")}arrayBuffer(){return p(this,Se).call(this,"arrayBuffer")}blob(){return p(this,Se).call(this,"blob")}formData(){return p(this,Se).call(this,"formData")}addValidatedData(e,t){p(this,Ke)[e]=t}valid(e){return p(this,Ke)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ws](){return p(this,ce)}get matchedRoutes(){return p(this,ce)[0].map(([[,e]])=>e)}get routePath(){return p(this,ce)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ke=new WeakMap,ce=new WeakMap,we=new WeakSet,Gt=function(e){const t=p(this,ce)[0][this.routeIndex][1][e],s=R(this,we,bt).call(this,t);return s&&/\%/.test(s)?It(s):s},Kt=function(){const e={},t=Object.keys(p(this,ce)[0][this.routeIndex][1]);for(const s of t){const a=R(this,we,bt).call(this,p(this,ce)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?It(a):a)}return e},bt=function(e){return p(this,ce)[1]?p(this,ce)[1][e]:e},Se=new WeakMap,Nt),Os={Stringify:1},Yt=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(n?n[0]+=e:n=[e],Promise.all(o.map(i=>i({phase:t,buffer:n,context:a}))).then(i=>Promise.all(i.filter(Boolean).map(l=>Yt(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},Bs="text/plain; charset=UTF-8",xt=(e,t)=>({"Content-Type":e,...t}),tt,st,ye,Ye,xe,se,at,Ve,_e,Pe,nt,ot,Ie,$e,Tt,js=(Tt=class{constructor(e,t){C(this,Ie);C(this,tt);C(this,st);k(this,"env",{});C(this,ye);k(this,"finalized",!1);k(this,"error");C(this,Ye);C(this,xe);C(this,se);C(this,at);C(this,Ve);C(this,_e);C(this,Pe);C(this,nt);C(this,ot);k(this,"render",(...e)=>(p(this,Ve)??w(this,Ve,t=>this.html(t)),p(this,Ve).call(this,...e)));k(this,"setLayout",e=>w(this,at,e));k(this,"getLayout",()=>p(this,at));k(this,"setRenderer",e=>{w(this,Ve,e)});k(this,"header",(e,t,s)=>{this.finalized&&w(this,se,new Response(p(this,se).body,p(this,se)));const a=p(this,se)?p(this,se).headers:p(this,Pe)??w(this,Pe,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});k(this,"status",e=>{w(this,Ye,e)});k(this,"set",(e,t)=>{p(this,ye)??w(this,ye,new Map),p(this,ye).set(e,t)});k(this,"get",e=>p(this,ye)?p(this,ye).get(e):void 0);k(this,"newResponse",(...e)=>R(this,Ie,$e).call(this,...e));k(this,"body",(e,t,s)=>R(this,Ie,$e).call(this,e,t,s));k(this,"text",(e,t,s)=>!p(this,Pe)&&!p(this,Ye)&&!t&&!s&&!this.finalized?new Response(e):R(this,Ie,$e).call(this,e,t,xt(Bs,s)));k(this,"json",(e,t,s)=>R(this,Ie,$e).call(this,JSON.stringify(e),t,xt("application/json",s)));k(this,"html",(e,t,s)=>{const a=n=>R(this,Ie,$e).call(this,n,t,xt("text/html; charset=UTF-8",s));return typeof e=="object"?Yt(e,Os.Stringify,!1,{}).then(a):a(e)});k(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});k(this,"notFound",()=>(p(this,_e)??w(this,_e,()=>new Response),p(this,_e).call(this,this)));w(this,tt,e),t&&(w(this,xe,t.executionCtx),this.env=t.env,w(this,_e,t.notFoundHandler),w(this,ot,t.path),w(this,nt,t.matchResult))}get req(){return p(this,st)??w(this,st,new $t(p(this,tt),p(this,ot),p(this,nt))),p(this,st)}get event(){if(p(this,xe)&&"respondWith"in p(this,xe))return p(this,xe);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,xe))return p(this,xe);throw Error("This context has no ExecutionContext")}get res(){return p(this,se)||w(this,se,new Response(null,{headers:p(this,Pe)??w(this,Pe,new Headers)}))}set res(e){if(p(this,se)&&e){e=new Response(e.body,e);for(const[t,s]of p(this,se).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=p(this,se).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}w(this,se,e),this.finalized=!0}get var(){return p(this,ye)?Object.fromEntries(p(this,ye)):{}}},tt=new WeakMap,st=new WeakMap,ye=new WeakMap,Ye=new WeakMap,xe=new WeakMap,se=new WeakMap,at=new WeakMap,Ve=new WeakMap,_e=new WeakMap,Pe=new WeakMap,nt=new WeakMap,ot=new WeakMap,Ie=new WeakSet,$e=function(e,t,s){const a=p(this,se)?new Headers(p(this,se).headers):p(this,Pe)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,i]of o)r.toLowerCase()==="set-cookie"?a.append(r,i):a.set(r,i)}if(s)for(const[o,r]of Object.entries(s))if(typeof r=="string")a.set(o,r);else{a.delete(o);for(const i of r)a.append(o,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??p(this,Ye);return new Response(e,{status:n,headers:a})},Tt),K="ALL",Us="all",Fs=["get","post","put","delete","options","patch"],Vt="Can not add a route since the matcher is already built.",_t=class extends Error{},Hs="__COMPOSED_HANDLER",Ws=e=>e.text("404 Not Found",404),At=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},pe,Y,zt,ge,Te,dt,ct,ze,$s=(ze=class{constructor(t={}){C(this,Y);k(this,"get");k(this,"post");k(this,"put");k(this,"delete");k(this,"options");k(this,"patch");k(this,"all");k(this,"on");k(this,"use");k(this,"router");k(this,"getPath");k(this,"_basePath","/");C(this,pe,"/");k(this,"routes",[]);C(this,ge,Ws);k(this,"errorHandler",At);k(this,"onError",t=>(this.errorHandler=t,this));k(this,"notFound",t=>(w(this,ge,t),this));k(this,"fetch",(t,...s)=>R(this,Y,ct).call(this,t,s[1],s[0],t.method));k(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${We("/",t)}`,s),a,n)));k(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(R(this,Y,ct).call(this,t.request,t,void 0,t.request.method))})});[...Fs,Us].forEach(o=>{this[o]=(r,...i)=>(typeof r=="string"?w(this,pe,r):R(this,Y,Te).call(this,o,p(this,pe),r),i.forEach(l=>{R(this,Y,Te).call(this,o,p(this,pe),l)}),this)}),this.on=(o,r,...i)=>{for(const l of[r].flat()){w(this,pe,l);for(const d of[o].flat())i.map(c=>{R(this,Y,Te).call(this,d.toUpperCase(),p(this,pe),c)})}return this},this.use=(o,...r)=>(typeof o=="string"?w(this,pe,o):(w(this,pe,"*"),r.unshift(o)),r.forEach(i=>{R(this,Y,Te).call(this,K,p(this,pe),i)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Ut:Ts}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var r;let o;s.errorHandler===At?o=n.handler:(o=async(i,l)=>(await St([],s.errorHandler)(i,()=>n.handler(i,l))).res,o[Hs]=n.handler),R(r=a,Y,Te).call(r,n.method,n.path,o)}),this}basePath(t){const s=R(this,Y,zt).call(this);return s._basePath=We(this._basePath,t),s}mount(t,s,a){let n,o;a&&(typeof a=="function"?o=a:(o=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const r=o?l=>{const d=o(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=We(this._basePath,t),d=l==="/"?0:l.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,c)}})());const i=async(l,d)=>{const c=await s(n(l.req.raw),...r(l));if(c)return c;await d()};return R(this,Y,Te).call(this,K,We(t,"*"),i),this}},pe=new WeakMap,Y=new WeakSet,zt=function(){const t=new ze({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,w(t,ge,p(this,ge)),t.routes=this.routes,t},ge=new WeakMap,Te=function(t,s,a){t=t.toUpperCase(),s=We(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},dt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},ct=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await R(this,Y,ct).call(this,t,s,a,"GET")))();const o=this.getPath(t,{env:a}),r=this.router.match(n,o),i=new js(t,{path:o,matchResult:r,env:a,executionCtx:s,notFoundHandler:p(this,ge)});if(r[0].length===1){let d;try{d=r[0][0][0][0](i,async()=>{i.res=await p(this,ge).call(this,i)})}catch(c){return R(this,Y,dt).call(this,c,i)}return d instanceof Promise?d.then(c=>c||(i.finalized?i.res:p(this,ge).call(this,i))).catch(c=>R(this,Y,dt).call(this,c,i)):d??p(this,ge).call(this,i)}const l=St(r[0],this.errorHandler,p(this,ge));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return R(this,Y,dt).call(this,d,i)}})()},ze),qt=[];function Gs(e,t){const s=this.buildAllMatchers(),a=((n,o)=>{const r=s[n]||s[K],i=r[2][o];if(i)return i;const l=o.match(r[0]);if(!l)return[[],qt];const d=l.indexOf("",1);return[r[1][d],l]});return this.match=a,a(e,t)}var gt="[^/]+",Xe=".*",Je="(?:|/.*)",Ge=Symbol(),Ks=new Set(".\\+*[^]$()");function Ys(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Xe||e===Je?1:t===Xe||t===Je?-1:e===gt?1:t===gt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Oe,Be,ue,Fe,Vs=(Fe=class{constructor(){C(this,Oe);C(this,Be);C(this,ue,Object.create(null))}insert(t,s,a,n,o){if(t.length===0){if(p(this,Oe)!==void 0)throw Ge;if(o)return;w(this,Oe,s);return}const[r,...i]=t,l=r==="*"?i.length===0?["","",Xe]:["","",gt]:r==="/*"?["","",Je]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let m=l[2]||gt;if(c&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Ge;if(d=p(this,ue)[m],!d){if(Object.keys(p(this,ue)).some(f=>f!==Xe&&f!==Je))throw Ge;if(o)return;d=p(this,ue)[m]=new Fe,c!==""&&w(d,Be,n.varIndex++)}!o&&c!==""&&a.push([c,p(d,Be)])}else if(d=p(this,ue)[r],!d){if(Object.keys(p(this,ue)).some(c=>c.length>1&&c!==Xe&&c!==Je))throw Ge;if(o)return;d=p(this,ue)[r]=new Fe}d.insert(i,s,a,n,o)}buildRegExpStr(){const s=Object.keys(p(this,ue)).sort(Ys).map(a=>{const n=p(this,ue)[a];return(typeof p(n,Be)=="number"?`(${a})@${p(n,Be)}`:Ks.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof p(this,Oe)=="number"&&s.unshift(`#${p(this,Oe)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Oe=new WeakMap,Be=new WeakMap,ue=new WeakMap,Fe),ut,rt,Dt,_s=(Dt=class{constructor(){C(this,ut,{varIndex:0});C(this,rt,new Vs)}insert(e,t,s){const a=[],n=[];for(let r=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${r}`;return n[r]=[d,l],r++,i=!0,d}),!i)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[i]=n[r];for(let l=o.length-1;l>=0;l--)if(o[l].indexOf(i)!==-1){o[l]=o[l].replace(i,n[r][1]);break}}return p(this,rt).insert(o,t,a,p(this,ut),s),a}buildRegExp(){let e=p(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,r)=>o!==void 0?(s[++t]=Number(o),"$()"):(r!==void 0&&(a[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,a]}},ut=new WeakMap,rt=new WeakMap,Dt),zs=[/^$/,[],Object.create(null)],mt=Object.create(null);function Qt(e){return mt[e]??(mt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function qs(){mt=Object.create(null)}function Qs(e){var d;const t=new _s,s=[];if(e.length===0)return zs;const a=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[f,y])=>c?1:f?-1:m.length-y.length),n=Object.create(null);for(let c=0,m=-1,f=a.length;c<f;c++){const[y,x,v]=a[c];y?n[x]=[v.map(([h])=>[h,Object.create(null)]),qt]:m++;let g;try{g=t.insert(x,m,y)}catch(h){throw h===Ge?new _t(x):h}y||(s[m]=v.map(([h,N])=>{const T=Object.create(null);for(N-=1;N>=0;N--){const[b,A]=g[N];T[b]=A}return[h,T]}))}const[o,r,i]=t.buildRegExp();for(let c=0,m=s.length;c<m;c++)for(let f=0,y=s[c].length;f<y;f++){const x=(d=s[c][f])==null?void 0:d[1];if(!x)continue;const v=Object.keys(x);for(let g=0,h=v.length;g<h;g++)x[v[g]]=i[x[v[g]]]}const l=[];for(const c in r)l[c]=s[r[c]];return[o,l,n]}function He(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(Qt(s).test(t))return[...e[s]]}}var Ae,Le,ft,Zt,Pt,Zs=(Pt=class{constructor(){C(this,ft);k(this,"name","RegExpRouter");C(this,Ae);C(this,Le);k(this,"match",Gs);w(this,Ae,{[K]:Object.create(null)}),w(this,Le,{[K]:Object.create(null)})}add(e,t,s){var i;const a=p(this,Ae),n=p(this,Le);if(!a||!n)throw new Error(Vt);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[K]).forEach(d=>{l[e][d]=[...l[K][d]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Qt(t);e===K?Object.keys(a).forEach(d=>{var c;(c=a[d])[t]||(c[t]=He(a[d],t)||He(a[K],t)||[])}):(i=a[e])[t]||(i[t]=He(a[e],t)||He(a[K],t)||[]),Object.keys(a).forEach(d=>{(e===K||e===d)&&Object.keys(a[d]).forEach(c=>{l.test(c)&&a[d][c].push([s,o])})}),Object.keys(n).forEach(d=>{(e===K||e===d)&&Object.keys(n[d]).forEach(c=>l.test(c)&&n[d][c].push([s,o]))});return}const r=Ft(t)||[t];for(let l=0,d=r.length;l<d;l++){const c=r[l];Object.keys(n).forEach(m=>{var f;(e===K||e===m)&&((f=n[m])[c]||(f[c]=[...He(a[m],c)||He(a[K],c)||[]]),n[m][c].push([s,o-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(p(this,Le)).concat(Object.keys(p(this,Ae))).forEach(t=>{e[t]||(e[t]=R(this,ft,Zt).call(this,t))}),w(this,Ae,w(this,Le,void 0)),qs(),e}},Ae=new WeakMap,Le=new WeakMap,ft=new WeakSet,Zt=function(e){const t=[];let s=e===K;return[p(this,Ae),p(this,Le)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(o=>[o,a[e][o]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==K&&t.push(...Object.keys(a[K]).map(o=>[o,a[K][o]]))}),s?Qs(t):null},Pt),Me,be,Ot,Xs=(Ot=class{constructor(e){k(this,"name","SmartRouter");C(this,Me,[]);C(this,be,[]);w(this,Me,e.routers)}add(e,t,s){if(!p(this,be))throw new Error(Vt);p(this,be).push([e,t,s])}match(e,t){if(!p(this,be))throw new Error("Fatal error");const s=p(this,Me),a=p(this,be),n=s.length;let o=0,r;for(;o<n;o++){const i=s[o];try{for(let l=0,d=a.length;l<d;l++)i.add(...a[l]);r=i.match(e,t)}catch(l){if(l instanceof _t)continue;throw l}this.match=i.match.bind(i),w(this,Me,[i]),w(this,be,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(p(this,be)||p(this,Me).length!==1)throw new Error("No active router has been determined yet.");return p(this,Me)[0]}},Me=new WeakMap,be=new WeakMap,Ot),Ze=Object.create(null),Re,Z,je,qe,z,ve,De,Qe,Js=(Qe=class{constructor(t,s,a){C(this,ve);C(this,Re);C(this,Z);C(this,je);C(this,qe,0);C(this,z,Ze);if(w(this,Z,a||Object.create(null)),w(this,Re,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},w(this,Re,[n])}w(this,je,[])}insert(t,s,a){w(this,qe,++Ct(this,qe)._);let n=this;const o=As(s),r=[];for(let i=0,l=o.length;i<l;i++){const d=o[i],c=o[i+1],m=Rs(d,c),f=Array.isArray(m)?m[0]:d;if(f in p(n,Z)){n=p(n,Z)[f],m&&r.push(m[1]);continue}p(n,Z)[f]=new Qe,m&&(p(n,je).push(m),r.push(m[1])),n=p(n,Z)[f]}return p(n,Re).push({[t]:{handler:a,possibleKeys:r.filter((i,l,d)=>d.indexOf(i)===l),score:p(this,qe)}}),n}search(t,s){var l;const a=[];w(this,z,Ze);let o=[this];const r=jt(s),i=[];for(let d=0,c=r.length;d<c;d++){const m=r[d],f=d===c-1,y=[];for(let x=0,v=o.length;x<v;x++){const g=o[x],h=p(g,Z)[m];h&&(w(h,z,p(g,z)),f?(p(h,Z)["*"]&&a.push(...R(this,ve,De).call(this,p(h,Z)["*"],t,p(g,z))),a.push(...R(this,ve,De).call(this,h,t,p(g,z)))):y.push(h));for(let N=0,T=p(g,je).length;N<T;N++){const b=p(g,je)[N],A=p(g,z)===Ze?{}:{...p(g,z)};if(b==="*"){const W=p(g,Z)["*"];W&&(a.push(...R(this,ve,De).call(this,W,t,p(g,z))),w(W,z,A),y.push(W));continue}const[L,F,q]=b;if(!m&&!(q instanceof RegExp))continue;const H=p(g,Z)[L],Q=r.slice(d).join("/");if(q instanceof RegExp){const W=q.exec(Q);if(W){if(A[F]=W[0],a.push(...R(this,ve,De).call(this,H,t,p(g,z),A)),Object.keys(p(H,Z)).length){w(H,z,A);const U=((l=W[0].match(/\//))==null?void 0:l.length)??0;(i[U]||(i[U]=[])).push(H)}continue}}(q===!0||q.test(m))&&(A[F]=m,f?(a.push(...R(this,ve,De).call(this,H,t,A,p(g,z))),p(H,Z)["*"]&&a.push(...R(this,ve,De).call(this,p(H,Z)["*"],t,A,p(g,z)))):(w(H,z,A),y.push(H)))}}o=y.concat(i.shift()??[])}return a.length>1&&a.sort((d,c)=>d.score-c.score),[a.map(({handler:d,params:c})=>[d,c])]}},Re=new WeakMap,Z=new WeakMap,je=new WeakMap,qe=new WeakMap,z=new WeakMap,ve=new WeakSet,De=function(t,s,a,n){const o=[];for(let r=0,i=p(t,Re).length;r<i;r++){const l=p(t,Re)[r],d=l[s]||l[K],c={};if(d!==void 0&&(d.params=Object.create(null),o.push(d),a!==Ze||n&&n!==Ze))for(let m=0,f=d.possibleKeys.length;m<f;m++){const y=d.possibleKeys[m],x=c[d.score];d.params[y]=n!=null&&n[y]&&!x?n[y]:a[y]??(n==null?void 0:n[y]),c[d.score]=!0}}return o},Qe),Ue,Bt,ea=(Bt=class{constructor(){k(this,"name","TrieRouter");C(this,Ue);w(this,Ue,new Js)}add(e,t,s){const a=Ft(t);if(a){for(let n=0,o=a.length;n<o;n++)p(this,Ue).insert(e,a[n],s);return}p(this,Ue).insert(e,t,s)}match(e,t){return p(this,Ue).search(e,t)}},Ue=new WeakMap,Bt),Xt=class extends $s{constructor(e={}){super(e),this.router=e.router??new Xs({routers:[new Zs,new ea]})}},ta=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(o=>typeof o=="string"?o==="*"?()=>o:r=>o===r?r:null:typeof o=="function"?o:r=>o.includes(r)?r:null)(s.origin),n=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(s.allowMethods);return async function(r,i){var c;function l(m,f){r.res.headers.set(m,f)}const d=await a(r.req.header("origin")||"",r);if(d&&l("Access-Control-Allow-Origin",d),s.credentials&&l("Access-Control-Allow-Credentials","true"),(c=s.exposeHeaders)!=null&&c.length&&l("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),r.req.method==="OPTIONS"){s.origin!=="*"&&l("Vary","Origin"),s.maxAge!=null&&l("Access-Control-Max-Age",s.maxAge.toString());const m=await n(r.req.header("origin")||"",r);m.length&&l("Access-Control-Allow-Methods",m.join(","));let f=s.allowHeaders;if(!(f!=null&&f.length)){const y=r.req.header("Access-Control-Request-Headers");y&&(f=y.split(/\s*,\s*/))}return f!=null&&f.length&&(l("Access-Control-Allow-Headers",f.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await i(),s.origin!=="*"&&r.header("Vary","Origin",{append:!0})}},sa=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Lt=(e,t=na)=>{const s=/\.([a-zA-Z0-9]+?)$/,a=e.match(s);if(!a)return;let n=t[a[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},aa={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},na=aa,oa=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),a=[];for(const n of s)n===".."&&a.length>0&&a.at(-1)!==".."?a.pop():n!=="."&&a.push(n);return a.join("/")||"."},Jt={br:".br",zstd:".zst",gzip:".gz"},ra=Object.keys(Jt),ia="index.html",la=e=>{const t=e.root??"./",s=e.path,a=e.join??oa;return async(n,o)=>{var c,m,f,y;if(n.finalized)return o();let r;if(e.path)r=e.path;else try{if(r=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(r))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),o()}let i=a(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(i)&&(i=a(i,ia));const l=e.getContent;let d=await l(i,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const x=e.mimes&&Lt(i,e.mimes)||Lt(i);if(n.header("Content-Type",x||"application/octet-stream"),e.precompressed&&(!x||sa.test(x))){const v=new Set((m=n.req.header("Accept-Encoding"))==null?void 0:m.split(",").map(g=>g.trim()));for(const g of ra){if(!v.has(g))continue;const h=await l(i+Jt[g],n);if(h){d=h,n.header("Content-Encoding",g),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=e.onFound)==null?void 0:f.call(e,i,n)),n.body(d)}await((y=e.onNotFound)==null?void 0:y.call(e,i,n)),await o()}},da=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const n=s[e]||e;if(!n)return null;const o=await a.get(n,{type:"stream"});return o||null},ca=e=>async function(s,a){return la({...e,getContent:async o=>da(o,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,a)},ma=e=>ca(e);const S=new Xt;S.use("/api/*",ta());S.use("*",async(e,t)=>{try{const s=await e.env.COMPANIES_KV.get("__streak_api_key__");s&&e.env.ENCRYPTION_KEY?pt=await ss(s,e.env.ENCRYPTION_KEY):e.env.STREAK_API_KEY&&(pt=e.env.STREAK_API_KEY)}catch{e.env.STREAK_API_KEY&&(pt=e.env.STREAK_API_KEY)}await t()});S.use("/static/*",ma({root:"./public"}));let pt="";const pa="https://www.streak.com/api/v1",es=["oattia@gmail.com","aina.andriamangason@gmail.com","winnielauren3@gmail.com","zakaria.omahdi@mabsilico.com"];async function ts(e){const t=new TextEncoder,s=await crypto.subtle.digest("SHA-256",t.encode(e));return crypto.subtle.importKey("raw",s,{name:"AES-GCM"},!1,["encrypt","decrypt"])}async function ga(e,t){const s=new TextEncoder,a=await ts(t),n=crypto.getRandomValues(new Uint8Array(12)),o=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},a,s.encode(e)),r=new Uint8Array(n.length+new Uint8Array(o).length);r.set(n),r.set(new Uint8Array(o),n.length);let i="";for(let l=0;l<r.length;l++)i+=String.fromCharCode(r[l]);return btoa(i)}async function ss(e,t){const s=atob(e),a=new Uint8Array(s.length);for(let l=0;l<s.length;l++)a[l]=s.charCodeAt(l);const n=a.slice(0,12),o=a.slice(12),r=await ts(t),i=await crypto.subtle.decrypt({name:"AES-GCM",iv:n},r,o);return new TextDecoder().decode(i)}async function as(e,t){try{const s=await fetch("https://oauth2.googleapis.com/tokeninfo?id_token="+encodeURIComponent(e));if(!s.ok)return null;const a=await s.json();return a.aud!==t||!a.email||a.email_verified!=="true"?null:{email:a.email,name:a.name||a.email}}catch{return null}}const et={mabsilico:{name:"MabSilico",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",networkSheetGid:"910674612",sources:{promote:"",network:"https://docs.google.com/spreadsheets/d/1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw/edit?gid=910674612#gid=910674612",engage:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw"}},"finance-montreal":{name:"Finance Montreal (Steve)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw"},"apm-music":{name:"APM Music",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM"},ducrocq:{name:"Ducrocq",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww"},milvue:{name:"Milvue",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw"},seekyo:{name:"Seekyo Therapeutics",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww"},altavia:{name:"Altavia",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM"},valos:{name:"Valos",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM"},"dab-embedded":{name:"DAB-Embedded",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww"},"finance-montreal-noza":{name:"Finance Montreal (Noza)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw"}},oe=et.mabsilico.pipelineKey,ns="Fit",os="Interest",Mt="1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw";async function O(e){const t=btoa(`${pt}:`),s=await fetch(`${pa}${e}`,{headers:{Authorization:`Basic ${t}`,"Content-Type":"application/json"}});if(!s.ok)throw new Error(`Streak API error: ${s.statusText}`);return s.json()}function wt(e){if(e.includes("docs.google.com")){const t=e.match(/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/),s=e.match(/[?&#]gid=(\d+)/),a=t?t[1]:Mt,n=s?s[1]:"0";return{sheetId:a,gid:n}}return{sheetId:Mt,gid:e}}async function rs(e){try{const{sheetId:t,gid:s}=wt(e),a=`https://docs.google.com/spreadsheets/d/${t}/export?format=csv&gid=${s}`,n=await fetch(a);if(!n.ok)throw new Error(`Google Sheets error: ${n.statusText}`);const r=(await n.text()).split(`
`).filter(b=>b.trim()),i=[];if(r.length<2)return{totalInvitations:0,totalAccepted:0,avgAcceptanceRate:0,thisWeek:{invitations:0,acceptance:0},lastWeek:{invitations:0,acceptance:0},recentWeeks:[],allData:[]};const l=r[0].split(",").map(b=>b.trim().toLowerCase()),d=l[0]==="w"||l[0]==="week",c=d?0:-1;for(let b=1;b<r.length;b++){const L=r[b].split(","),F=3+c,q=4+c,H=7+c,Q=8+c,W=1+c,U=2+c;if(L.length>=(d?9:8)&&L[F]&&L[F].trim()){const re=parseInt(L[F])||0,X=parseInt(L[q])||0,fe=L[H]?L[H].replace("%","").trim():"0",ke=parseFloat(fe)||0;i.push({week:d?L[0]:String(b),from:L[W],to:L[U],invitations:re,messages:X,acceptance:ke,opportunities:Q<L.length&&parseInt(L[Q])||0})}}const m=i.reduce((b,A)=>b+A.invitations,0),f=i.reduce((b,A)=>{const L=Math.min(A.acceptance,100);return b+Math.round(A.invitations*L/100)},0),y=i.map(b=>Math.min(b.acceptance,100)),x=y.length>0?y.reduce((b,A)=>b+A,0)/y.length:0,v=20,g=x>0?x/v*100:0,h=i.slice(-4),N=i[i.length-1]||{invitations:0,acceptance:0},T=i[i.length-2]||{invitations:0,acceptance:0};return{totalInvitations:m,totalAccepted:f,avgAcceptanceRate:Math.round(x*10)/10,networkObjective:v,objectiveAchievement:Math.round(g*10)/10,thisWeek:{invitations:N.invitations,acceptance:Math.min(N.acceptance,100)},lastWeek:{invitations:T.invitations,acceptance:Math.min(T.acceptance,100)},recentWeeks:h.map(b=>({...b,acceptance:Math.min(b.acceptance,100)})),allData:i}}catch(t){return console.error("Error fetching network data:",t),{totalInvitations:0,totalAccepted:0,avgAcceptanceRate:0,thisWeek:{invitations:0,acceptance:0},lastWeek:{invitations:0,acceptance:0},recentWeeks:[],allData:[]}}}async function is(e){try{let t=function(c){const m=[];let f="",y=!1;for(let x=0;x<c.length;x++){const v=c[x];v==='"'?y=!y:v===","&&!y?(m.push(f.trim()),f=""):f+=v}return m.push(f.trim()),m};const{sheetId:s,gid:a}=wt(e),n=`https://docs.google.com/spreadsheets/d/${s}/export?format=csv&gid=${a}`,o=await fetch(n);if(!o.ok)throw new Error(`Google Sheets error: ${o.statusText}`);const i=(await o.text()).split(`
`).filter(c=>c.trim());if(i.length<2)return{campaigns:[],totals:{emailsSent:0,allReplies:0,humanReplies:0,positiveReplies:0,humanReplyRate:0,positiveReplyRate:0}};const l=[];for(let c=1;c<i.length;c++){const m=t(i[c]);m.length<10||l.push({id:m[0],name:m[1],account:m[2],company:m[3],emailsSent:parseInt(m[4])||0,allReplies:parseInt(m[5])||0,humanReplies:parseInt(m[6])||0,positiveReplies:parseInt(m[7])||0,humanReplyRate:parseFloat(m[8])||0,positiveReplyRate:parseFloat(m[9])||0,targeting:m.length>10?m[10]:"",leads:m.length>11&&parseInt(m[11])||0})}const d={emailsSent:l.reduce((c,m)=>c+m.emailsSent,0),allReplies:l.reduce((c,m)=>c+m.allReplies,0),humanReplies:l.reduce((c,m)=>c+m.humanReplies,0),positiveReplies:l.reduce((c,m)=>c+m.positiveReplies,0),humanReplyRate:0,positiveReplyRate:0,leads:l.reduce((c,m)=>c+m.leads,0),campaignCount:l.length};return d.allReplies>0&&(d.humanReplyRate=d.humanReplies/d.allReplies*100,d.positiveReplyRate=d.positiveReplies/d.allReplies*100),{campaigns:l,totals:d}}catch(t){return console.error("Error fetching emailing data:",t),{campaigns:[],totals:{emailsSent:0,allReplies:0,humanReplies:0,positiveReplies:0,humanReplyRate:0,positiveReplyRate:0,leads:0,campaignCount:0}}}}S.get("/api/pipeline",async e=>{try{const t=await O(`/pipelines/${oe}`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});S.get("/api/boxes",async e=>{try{const t=await O(`/pipelines/${oe}/boxes`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});S.get("/api/boxes/:boxKey",async e=>{try{const t=e.req.param("boxKey"),s=await O(`/boxes/${t}`);return e.json(s)}catch(t){return e.json({error:t.message},500)}});S.get("/api/sheets/stage/:stageName/count",async e=>{try{const t=e.req.param("stageName"),[s,a]=await Promise.all([O(`/pipelines/${oe}`),O(`/pipelines/${oe}/boxes`)]),n=s.stageOrder||[],o=Array.isArray(n)?n.map(i=>{var l,d;return{key:i,name:((d=(l=s.stages)==null?void 0:l[i])==null?void 0:d.name)||"Unknown"}}):[],r=Array.isArray(a)?a.filter(i=>{const l=o.find(d=>d&&d.key===i.stageKey);return l&&l.name.toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/priority/:priorityName/count",async e=>{try{const t=e.req.param("priorityName"),[s,a]=await Promise.all([O(`/pipelines/${oe}`),O(`/pipelines/${oe}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name==="Priority"),r=Array.isArray(a)?a.filter(i=>{var f;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="no priority";const l=i.fields[o.key],d=(f=o.dropdownSettings)==null?void 0:f.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"No Priority").toLowerCase().includes(t.toLowerCase())}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/country/:countryName/count",async e=>{try{const t=e.req.param("countryName"),[s,a]=await Promise.all([O(`/pipelines/${oe}`),O(`/pipelines/${oe}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name==="Country"),r=Array.isArray(a)?a.filter(i=>{var f;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="unknown";const l=i.fields[o.key],d=(f=o.dropdownSettings)==null?void 0:f.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"Unknown").toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/total",async e=>{try{const t=await O(`/pipelines/${oe}/boxes`),s=Array.isArray(t)?t.length:0;return e.text(s.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/freshness/:level/count",async e=>{try{const t=e.req.param("level").toLowerCase(),s=await O(`/pipelines/${oe}/boxes`),a=Array.isArray(s)?s.filter(n=>{const o=n.freshness||0;return t==="high"?o>.5:t==="medium"?o>=.2&&o<=.5:t==="low"?o<.2:!1}).length:0;return e.text(a.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/fit/:fitLevel/count",async e=>{try{const t=e.req.param("fitLevel"),[s,a]=await Promise.all([O(`/pipelines/${oe}`),O(`/pipelines/${oe}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name===ns),r=Array.isArray(a)?a.filter(i=>{var f;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="not set";const l=i.fields[o.key],d=(f=o.dropdownSettings)==null?void 0:f.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/interest/:interestLevel/count",async e=>{try{const t=e.req.param("interestLevel"),[s,a]=await Promise.all([O(`/pipelines/${oe}`),O(`/pipelines/${oe}/boxes`)]),o=(Array.isArray(s.fields)?s.fields:[]).find(i=>i&&i.name===os),r=Array.isArray(a)?a.filter(i=>{var f;if(!o||!i.fields||!i.fields[o.key])return t.toLowerCase()==="not set";const l=i.fields[o.key],d=(f=o.dropdownSettings)==null?void 0:f.items,c=Array.isArray(d)?d.find(y=>y&&y.key===l):null;return(c?c.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});function ls(e,t){if(e&&e.startsWith("strk_")&&t){const s=t.match(/\/pipelines\/([a-zA-Z0-9_-]{20,})/);if(s)return s[1]}if(e&&e.includes("/pipelines/")){const s=e.match(/\/pipelines\/([a-zA-Z0-9_-]{20,})/);if(s)return s[1]}return e}async function Ne(e,t){const s=await e.get(`company:${t}`);if(s)return JSON.parse(s);if(et[t]){const a=et[t];return{key:t,name:a.name,pipelineKey:a.pipelineKey,url:a.url||"",networkSheetGid:a.networkSheetGid||"",sources:a.sources||{}}}return null}async function it(e,t=!1){const s={};for(const o of Object.keys(et)){const r=et[o];s[o]={key:o,name:r.name,pipelineKey:r.pipelineKey,url:r.url||"",networkSheetGid:r.networkSheetGid||"",sources:r.sources||{},archived:!1}}const a=await e.list({prefix:"company:"});for(const o of a.keys){const r=await e.get(o.name);if(r){const i=JSON.parse(r);s[i.key]=i}}const n=Object.values(s);return t?n:n.filter(o=>!o.archived)}S.get("/api/companies",async e=>{const t=e.req.query("includeArchived")==="true",s=await it(e.env.COMPANIES_KV,t);return e.json({companies:s,count:s.length})});S.post("/api/companies",async e=>{try{const t=await e.req.json(),{name:s,pipelineKey:a,networkUrl:n,promoteUrl:o,engageUrl:r,notionUrl:i,networkGid:l,key:d,googleChatUrl:c,googleChatWebhookUrl:m,emailingUrl:f,messages:y}=t;if(!s||!a)return e.json({error:"name and pipelineKey are required"},400);const x=d||s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""),v=ls(a,r),g={key:x,name:s,pipelineKey:v,url:r||`https://www.streak.com/a/pipelines/${a}`,sources:{promote:o||"",network:n||"",engage:r||`https://www.streak.com/a/pipelines/${a}`,notion:i||""}};return l&&(g.networkSheetGid=l),c&&(g.googleChatUrl=c),m&&(g.googleChatWebhookUrl=m),y&&y.length>0&&(g.messages=y),f&&(g.emailingUrl=f),await e.env.COMPANIES_KV.put(`company:${x}`,JSON.stringify(g)),e.json({success:!0,company:g})}catch{return e.json({error:"Failed to save company"},500)}});async function ds(e,t){var d,c;const s=/\[leads:([^\]]+)\]/gi,a=[...e.matchAll(s)];if(a.length===0)return e;const[n,o]=await Promise.all([O(`/pipelines/${t}`),O(`/pipelines/${t}/boxes`)]),r=n.stageOrder||[],i={};for(const m of r)i[m]=((c=(d=n.stages)==null?void 0:d[m])==null?void 0:c.name)||"Unknown";let l=e;for(const m of a){const f=m[1],y=Array.isArray(o)?o.filter(x=>(i[x.stageKey]||"").toLowerCase()===f.toLowerCase()).length:0;l=l.replace(m[0],y.toString())}return l}function ua(){const e=new Date,t=-300;e.getUTCHours()*60+e.getUTCMinutes();const s=new Date(e);return s.setUTCMinutes(s.getUTCMinutes()+t),["sunday","monday","tuesday","wednesday","thursday","friday","saturday"][s.getUTCDay()]}S.get("/api/chat/send-messages",async e=>{try{const t=[],s=await it(e.env.COMPANIES_KV),a=ua();for(const n of s){if(!n.googleChatWebhookUrl||!n.messages||!n.pipelineKey)continue;const o=n.messages.filter(r=>r.enabled&&r.dayOfWeek===a);for(const r of o)try{const i=await ds(r.text,n.pipelineKey),l=await fetch(n.googleChatWebhookUrl,{method:"POST",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify({text:i})});t.push({company:n.name,messageId:r.id,sent:l.ok,status:l.status,resolvedText:i})}catch(i){t.push({company:n.name,messageId:r.id,error:i.message,sent:!1})}}return e.json({success:!0,day:a,results:t,timestamp:new Date().toISOString()})}catch(t){return e.json({error:t.message},500)}});S.get("/api/chat/weekly-reminder",async e=>{var t,s;try{const a=[],n=await it(e.env.COMPANIES_KV);for(const o of n)if(!(!o.googleChatWebhookUrl||!o.pipelineKey))try{const[r,i]=await Promise.all([O(`/pipelines/${o.pipelineKey}`),O(`/pipelines/${o.pipelineKey}/boxes`)]),l=r.stageOrder||[],d={};for(const y of l)d[y]=((s=(t=r.stages)==null?void 0:t[y])==null?void 0:s.name)||"Unknown";const c=Array.isArray(i)?i.filter(y=>(d[y.stageKey]||"").toLowerCase()==="lead").length:0,m=`As a reminder, you still have ${c} leads in your Streak that are still at the stage of LEAD, they should be CONTACTED or better. Also, a FIT would be important to share for future campaigns. Thanks.`,f=await fetch(o.googleChatWebhookUrl,{method:"POST",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify({text:m})});a.push({company:o.name,leadCount:c,sent:f.ok,status:f.status})}catch(r){a.push({company:o.name,error:r.message,sent:!1})}return e.json({success:!0,results:a,timestamp:new Date().toISOString()})}catch(a){return e.json({error:a.message},500)}});S.get("/api/chat/send-messages/:companyKey",async e=>{try{const t=e.req.param("companyKey").toLowerCase(),s=await Ne(e.env.COMPANIES_KV,t);if(!s)return e.json({error:"Company not found"},404);if(!s.googleChatWebhookUrl)return e.json({error:`No Google Chat webhook configured for ${s.name}`},400);if(!s.pipelineKey)return e.json({error:`No pipeline key configured for ${s.name}`},400);if(!s.messages||s.messages.length===0)return e.json({error:`No messages configured for ${s.name}`},400);const a=[];for(const n of s.messages)if(n.enabled)try{const o=await ds(n.text,s.pipelineKey),r=await fetch(s.googleChatWebhookUrl,{method:"POST",headers:{"Content-Type":"application/json; charset=UTF-8"},body:JSON.stringify({text:o})});a.push({messageId:n.id,dayOfWeek:n.dayOfWeek,time:n.time,sent:r.ok,resolvedText:o})}catch(o){a.push({messageId:n.id,error:o.message,sent:!1})}return e.json({success:!0,company:s.name,results:a,timestamp:new Date().toISOString()})}catch(t){return e.json({error:t.message},500)}});S.delete("/api/companies/:key",async e=>{try{const t=e.req.param("key");return await e.env.COMPANIES_KV.delete(`company:${t}`),e.json({success:!0})}catch{return e.json({error:"Failed to delete company"},500)}});S.put("/api/companies/:key",async e=>{var t,s,a;try{const n=e.req.param("key"),o=await e.req.json(),{name:r,pipelineKey:i,networkUrl:l,promoteUrl:d,engageUrl:c,networkGid:m,googleChatUrl:f,googleChatWebhookUrl:y,emailingUrl:x,messages:v}=o,h=(await it(e.env.COMPANIES_KV,!0)).find(A=>A.key===n);if(!h)return e.json({error:"Company not found"},404);const{archived:N}=o,T=i?ls(i,c||h.url):h.pipelineKey,b={...h,key:n,name:r||h.name,pipelineKey:T,sources:{promote:d!==void 0?d:((t=h.sources)==null?void 0:t.promote)||"",network:l!==void 0?l:((s=h.sources)==null?void 0:s.network)||"",engage:c!==void 0?c:((a=h.sources)==null?void 0:a.engage)||h.url||""}};return m!==void 0&&(m?b.networkSheetGid=m:delete b.networkSheetGid),c&&(b.url=c),N!==void 0&&(b.archived=N),f!==void 0&&(b.googleChatUrl=f),y!==void 0&&(b.googleChatWebhookUrl=y),v!==void 0&&(b.messages=v),o.emailingUrl!==void 0&&(b.emailingUrl=o.emailingUrl),await e.env.COMPANIES_KV.put(`company:${n}`,JSON.stringify(b)),e.json({success:!0,company:b})}catch{return e.json({error:"Failed to update company"},500)}});S.get("/api/sheets/:companyName/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Ne(e.env.COMPANIES_KV,t);if(!s)return e.text("COMPANY_NOT_FOUND");const a=await O(`/pipelines/${s.pipelineKey}/boxes`),n=Array.isArray(a)?a.length:0;return e.text(n.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/:companyName/month/:yearMonth/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=e.req.param("yearMonth"),a=await Ne(e.env.COMPANIES_KV,t);if(!a)return e.text("COMPANY_NOT_FOUND");const n=await O(`/pipelines/${a.pipelineKey}/boxes`),[o,r]=s.split("-").map(Number),i=Array.isArray(n)?n.filter(l=>{const d=new Date(l.creationTimestamp);return d.getFullYear()===o&&d.getMonth()+1===r}).length:0;return e.text(i.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/:companyName/week/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Ne(e.env.COMPANIES_KV,t);if(!s)return e.text("ERROR");const a=await O(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a))return e.text("0");const o=Date.now()-10080*60*1e3,r=a.filter(i=>(i.creationTimestamp||0)>=o).length;return e.text(r.toString())}catch{return e.text("ERROR")}});S.get("/api/sheets/:companyName/duration/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Ne(e.env.COMPANIES_KV,t);if(!s)return e.text("0");const a=await O(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a)||a.length===0)return e.text("0");const n=a.map(m=>m.creationTimestamp).filter(m=>m);if(n.length===0)return e.text("0");const o=Math.min(...n),r=new Date(o),i=new Date,l=i.getFullYear()-r.getFullYear(),d=i.getMonth()-r.getMonth(),c=l*12+d+1;return e.text(c.toString())}catch{return e.text("0")}});S.get("/api/sheets/:companyName/monthly-stats",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await Ne(e.env.COMPANIES_KV,t);if(!s)return e.json({error:"Company not found"},404);const a=await O(`/pipelines/${s.pipelineKey}/boxes`),n=Array.isArray(a)?a:[],o=new Date,r=[];for(let c=11;c>=0;c--){const m=new Date(o.getFullYear(),o.getMonth()-c,1),f=m.getFullYear(),y=m.getMonth()+1,x=n.filter(g=>{const h=new Date(g.creationTimestamp);return h.getFullYear()===f&&h.getMonth()+1===y}).length,v=(x/10*100).toFixed(1);r.push({month:`${f}-${String(y).padStart(2,"0")}`,count:x,objective:10,percentage:parseFloat(v)})}const i=r.reduce((c,m)=>c+m.count,0),l=(i/12).toFixed(1),d=(parseFloat(l)/10*100).toFixed(1);return e.json({company:s.name,companyKey:t,objective:10,monthlyStats:r,summary:{totalLeads:i,average:parseFloat(l),averagePercentage:parseFloat(d)}})}catch(t){return e.json({error:t.message},500)}});S.get("/api/analytics",async e=>{var t;try{const s=e.req.query("company")||"mabsilico",a=await Ne(e.env.COMPANIES_KV,s);if(!a)return e.json({error:"Invalid company key"},400);const n=a.pipelineKey;if(!n)return e.json({error:`No Streak pipeline key configured for "${a.name}". Please set it in the Admin Panel.`},400);const[o,r]=await Promise.all([O(`/pipelines/${n}`),O(`/pipelines/${n}/boxes`)]),i=Array.isArray(r)?r.length:0,l={},d={},c={},m={},f={},y={},x={"High (>0.5)":0,"Medium (0.2-0.5)":0,"Low (<0.2)":0},v=o.stageOrder||[],g=Array.isArray(v)?v.map(u=>{var I,_;return{key:u,name:((_=(I=o.stages)==null?void 0:I[u])==null?void 0:_.name)||"Unknown"}}):[],h=Array.isArray(o.fields)?o.fields:[],N=h.find(u=>u&&u.name==="Origin"),T=h.find(u=>u&&u.name===ns),b=h.find(u=>u&&u.name===os),A=h.find(u=>u&&u.name==="Est Start Date"),L=h.find(u=>u&&u.name==="Country"),F=h.find(u=>u&&u.name==="Language");Array.isArray(r)&&r.forEach(u=>{var ae,ie,de,ne,ee;if(!u)return;const I=g.find(j=>j&&j.key===u.stageKey),_=I?I.name:"Unknown";if(l[_]=(l[_]||0)+1,N&&u.fields&&u.fields[N.key]){const j=u.fields[N.key],B=(ae=N.dropdownSettings)==null?void 0:ae.items,$=Array.isArray(B)?B.find(P=>P&&P.key===j):null,D=$?$.name:"Unknown";d[D]=(d[D]||0)+1}if(T&&u.fields&&u.fields[T.key]){const j=u.fields[T.key],B=(ie=T.dropdownSettings)==null?void 0:ie.items,$=Array.isArray(B)?B.find(P=>P&&P.key===j):null,D=$?$.name:"Not Set";c[D]=(c[D]||0)+1}else c["Not Set"]=(c["Not Set"]||0)+1;if(b&&u.fields&&u.fields[b.key]){const j=u.fields[b.key],B=(de=b.dropdownSettings)==null?void 0:de.items,$=Array.isArray(B)?B.find(P=>P&&P.key===j):null,D=$?$.name:"Not Set";m[D]=(m[D]||0)+1}else m["Not Set"]=(m["Not Set"]||0)+1;if(L&&u.fields&&u.fields[L.key]){const j=u.fields[L.key],B=(ne=L.dropdownSettings)==null?void 0:ne.items,$=Array.isArray(B)?B.find(P=>P&&P.key===j):null,D=$?$.name:"Unknown";f[D]=(f[D]||0)+1}else f.Unknown=(f.Unknown||0)+1;if(F&&u.fields&&u.fields[F.key]){const j=u.fields[F.key],B=(ee=F.dropdownSettings)==null?void 0:ee.items,$=Array.isArray(B)?B.find(P=>P&&P.key===j):null,D=$?$.name:"Unknown";y[D]=(y[D]||0)+1}else y.Unknown=(y.Unknown||0)+1;const J=u.freshness||0;J>.5?x["High (>0.5)"]++:J>=.2?x["Medium (0.2-0.5)"]++:x["Low (<0.2)"]++});const q={};Object.keys(c).forEach(u=>{q[u]=i>0?(c[u]/i*100).toFixed(1):0});const H={};Object.keys(m).forEach(u=>{H[u]=i>0?(m[u]/i*100).toFixed(1):0});const Q=new Date,W=[],U=10;for(let u=11;u>=0;u--){const I=new Date(Q.getFullYear(),Q.getMonth()-u,1),_=I.getFullYear(),J=I.getMonth()+1,ae=Array.isArray(r)?r.filter(de=>{const ne=new Date(de.creationTimestamp);return ne.getFullYear()===_&&ne.getMonth()+1===J}).length:0,ie=(ae/U*100).toFixed(1);W.push({month:`${_}-${String(J).padStart(2,"0")}`,monthName:I.toLocaleString("en-US",{month:"short",year:"numeric"}),count:ae,objective:U,percentage:parseFloat(ie),status:ae>=U?"achieved":"pending"})}const X=(W.reduce((u,I)=>u+I.count,0)/12).toFixed(1),fe=(parseFloat(X)/U*100).toFixed(1);let ke=0,he=null;if(Array.isArray(r)&&r.length>0){const u=r.map(I=>I.creationTimestamp).filter(I=>I);if(u.length>0){const I=Math.min(...u);he=new Date(I);const _=Q.getFullYear()-he.getFullYear(),J=Q.getMonth()-he.getMonth();ke=_*12+J+1}}let Ee=null;const E=a.networkSheetGid||((t=a.sources)==null?void 0:t.network);E&&(Ee=await rs(E));let M=null;const me=a.emailingUrl;return me&&(M=await is(me)),e.json({company:a.name,companyKey:s,totalBoxes:i,campaignDurationMonths:ke,firstLeadDate:he?he.toISOString():null,networkData:Ee,emailingData:M,stageDistribution:l,originDistribution:d,fitDistribution:c,fitPercentages:q,interestDistribution:m,interestPercentages:H,countryDistribution:f,languageDistribution:y,freshnessDistribution:x,monthlyLeads:W,leadObjective:U,averageLeadsPerMonth:parseFloat(X),averagePercentage:parseFloat(fe),recentBoxes:Array.isArray(r)?r.filter(u=>{var ie,de;const I=T&&u.fields&&u.fields[T.key],_=b&&u.fields&&u.fields[b.key];let J="Not Set";if(I){const ne=u.fields[T.key],ee=(ie=T.dropdownSettings)==null?void 0:ie.items,j=Array.isArray(ee)?ee.find(B=>B&&B.key===ne):null;J=j?j.name:"Not Set"}let ae="Not Set";if(_){const ne=u.fields[b.key],ee=(de=b.dropdownSettings)==null?void 0:de.items,j=Array.isArray(ee)?ee.find(B=>B&&B.key===ne):null;ae=j?j.name:"Not Set"}return J==="High"||ae==="High"}).slice(0,10).map(u=>{var ee,j,B,$;const I=g.find(D=>D&&D.key===u.stageKey);let _="Not Set";if(T&&u.fields&&u.fields[T.key]){const D=u.fields[T.key],P=(ee=T.dropdownSettings)==null?void 0:ee.items,le=Array.isArray(P)?P.find(V=>V&&V.key===D):null;_=le?le.name:"Not Set"}let J="Not Set";if(b&&u.fields&&u.fields[b.key]){const D=u.fields[b.key],P=(j=b.dropdownSettings)==null?void 0:j.items,le=Array.isArray(P)?P.find(V=>V&&V.key===D):null;J=le?le.name:"Not Set"}let ae=null;A&&u.fields&&u.fields[A.key]&&(ae=new Date(u.fields[A.key]).toISOString());let ie="Unknown";if(L&&u.fields&&u.fields[L.key]){const D=u.fields[L.key],P=(B=L.dropdownSettings)==null?void 0:B.items,le=Array.isArray(P)?P.find(V=>V&&V.key===D):null;ie=le?le.name:"Unknown"}let de="Unknown";if(F&&u.fields&&u.fields[F.key]){const D=u.fields[F.key],P=($=F.dropdownSettings)==null?void 0:$.items,le=Array.isArray(P)?P.find(V=>V&&V.key===D):null;de=le?le.name:"Unknown"}const ne=u.freshness||0;return{name:u.name||"Unnamed",key:u.boxKey,stage:I?I.name:"Unknown",fit:_,interest:J,dueDate:ae,country:ie,language:de,freshness:ne.toFixed(3),lastUpdated:new Date(u.lastUpdatedTimestamp).toISOString()}}):[]})}catch(s){return e.json({error:s.message},500)}});async function cs(e){var f,y;const{sheetId:t,gid:s}=wt(e),a=`https://docs.google.com/spreadsheets/d/${t}/export?format=csv&gid=${s}`,n=await fetch(a);if(!n.ok)throw new Error(`Google Sheets error: ${n.statusText}`);const r=(await n.text()).split(`
`).filter(x=>x.trim());if(r.length<2)return{platforms:{}};const i=r[0].split(",").map(x=>x.trim().toLowerCase().replace(/\s+/g,"_")),l=x=>i.indexOf(x),d=[];for(let x=1;x<r.length;x++){const v=r[x].split(",");v.length<5||d.push({date:((f=v[l("date")])==null?void 0:f.trim())||"",platform:(((y=v[l("platform")])==null?void 0:y.trim())||"linkedin").toLowerCase(),followers:parseInt(v[l("follower_count")])||0,impressions:parseFloat(v[l("impressions")])||0,reach:parseInt(v[l("reach")])||0,likes:parseInt(v[l("like_count")])||0,comments:parseInt(v[l("comment_count")])||0,shares:parseInt(v[l("share_count")])||0,clicks:parseInt(v[l("click_count")])||0,engagements:parseInt(v[l("overall_engagements")])||0,engRate:parseFloat(v[l("engagement_rate")])||0,netGrowth:parseInt(v[l("net_audience_growth")])||0,posts:parseInt(v[l("post_count")])||0})}const c={};d.forEach(x=>{c[x.platform]||(c[x.platform]=[]),c[x.platform].push(x)});const m={};for(const[x,v]of Object.entries(c)){const g=[...v].sort((E,M)=>E.date.localeCompare(M.date)),h=g[0].followers,N=g[g.length-1].followers,T=N-h,b=h>0?+(T/h*100).toFixed(1):0,A=g.reduce((E,M)=>E+M.posts,0),L=Math.round(g.reduce((E,M)=>E+M.impressions,0)),F=g.reduce((E,M)=>E+M.reach,0),q=g.reduce((E,M)=>E+M.engagements,0),H=g.reduce((E,M)=>E+M.likes,0),Q=g.reduce((E,M)=>E+M.comments,0),W=g.reduce((E,M)=>E+M.shares,0),U=g.filter(E=>E.impressions>0&&E.engRate>0).map(E=>E.engRate),re=U.length>0?+(U.reduce((E,M)=>E+M,0)/U.length*100).toFixed(2):0,X={};g.forEach(E=>{const M=new Date(E.date),me=M.getDay(),u=new Date(M);u.setDate(M.getDate()-(me===0?6:me-1));const I=u.toISOString().split("T")[0];X[I]||(X[I]={week:I,posts:0,impressions:0,engagements:0,reach:0,netGrowth:0}),X[I].posts+=E.posts,X[I].impressions+=Math.round(E.impressions),X[I].engagements+=E.engagements,X[I].reach+=E.reach,X[I].netGrowth+=E.netGrowth});const fe=Object.values(X).sort((E,M)=>E.week.localeCompare(M.week)),ke=fe.length||1,he=+(A/ke).toFixed(1),Ee=g.map(E=>({date:E.date,followers:E.followers,posts:E.posts,impressions:Math.round(E.impressions),engagements:E.engagements,reach:E.reach}));m[x]={followersStart:h,followersEnd:N,followersGrowth:T,followersGrowthPct:b,totalPosts:A,avgPostsPerWeek:he,totalImpressions:L,totalReach:F,totalEngagements:q,totalLikes:H,totalComments:Q,totalShares:W,avgEngRate:re,weeklyBreakdown:fe,dailyData:Ee,dateRange:{from:g[0].date,to:g[g.length-1].date}}}return{platforms:m}}S.get("/api/promote",async e=>{var t;try{const s=e.req.query("company")||"mabsilico",a=await Ne(e.env.COMPANIES_KV,s);if(!a)return e.json({error:"Company not found"},404);const n=((t=a.sources)==null?void 0:t.promote)||"";if(!n)return e.json({error:"No promote URL configured for this company"},404);const o=await cs(n);return e.json(o)}catch(s){return e.json({error:s.message},500)}});S.get("/api/overview",async e=>{try{let t=function(g){let h=0,N=a;return g==="week"?h=a-6048e5:g==="last-month"?(h=new Date(n.getFullYear(),n.getMonth()-1,1).getTime(),N=new Date(n.getFullYear(),n.getMonth(),1).getTime()):g==="this-month"?h=new Date(n.getFullYear(),n.getMonth(),1).getTime():g==="year"&&(h=new Date(n.getFullYear(),0,1).getTime()),{start:h,end:N}};const s=e.req.query("period")||"this-month",a=Date.now(),n=new Date,o={start:a-10080*60*1e3,end:a},r={start:new Date(n.getFullYear(),n.getMonth()-1,1).getTime(),end:new Date(n.getFullYear(),n.getMonth(),1).getTime()},i=t(s),l=await it(e.env.COMPANIES_KV),d=await Promise.all(l.map(async g=>{var h,N,T,b;try{let A=function(G,te){return re.filter(Ce=>{const kt=Ce.creationTimestamp||0;return kt>=G&&kt<te}).length};const L=((h=g.sources)==null?void 0:h.promote)||"",F=g.networkSheetGid||((N=g.sources)==null?void 0:N.network)||"",q=((T=g.sources)==null?void 0:T.emailing)||"",[H,Q,W,U]=await Promise.all([O(`/pipelines/${g.pipelineKey}/boxes`).catch(()=>[]),L?cs(L).catch(()=>({platforms:{}})):Promise.resolve({platforms:{}}),F?rs(F).catch(()=>({avgAcceptanceRate:0,totalInvitations:0,totalAccepted:0})):Promise.resolve({avgAcceptanceRate:0,totalInvitations:0,totalAccepted:0}),q?is(q).catch(()=>({campaigns:[],totals:{emailsSent:0,humanReplies:0,humanReplyRate:0,positiveReplies:0,positiveReplyRate:0,leads:0,campaignCount:0}})):Promise.resolve({campaigns:[],totals:{emailsSent:0,humanReplies:0,humanReplyRate:0,positiveReplies:0,positiveReplyRate:0,leads:0,campaignCount:0}})]),re=Array.isArray(H)?H:[],X=re.length,fe=A(i.start,i.end),ke=A(o.start,o.end),he=A(r.start,r.end),Ee={};re.forEach(G=>{const te=G.stageKey||"Unknown";Ee[te]=(Ee[te]||0)+1});const E=re.filter(G=>(G.lastUpdatedTimestamp||0)>=o.start).length,M=10;let me=M;if(s==="week")me=Math.round(M/30*7);else if(s==="year")me=M*12;else if(s==="all"){const G=re.map(te=>te.creationTimestamp).filter(Boolean);if(G.length>0){const te=new Date(Math.min(...G)),Ce=(n.getFullYear()-te.getFullYear())*12+(n.getMonth()-te.getMonth())+1;me=M*Math.max(Ce,1)}}let u=0,I=!1;if(L&&Q.platforms){I=!0;let G=0,te=0;for(const Ce of Object.values(Q.platforms))G+=Ce.totalPosts||0,Ce.dailyData&&Ce.dailyData.length>te&&(te=Ce.dailyData.length);u=te>0?Math.round(G/te*10)/10:0}const _=W.avgAcceptanceRate||0,J=!!F,ae=new Date(n.getFullYear(),n.getMonth(),1).getTime(),ie=re.filter(G=>(G.creationTimestamp||0)>=ae).length,de=Math.round(ie/10*100),ne=re.map(G=>G.creationTimestamp).filter(Boolean),ee=ne.length>0?Math.min(...ne):0,j=ee>0?Math.max(1,Math.round((a-ee)/(30.44*24*60*60*1e3))):0;let B=0,$=0,D=0;if(L&&Q.platforms)for(const G of Object.values(Q.platforms))B+=G.totalPosts||0,$+=G.totalImpressions||0,D+=G.latestFollowers||G.totalFollowers||0;const P=W.totalInvitations||0,le=W.totalAccepted||0,V=(U==null?void 0:U.totals)||{},ps=V.emailsSent||0,gs=V.humanReplies||0,us=V.humanReplyRate||0,fs=V.positiveReplies||0,hs=V.positiveReplyRate||0,ys=V.leads||0,xs=((b=U==null?void 0:U.campaigns)==null?void 0:b.length)||0;return{key:g.key,name:g.name,periodLeads:fe,totalLeads:X,weekLeads:ke,lastMonthLeads:he,recentActivity:E,stageCount:Object.keys(Ee).length,goalPct:me>0?Math.round(fe/me*100):0,promotePostsPerDay:u,promoteConfigured:I,promoteTotalPosts:B,promoteTotalImpressions:$,promoteFollowers:D,networkAcceptanceRate:_,networkConfigured:J,networkInvitations:P,networkAccepted:le,engageMeetingsPct:de,engageThisMonthLeads:ie,emailsSent:ps,emailHumanReplies:gs,emailReplyRate:us,emailPositiveReplies:fs,emailPositiveRate:hs,emailLeads:ys,emailCampaignCount:xs,emailConfigured:!!q,campaignMonths:j,firstLeadTs:ee,error:!1}}catch{return{key:g.key,name:g.name,periodLeads:0,totalLeads:0,weekLeads:0,lastMonthLeads:0,recentActivity:0,stageCount:0,goalPct:0,promotePostsPerDay:0,promoteConfigured:!1,promoteTotalPosts:0,promoteTotalImpressions:0,promoteFollowers:0,networkAcceptanceRate:0,networkConfigured:!1,networkInvitations:0,networkAccepted:0,engageMeetingsPct:0,engageThisMonthLeads:0,emailsSent:0,emailHumanReplies:0,emailReplyRate:0,emailPositiveReplies:0,emailPositiveRate:0,emailLeads:0,emailCampaignCount:0,emailConfigured:!1,campaignMonths:0,firstLeadTs:0,error:!0}}}));d.sort((g,h)=>h.periodLeads-g.periodLeads);const c=d.filter(g=>!g.error).length||1,m=Math.round(d.reduce((g,h)=>g+h.weekLeads,0)/c*10)/10,f=Math.round(d.reduce((g,h)=>g+h.lastMonthLeads,0)/c*10)/10,y=Math.round(d.reduce((g,h)=>g+h.periodLeads,0)/c*10)/10,x=Math.round(d.reduce((g,h)=>g+h.totalLeads,0)/c*10)/10,v=Math.round(d.reduce((g,h)=>g+h.recentActivity,0)/c*10)/10;return e.json({period:s,totalPeriodLeads:d.reduce((g,h)=>g+h.periodLeads,0),totalAllLeads:d.reduce((g,h)=>g+h.totalLeads,0),totalWeekLeads:d.reduce((g,h)=>g+h.weekLeads,0),totalLastMonthLeads:d.reduce((g,h)=>g+h.lastMonthLeads,0),averages:{weekLeads:m,lastMonthLeads:f,periodLeads:y,totalLeads:x,recentActivity:v},companies:d})}catch(t){return e.json({error:t.message},500)}});S.post("/api/admin/verify-google",async e=>{try{const t=await e.req.json();if(!t.token)return e.json({authorized:!1,error:"No token provided"},400);const s=await as(t.token,e.env.GOOGLE_CLIENT_ID);if(!s)return e.json({authorized:!1,error:"Invalid token"},401);const a=es.includes(s.email.toLowerCase());return e.json({authorized:a,email:s.email,name:s.name})}catch{return e.json({authorized:!1,error:"Verification failed"},500)}});S.get("/api/admin/streak-key/status",async e=>{try{const t=await e.env.COMPANIES_KV.get("__streak_api_key__");if(t&&e.env.ENCRYPTION_KEY){const s=await ss(t,e.env.ENCRYPTION_KEY),a=s.length>8?s.substring(0,4)+"****"+s.substring(s.length-4):"****";return e.json({configured:!0,maskedKey:a})}else if(e.env.STREAK_API_KEY){const s=e.env.STREAK_API_KEY,a=s.length>8?s.substring(0,4)+"****"+s.substring(s.length-4):"****";return e.json({configured:!0,maskedKey:a,source:"env"})}return e.json({configured:!1,maskedKey:null})}catch{return e.json({configured:!1,maskedKey:null,error:"Failed to check status"})}});S.post("/api/admin/streak-key",async e=>{try{const t=await e.req.json();if(!t.token||!t.key)return e.json({success:!1,error:"Token and key are required"},400);const s=await as(t.token,e.env.GOOGLE_CLIENT_ID);if(!s)return e.json({success:!1,error:"Invalid Google token"},401);if(!es.includes(s.email.toLowerCase()))return e.json({success:!1,error:"Unauthorized email"},403);if(!e.env.ENCRYPTION_KEY)return e.json({success:!1,error:"Encryption key not configured on server"},500);const a=await ga(t.key,e.env.ENCRYPTION_KEY);return await e.env.COMPANIES_KV.put("__streak_api_key__",a),e.json({success:!0,message:"Streak API key saved successfully"})}catch{return e.json({success:!1,error:"Failed to save key"},500)}});S.get("/admin",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
        ...
        <div class="bg-white shadow-lg border-b-4 border-blue-600">
            <div class="max-w-7xl mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-sm text-gray-600">Version <strong>1.3.18</strong></span>
  ...
  `));S.get("/",e=>e.req.query("company")?e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `):e.redirect("/overview"));const Rt=new Xt,fa=Object.assign({"/src/index.tsx":S});let ms=!1;for(const[,e]of Object.entries(fa))e&&(Rt.route("/",e),Rt.notFound(e.notFoundHandler),ms=!0);if(!ms)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Rt as default};
