var Yt=Object.defineProperty;var mt=e=>{throw TypeError(e)};var Kt=(e,t,s)=>t in e?Yt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var h=(e,t,s)=>Kt(e,typeof t!="symbol"?t+"":t,s),at=(e,t,s)=>t.has(e)||mt("Cannot "+s);var d=(e,t,s)=>(at(e,t,"read from private field"),s?s.call(e):t.get(e)),v=(e,t,s)=>t.has(e)?mt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),y=(e,t,s,a)=>(at(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),E=(e,t,s)=>(at(e,t,"access private method"),s);var pt=(e,t,s,a)=>({set _(n){y(e,t,n,s)},get _(){return d(e,t,a)}});var ut=(e,t,s)=>(a,n)=>{let r=-1;return o(0);async function o(l){if(l<=r)throw new Error("next() called multiple times");r=l;let c,i=!1,m;if(e[l]?(m=e[l][0][0],a.req.routeIndex=l):m=l===e.length&&n||void 0,m)try{c=await m(a,()=>o(l+1))}catch(u){if(u instanceof Error&&t)a.error=u,c=await t(u,a),i=!0;else throw u}else a.finalized===!1&&s&&(c=await s(a));return c&&(a.finalized===!1||i)&&(a.res=c),a}},Vt=Symbol(),zt=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,r=(e instanceof Rt?e.raw.headers:e.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?Qt(e,{all:s,dot:a}):{}};async function Qt(e,t){const s=await e.formData();return s?Xt(s,t):{}}function Xt(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Zt(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(qt(s,a,n),delete s[a])}),s}var Zt=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},qt=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((r,o)=>{o===n.length-1?a[r]=s:((!a[r]||typeof a[r]!="object"||Array.isArray(a[r])||a[r]instanceof File)&&(a[r]=Object.create(null)),a=a[r])})},Ct=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Jt=e=>{const{groups:t,path:s}=es(e),a=Ct(s);return ts(a,t)},es=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},ts=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},Qe={},ss=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return Qe[a]||(s[2]?Qe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Qe[a]=[e,s[1],!0]),Qe[a]}return null},it=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},as=e=>it(e,decodeURI),St=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const r=t.indexOf("?",a),o=t.slice(s,r===-1?void 0:r);return as(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63)break}return t.slice(s,a)},ns=e=>{const t=St(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ae=(e,t,...s)=>(s.length&&(t=Ae(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),At=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const r=n.replace("?","");a+="/"+r,s.push(a)}else a+="/"+n}),s.filter((n,r,o)=>o.indexOf(n)===r)},nt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?it(e,Nt):e):e,It=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const l=e.charCodeAt(o+t.length+1);if(l===61){const c=o+t.length+2,i=e.indexOf("&",c);return nt(e.slice(c,i===-1?void 0:i))}else if(l==38||isNaN(l))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let r=e.indexOf("?",8);for(;r!==-1;){const o=e.indexOf("&",r+1);let l=e.indexOf("=",r);l>o&&o!==-1&&(l=-1);let c=e.slice(r+1,l===-1?o===-1?void 0:o:l);if(a&&(c=nt(c)),r=o,c==="")continue;let i;l===-1?i="":(i=e.slice(l+1,o===-1?void 0:o),a&&(i=nt(i))),s?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(i)):n[c]??(n[c]=i)}return t?n[t]:n},rs=It,os=(e,t)=>It(e,t,!0),Nt=decodeURIComponent,gt=e=>it(e,Nt),Re,K,le,Tt,Lt,ot,de,bt,Rt=(bt=class{constructor(e,t="/",s=[[]]){v(this,le);h(this,"raw");v(this,Re);v(this,K);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});v(this,de,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(r=>(n==="json"&&(r=JSON.stringify(r)),new Response(r)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,y(this,K,s),y(this,Re,{})}param(e){return e?E(this,le,Tt).call(this,e):E(this,le,Lt).call(this)}query(e){return rs(this.url,e)}queries(e){return os(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await zt(this,e))}json(){return d(this,de).call(this,"text").then(e=>JSON.parse(e))}text(){return d(this,de).call(this,"text")}arrayBuffer(){return d(this,de).call(this,"arrayBuffer")}blob(){return d(this,de).call(this,"blob")}formData(){return d(this,de).call(this,"formData")}addValidatedData(e,t){d(this,Re)[e]=t}valid(e){return d(this,Re)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Vt](){return d(this,K)}get matchedRoutes(){return d(this,K)[0].map(([[,e]])=>e)}get routePath(){return d(this,K)[0].map(([[,e]])=>e)[this.routeIndex].path}},Re=new WeakMap,K=new WeakMap,le=new WeakSet,Tt=function(e){const t=d(this,K)[0][this.routeIndex][1][e],s=E(this,le,ot).call(this,t);return s&&/\%/.test(s)?gt(s):s},Lt=function(){const e={},t=Object.keys(d(this,K)[0][this.routeIndex][1]);for(const s of t){const a=E(this,le,ot).call(this,d(this,K)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?gt(a):a)}return e},ot=function(e){return d(this,K)[1]?d(this,K)[1][e]:e},de=new WeakMap,bt),is={Stringify:1},Mt=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const r=e.callbacks;return r!=null&&r.length?(n?n[0]+=e:n=[e],Promise.all(r.map(l=>l({phase:t,buffer:n,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(c=>Mt(c,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},ls="text/plain; charset=UTF-8",rt=(e,t)=>({"Content-Type":e,...t}),$e,_e,ne,Te,re,B,He,Le,Me,xe,Ye,Ke,me,Ie,xt,cs=(xt=class{constructor(e,t){v(this,me);v(this,$e);v(this,_e);h(this,"env",{});v(this,ne);h(this,"finalized",!1);h(this,"error");v(this,Te);v(this,re);v(this,B);v(this,He);v(this,Le);v(this,Me);v(this,xe);v(this,Ye);v(this,Ke);h(this,"render",(...e)=>(d(this,Le)??y(this,Le,t=>this.html(t)),d(this,Le).call(this,...e)));h(this,"setLayout",e=>y(this,He,e));h(this,"getLayout",()=>d(this,He));h(this,"setRenderer",e=>{y(this,Le,e)});h(this,"header",(e,t,s)=>{this.finalized&&y(this,B,new Response(d(this,B).body,d(this,B)));const a=d(this,B)?d(this,B).headers:d(this,xe)??y(this,xe,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});h(this,"status",e=>{y(this,Te,e)});h(this,"set",(e,t)=>{d(this,ne)??y(this,ne,new Map),d(this,ne).set(e,t)});h(this,"get",e=>d(this,ne)?d(this,ne).get(e):void 0);h(this,"newResponse",(...e)=>E(this,me,Ie).call(this,...e));h(this,"body",(e,t,s)=>E(this,me,Ie).call(this,e,t,s));h(this,"text",(e,t,s)=>!d(this,xe)&&!d(this,Te)&&!t&&!s&&!this.finalized?new Response(e):E(this,me,Ie).call(this,e,t,rt(ls,s)));h(this,"json",(e,t,s)=>E(this,me,Ie).call(this,JSON.stringify(e),t,rt("application/json",s)));h(this,"html",(e,t,s)=>{const a=n=>E(this,me,Ie).call(this,n,t,rt("text/html; charset=UTF-8",s));return typeof e=="object"?Mt(e,is.Stringify,!1,{}).then(a):a(e)});h(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});h(this,"notFound",()=>(d(this,Me)??y(this,Me,()=>new Response),d(this,Me).call(this,this)));y(this,$e,e),t&&(y(this,re,t.executionCtx),this.env=t.env,y(this,Me,t.notFoundHandler),y(this,Ke,t.path),y(this,Ye,t.matchResult))}get req(){return d(this,_e)??y(this,_e,new Rt(d(this,$e),d(this,Ke),d(this,Ye))),d(this,_e)}get event(){if(d(this,re)&&"respondWith"in d(this,re))return d(this,re);throw Error("This context has no FetchEvent")}get executionCtx(){if(d(this,re))return d(this,re);throw Error("This context has no ExecutionContext")}get res(){return d(this,B)||y(this,B,new Response(null,{headers:d(this,xe)??y(this,xe,new Headers)}))}set res(e){if(d(this,B)&&e){e=new Response(e.body,e);for(const[t,s]of d(this,B).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=d(this,B).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}y(this,B,e),this.finalized=!0}get var(){return d(this,ne)?Object.fromEntries(d(this,ne)):{}}},$e=new WeakMap,_e=new WeakMap,ne=new WeakMap,Te=new WeakMap,re=new WeakMap,B=new WeakMap,He=new WeakMap,Le=new WeakMap,Me=new WeakMap,xe=new WeakMap,Ye=new WeakMap,Ke=new WeakMap,me=new WeakSet,Ie=function(e,t,s){const a=d(this,B)?new Headers(d(this,B).headers):d(this,xe)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,l]of r)o.toLowerCase()==="set-cookie"?a.append(o,l):a.set(o,l)}if(s)for(const[r,o]of Object.entries(s))if(typeof o=="string")a.set(r,o);else{a.delete(r);for(const l of o)a.append(r,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??d(this,Te);return new Response(e,{status:n,headers:a})},xt),O="ALL",ds="all",ms=["get","post","put","delete","options","patch"],Dt="Can not add a route since the matcher is already built.",Ot=class extends Error{},ps="__COMPOSED_HANDLER",us=e=>e.text("404 Not Found",404),ft=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},Z,F,Ft,q,he,Xe,Ze,De,gs=(De=class{constructor(t={}){v(this,F);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");v(this,Z,"/");h(this,"routes",[]);v(this,q,us);h(this,"errorHandler",ft);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(y(this,q,t),this));h(this,"fetch",(t,...s)=>E(this,F,Ze).call(this,t,s[1],s[0],t.method));h(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ae("/",t)}`,s),a,n)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(E(this,F,Ze).call(this,t.request,t,void 0,t.request.method))})});[...ms,ds].forEach(r=>{this[r]=(o,...l)=>(typeof o=="string"?y(this,Z,o):E(this,F,he).call(this,r,d(this,Z),o),l.forEach(c=>{E(this,F,he).call(this,r,d(this,Z),c)}),this)}),this.on=(r,o,...l)=>{for(const c of[o].flat()){y(this,Z,c);for(const i of[r].flat())l.map(m=>{E(this,F,he).call(this,i.toUpperCase(),d(this,Z),m)})}return this},this.use=(r,...o)=>(typeof r=="string"?y(this,Z,r):(y(this,Z,"*"),o.unshift(r)),o.forEach(l=>{E(this,F,he).call(this,O,d(this,Z),l)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??St:ns}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var o;let r;s.errorHandler===ft?r=n.handler:(r=async(l,c)=>(await ut([],s.errorHandler)(l,()=>n.handler(l,c))).res,r[ps]=n.handler),E(o=a,F,he).call(o,n.method,n.path,r)}),this}basePath(t){const s=E(this,F,Ft).call(this);return s._basePath=Ae(this._basePath,t),s}mount(t,s,a){let n,r;a&&(typeof a=="function"?r=a:(r=a.optionHandler,a.replaceRequest===!1?n=c=>c:n=a.replaceRequest));const o=r?c=>{const i=r(c);return Array.isArray(i)?i:[i]}:c=>{let i;try{i=c.executionCtx}catch{}return[c.env,i]};n||(n=(()=>{const c=Ae(this._basePath,t),i=c==="/"?0:c.length;return m=>{const u=new URL(m.url);return u.pathname=u.pathname.slice(i)||"/",new Request(u,m)}})());const l=async(c,i)=>{const m=await s(n(c.req.raw),...o(c));if(m)return m;await i()};return E(this,F,he).call(this,O,Ae(t,"*"),l),this}},Z=new WeakMap,F=new WeakSet,Ft=function(){const t=new De({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,y(t,q,d(this,q)),t.routes=this.routes,t},q=new WeakMap,he=function(t,s,a){t=t.toUpperCase(),s=Ae(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},Xe=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Ze=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await E(this,F,Ze).call(this,t,s,a,"GET")))();const r=this.getPath(t,{env:a}),o=this.router.match(n,r),l=new cs(t,{path:r,matchResult:o,env:a,executionCtx:s,notFoundHandler:d(this,q)});if(o[0].length===1){let i;try{i=o[0][0][0][0](l,async()=>{l.res=await d(this,q).call(this,l)})}catch(m){return E(this,F,Xe).call(this,m,l)}return i instanceof Promise?i.then(m=>m||(l.finalized?l.res:d(this,q).call(this,l))).catch(m=>E(this,F,Xe).call(this,m,l)):i??d(this,q).call(this,l)}const c=ut(o[0],this.errorHandler,d(this,q));return(async()=>{try{const i=await c(l);if(!i.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return i.res}catch(i){return E(this,F,Xe).call(this,i,l)}})()},De),Pt=[];function fs(e,t){const s=this.buildAllMatchers(),a=((n,r)=>{const o=s[n]||s[O],l=o[2][r];if(l)return l;const c=r.match(o[0]);if(!c)return[[],Pt];const i=c.indexOf("",1);return[o[1][i],c]});return this.match=a,a(e,t)}var Je="[^/]+",Be=".*",Ge="(?:|/.*)",Ne=Symbol(),ys=new Set(".\\+*[^]$()");function hs(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Be||e===Ge?1:t===Be||t===Ge?-1:e===Je?1:t===Je?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ve,we,J,Ce,bs=(Ce=class{constructor(){v(this,ve);v(this,we);v(this,J,Object.create(null))}insert(t,s,a,n,r){if(t.length===0){if(d(this,ve)!==void 0)throw Ne;if(r)return;y(this,ve,s);return}const[o,...l]=t,c=o==="*"?l.length===0?["","",Be]:["","",Je]:o==="/*"?["","",Ge]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let i;if(c){const m=c[1];let u=c[2]||Je;if(m&&c[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw Ne;if(i=d(this,J)[u],!i){if(Object.keys(d(this,J)).some(g=>g!==Be&&g!==Ge))throw Ne;if(r)return;i=d(this,J)[u]=new Ce,m!==""&&y(i,we,n.varIndex++)}!r&&m!==""&&a.push([m,d(i,we)])}else if(i=d(this,J)[o],!i){if(Object.keys(d(this,J)).some(m=>m.length>1&&m!==Be&&m!==Ge))throw Ne;if(r)return;i=d(this,J)[o]=new Ce}i.insert(l,s,a,n,r)}buildRegExpStr(){const s=Object.keys(d(this,J)).sort(hs).map(a=>{const n=d(this,J)[a];return(typeof d(n,we)=="number"?`(${a})@${d(n,we)}`:ys.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof d(this,ve)=="number"&&s.unshift(`#${d(this,ve)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},ve=new WeakMap,we=new WeakMap,J=new WeakMap,Ce),et,Ve,vt,xs=(vt=class{constructor(){v(this,et,{varIndex:0});v(this,Ve,new bs)}insert(e,t,s){const a=[],n=[];for(let o=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const i=`@\\${o}`;return n[o]=[i,c],o++,l=!0,i}),!l)break}const r=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[l]=n[o];for(let c=r.length-1;c>=0;c--)if(r[c].indexOf(l)!==-1){r[c]=r[c].replace(l,n[o][1]);break}}return d(this,Ve).insert(r,t,a,d(this,et),s),a}buildRegExp(){let e=d(this,Ve).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,r,o)=>r!==void 0?(s[++t]=Number(r),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),s,a]}},et=new WeakMap,Ve=new WeakMap,vt),vs=[/^$/,[],Object.create(null)],qe=Object.create(null);function jt(e){return qe[e]??(qe[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ws(){qe=Object.create(null)}function Es(e){var i;const t=new xs,s=[];if(e.length===0)return vs;const a=e.map(m=>[!/\*|\/:/.test(m[0]),...m]).sort(([m,u],[g,f])=>m?1:g?-1:u.length-f.length),n=Object.create(null);for(let m=0,u=-1,g=a.length;m<g;m++){const[f,k,w]=a[m];f?n[k]=[w.map(([x])=>[x,Object.create(null)]),Pt]:u++;let b;try{b=t.insert(k,u,f)}catch(x){throw x===Ne?new Ot(k):x}f||(s[u]=w.map(([x,N])=>{const D=Object.create(null);for(N-=1;N>=0;N--){const[ee,L]=b[N];D[ee]=L}return[x,D]}))}const[r,o,l]=t.buildRegExp();for(let m=0,u=s.length;m<u;m++)for(let g=0,f=s[m].length;g<f;g++){const k=(i=s[m][g])==null?void 0:i[1];if(!k)continue;const w=Object.keys(k);for(let b=0,x=w.length;b<x;b++)k[w[b]]=l[k[w[b]]]}const c=[];for(const m in o)c[m]=s[o[m]];return[r,c,n]}function Se(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(jt(s).test(t))return[...e[s]]}}var pe,ue,tt,Ut,wt,ks=(wt=class{constructor(){v(this,tt);h(this,"name","RegExpRouter");v(this,pe);v(this,ue);h(this,"match",fs);y(this,pe,{[O]:Object.create(null)}),y(this,ue,{[O]:Object.create(null)})}add(e,t,s){var l;const a=d(this,pe),n=d(this,ue);if(!a||!n)throw new Error(Dt);a[e]||[a,n].forEach(c=>{c[e]=Object.create(null),Object.keys(c[O]).forEach(i=>{c[e][i]=[...c[O][i]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=jt(t);e===O?Object.keys(a).forEach(i=>{var m;(m=a[i])[t]||(m[t]=Se(a[i],t)||Se(a[O],t)||[])}):(l=a[e])[t]||(l[t]=Se(a[e],t)||Se(a[O],t)||[]),Object.keys(a).forEach(i=>{(e===O||e===i)&&Object.keys(a[i]).forEach(m=>{c.test(m)&&a[i][m].push([s,r])})}),Object.keys(n).forEach(i=>{(e===O||e===i)&&Object.keys(n[i]).forEach(m=>c.test(m)&&n[i][m].push([s,r]))});return}const o=At(t)||[t];for(let c=0,i=o.length;c<i;c++){const m=o[c];Object.keys(n).forEach(u=>{var g;(e===O||e===u)&&((g=n[u])[m]||(g[m]=[...Se(a[u],m)||Se(a[O],m)||[]]),n[u][m].push([s,r-i+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(d(this,ue)).concat(Object.keys(d(this,pe))).forEach(t=>{e[t]||(e[t]=E(this,tt,Ut).call(this,t))}),y(this,pe,y(this,ue,void 0)),ws(),e}},pe=new WeakMap,ue=new WeakMap,tt=new WeakSet,Ut=function(e){const t=[];let s=e===O;return[d(this,pe),d(this,ue)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(r=>[r,a[e][r]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==O&&t.push(...Object.keys(a[O]).map(r=>[r,a[O][r]]))}),s?Es(t):null},wt),ge,oe,Et,Cs=(Et=class{constructor(e){h(this,"name","SmartRouter");v(this,ge,[]);v(this,oe,[]);y(this,ge,e.routers)}add(e,t,s){if(!d(this,oe))throw new Error(Dt);d(this,oe).push([e,t,s])}match(e,t){if(!d(this,oe))throw new Error("Fatal error");const s=d(this,ge),a=d(this,oe),n=s.length;let r=0,o;for(;r<n;r++){const l=s[r];try{for(let c=0,i=a.length;c<i;c++)l.add(...a[c]);o=l.match(e,t)}catch(c){if(c instanceof Ot)continue;throw c}this.match=l.match.bind(l),y(this,ge,[l]),y(this,oe,void 0);break}if(r===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(d(this,oe)||d(this,ge).length!==1)throw new Error("No active router has been determined yet.");return d(this,ge)[0]}},ge=new WeakMap,oe=new WeakMap,Et),We=Object.create(null),fe,U,Ee,Oe,j,ie,be,Fe,Ss=(Fe=class{constructor(t,s,a){v(this,ie);v(this,fe);v(this,U);v(this,Ee);v(this,Oe,0);v(this,j,We);if(y(this,U,a||Object.create(null)),y(this,fe,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},y(this,fe,[n])}y(this,Ee,[])}insert(t,s,a){y(this,Oe,++pt(this,Oe)._);let n=this;const r=Jt(s),o=[];for(let l=0,c=r.length;l<c;l++){const i=r[l],m=r[l+1],u=ss(i,m),g=Array.isArray(u)?u[0]:i;if(g in d(n,U)){n=d(n,U)[g],u&&o.push(u[1]);continue}d(n,U)[g]=new Fe,u&&(d(n,Ee).push(u),o.push(u[1])),n=d(n,U)[g]}return d(n,fe).push({[t]:{handler:a,possibleKeys:o.filter((l,c,i)=>i.indexOf(l)===c),score:d(this,Oe)}}),n}search(t,s){var c;const a=[];y(this,j,We);let r=[this];const o=Ct(s),l=[];for(let i=0,m=o.length;i<m;i++){const u=o[i],g=i===m-1,f=[];for(let k=0,w=r.length;k<w;k++){const b=r[k],x=d(b,U)[u];x&&(y(x,j,d(b,j)),g?(d(x,U)["*"]&&a.push(...E(this,ie,be).call(this,d(x,U)["*"],t,d(b,j))),a.push(...E(this,ie,be).call(this,x,t,d(b,j)))):f.push(x));for(let N=0,D=d(b,Ee).length;N<D;N++){const ee=d(b,Ee)[N],L=d(b,j)===We?{}:{...d(b,j)};if(ee==="*"){const $=d(b,U)["*"];$&&(a.push(...E(this,ie,be).call(this,$,t,d(b,j))),y($,j,L),f.push($));continue}const[te,Pe,ce]=ee;if(!u&&!(ce instanceof RegExp))continue;const G=d(b,U)[te],je=o.slice(i).join("/");if(ce instanceof RegExp){const $=ce.exec(je);if($){if(L[Pe]=$[0],a.push(...E(this,ie,be).call(this,G,t,d(b,j),L)),Object.keys(d(G,U)).length){y(G,j,L);const ze=((c=$[0].match(/\//))==null?void 0:c.length)??0;(l[ze]||(l[ze]=[])).push(G)}continue}}(ce===!0||ce.test(u))&&(L[Pe]=u,g?(a.push(...E(this,ie,be).call(this,G,t,L,d(b,j))),d(G,U)["*"]&&a.push(...E(this,ie,be).call(this,d(G,U)["*"],t,L,d(b,j)))):(y(G,j,L),f.push(G)))}}r=f.concat(l.shift()??[])}return a.length>1&&a.sort((i,m)=>i.score-m.score),[a.map(({handler:i,params:m})=>[i,m])]}},fe=new WeakMap,U=new WeakMap,Ee=new WeakMap,Oe=new WeakMap,j=new WeakMap,ie=new WeakSet,be=function(t,s,a,n){const r=[];for(let o=0,l=d(t,fe).length;o<l;o++){const c=d(t,fe)[o],i=c[s]||c[O],m={};if(i!==void 0&&(i.params=Object.create(null),r.push(i),a!==We||n&&n!==We))for(let u=0,g=i.possibleKeys.length;u<g;u++){const f=i.possibleKeys[u],k=m[i.score];i.params[f]=n!=null&&n[f]&&!k?n[f]:a[f]??(n==null?void 0:n[f]),m[i.score]=!0}}return r},Fe),ke,kt,As=(kt=class{constructor(){h(this,"name","TrieRouter");v(this,ke);y(this,ke,new Ss)}add(e,t,s){const a=At(t);if(a){for(let n=0,r=a.length;n<r;n++)d(this,ke).insert(e,a[n],s);return}d(this,ke).insert(e,t,s)}match(e,t){return d(this,ke).search(e,t)}},ke=new WeakMap,kt),Wt=class extends gs{constructor(e={}){super(e),this.router=e.router??new Cs({routers:[new ks,new As]})}},Is=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(r=>typeof r=="string"?r==="*"?()=>r:o=>r===o?o:null:typeof r=="function"?r:o=>r.includes(o)?o:null)(s.origin),n=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(s.allowMethods);return async function(o,l){var m;function c(u,g){o.res.headers.set(u,g)}const i=await a(o.req.header("origin")||"",o);if(i&&c("Access-Control-Allow-Origin",i),s.credentials&&c("Access-Control-Allow-Credentials","true"),(m=s.exposeHeaders)!=null&&m.length&&c("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),o.req.method==="OPTIONS"){s.origin!=="*"&&c("Vary","Origin"),s.maxAge!=null&&c("Access-Control-Max-Age",s.maxAge.toString());const u=await n(o.req.header("origin")||"",o);u.length&&c("Access-Control-Allow-Methods",u.join(","));let g=s.allowHeaders;if(!(g!=null&&g.length)){const f=o.req.header("Access-Control-Request-Headers");f&&(g=f.split(/\s*,\s*/))}return g!=null&&g.length&&(c("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&o.header("Vary","Origin",{append:!0})}},Ns=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,yt=(e,t=Ts)=>{const s=/\.([a-zA-Z0-9]+?)$/,a=e.match(s);if(!a)return;let n=t[a[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},Rs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ts=Rs,Ls=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),a=[];for(const n of s)n===".."&&a.length>0&&a.at(-1)!==".."?a.pop():n!=="."&&a.push(n);return a.join("/")||"."},Bt={br:".br",zstd:".zst",gzip:".gz"},Ms=Object.keys(Bt),Ds="index.html",Os=e=>{const t=e.root??"./",s=e.path,a=e.join??Ls;return async(n,r)=>{var m,u,g,f;if(n.finalized)return r();let o;if(e.path)o=e.path;else try{if(o=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(o))throw new Error}catch{return await((m=e.onNotFound)==null?void 0:m.call(e,n.req.path,n)),r()}let l=a(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(o):o);e.isDir&&await e.isDir(l)&&(l=a(l,Ds));const c=e.getContent;let i=await c(l,n);if(i instanceof Response)return n.newResponse(i.body,i);if(i){const k=e.mimes&&yt(l,e.mimes)||yt(l);if(n.header("Content-Type",k||"application/octet-stream"),e.precompressed&&(!k||Ns.test(k))){const w=new Set((u=n.req.header("Accept-Encoding"))==null?void 0:u.split(",").map(b=>b.trim()));for(const b of Ms){if(!w.has(b))continue;const x=await c(l+Bt[b],n);if(x){i=x,n.header("Content-Encoding",b),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((g=e.onFound)==null?void 0:g.call(e,l,n)),n.body(i)}await((f=e.onNotFound)==null?void 0:f.call(e,l,n)),await r()}},Fs=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const n=s[e]||e;if(!n)return null;const r=await a.get(n,{type:"stream"});return r||null},Ps=e=>async function(s,a){return Os({...e,getContent:async r=>Fs(r,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,a)},js=e=>Ps(e);const C=new Wt;C.use("/api/*",Is());C.use("/static/*",js({root:"./public"}));const Us="e77554988b424c6498d85362b0367757",Ws="https://www.streak.com/api/v1",lt={mabsilico:{name:"MabSilico",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",networkSheetGid:"910674612",sources:{promote:"",network:"https://docs.google.com/spreadsheets/d/1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw/edit?gid=910674612#gid=910674612",engage:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw"}},"finance-montreal":{name:"Finance Montreal (Steve)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw"},"apm-music":{name:"APM Music",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM"},ducrocq:{name:"Ducrocq",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww"},milvue:{name:"Milvue",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw"},seekyo:{name:"Seekyo Therapeutics",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww"},altavia:{name:"Altavia",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM"},valos:{name:"Valos",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM"},"dab-embedded":{name:"DAB-Embedded",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww"},"finance-montreal-noza":{name:"Finance Montreal (Noza)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw"}},_=lt.mabsilico.pipelineKey;lt.mabsilico.name;const Gt="Fit",$t="Interest",Bs="1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw",Gs=`https://docs.google.com/spreadsheets/d/${Bs}/export?format=csv`;async function ye(e,t){if(e)try{const s=await e.prepare("SELECT * FROM companies WHERE key = ?").bind(t).first();if(s)return{key:s.key,name:s.name,pipelineKey:s.pipeline_key,url:s.url,networkSheetGid:s.network_sheet_gid,sources:{promote:s.promote_url||"",network:s.network_url||"",engage:s.engage_url||""}}}catch(s){console.error("D1 query error, falling back to COMPANIES object:",s)}return lt[t]}async function A(e){const t=btoa(`${Us}:`),s=await fetch(`${Ws}${e}`,{headers:{Authorization:`Basic ${t}`,"Content-Type":"application/json"}});if(!s.ok)throw new Error(`Streak API error: ${s.statusText}`);return s.json()}async function $s(e){try{const t=`${Gs}&gid=${e}`,s=await fetch(t);if(!s.ok)throw new Error(`Google Sheets error: ${s.statusText}`);const n=(await s.text()).split(`
`).filter(w=>w.trim()),r=[];for(let w=1;w<n.length;w++){const x=n[w].split(",");if(x.length>=9&&x[3]&&x[3].trim()){const N=parseInt(x[3])||0,D=parseInt(x[4])||0,ee=x[7]?x[7].replace("%","").trim():"0",L=parseFloat(ee)||0;r.push({week:x[0],from:x[1],to:x[2],invitations:N,messages:D,acceptance:L,opportunities:parseInt(x[8])||0})}}const o=r.reduce((w,b)=>w+b.invitations,0),l=r.reduce((w,b)=>{const x=Math.min(b.acceptance,100);return w+Math.round(b.invitations*x/100)},0),c=r.map(w=>Math.min(w.acceptance,100)),i=c.length>0?c.reduce((w,b)=>w+b,0)/c.length:0,m=20,u=i>0?i/m*100:0,g=r.slice(-4),f=r[r.length-1]||{invitations:0,acceptance:0},k=r[r.length-2]||{invitations:0,acceptance:0};return{totalInvitations:o,totalAccepted:l,avgAcceptanceRate:Math.round(i*10)/10,networkObjective:m,objectiveAchievement:Math.round(u*10)/10,thisWeek:{invitations:f.invitations,acceptance:Math.min(f.acceptance,100)},lastWeek:{invitations:k.invitations,acceptance:Math.min(k.acceptance,100)},recentWeeks:g.map(w=>({...w,acceptance:Math.min(w.acceptance,100)})),allData:r}}catch(t){return console.error("Error fetching network data:",t),{totalInvitations:0,totalAccepted:0,avgAcceptanceRate:0,thisWeek:{invitations:0,acceptance:0},lastWeek:{invitations:0,acceptance:0},recentWeeks:[],allData:[]}}}C.get("/api/pipeline",async e=>{try{const t=await A(`/pipelines/${_}`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});C.get("/api/boxes",async e=>{try{const t=await A(`/pipelines/${_}/boxes`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});C.get("/api/boxes/:boxKey",async e=>{try{const t=e.req.param("boxKey"),s=await A(`/boxes/${t}`);return e.json(s)}catch(t){return e.json({error:t.message},500)}});C.get("/api/sheets/stage/:stageName/count",async e=>{try{const t=e.req.param("stageName"),[s,a]=await Promise.all([A(`/pipelines/${_}`),A(`/pipelines/${_}/boxes`)]),n=s.stageOrder||[],r=Array.isArray(n)?n.map(l=>{var c,i;return{key:l,name:((i=(c=s.stages)==null?void 0:c[l])==null?void 0:i.name)||"Unknown"}}):[],o=Array.isArray(a)?a.filter(l=>{const c=r.find(i=>i&&i.key===l.stageKey);return c&&c.name.toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/priority/:priorityName/count",async e=>{try{const t=e.req.param("priorityName"),[s,a]=await Promise.all([A(`/pipelines/${_}`),A(`/pipelines/${_}/boxes`)]),r=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name==="Priority"),o=Array.isArray(a)?a.filter(l=>{var g;if(!r||!l.fields||!l.fields[r.key])return t.toLowerCase()==="no priority";const c=l.fields[r.key],i=(g=r.dropdownSettings)==null?void 0:g.items,m=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(m?m.name:"No Priority").toLowerCase().includes(t.toLowerCase())}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/country/:countryName/count",async e=>{try{const t=e.req.param("countryName"),[s,a]=await Promise.all([A(`/pipelines/${_}`),A(`/pipelines/${_}/boxes`)]),r=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name==="Country"),o=Array.isArray(a)?a.filter(l=>{var g;if(!r||!l.fields||!l.fields[r.key])return t.toLowerCase()==="unknown";const c=l.fields[r.key],i=(g=r.dropdownSettings)==null?void 0:g.items,m=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(m?m.name:"Unknown").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/total",async e=>{try{const t=await A(`/pipelines/${_}/boxes`),s=Array.isArray(t)?t.length:0;return e.text(s.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/freshness/:level/count",async e=>{try{const t=e.req.param("level").toLowerCase(),s=await A(`/pipelines/${_}/boxes`),a=Array.isArray(s)?s.filter(n=>{const r=n.freshness||0;return t==="high"?r>.5:t==="medium"?r>=.2&&r<=.5:t==="low"?r<.2:!1}).length:0;return e.text(a.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/fit/:fitLevel/count",async e=>{try{const t=e.req.param("fitLevel"),[s,a]=await Promise.all([A(`/pipelines/${_}`),A(`/pipelines/${_}/boxes`)]),r=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name===Gt),o=Array.isArray(a)?a.filter(l=>{var g;if(!r||!l.fields||!l.fields[r.key])return t.toLowerCase()==="not set";const c=l.fields[r.key],i=(g=r.dropdownSettings)==null?void 0:g.items,m=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(m?m.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/interest/:interestLevel/count",async e=>{try{const t=e.req.param("interestLevel"),[s,a]=await Promise.all([A(`/pipelines/${_}`),A(`/pipelines/${_}/boxes`)]),r=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name===$t),o=Array.isArray(a)?a.filter(l=>{var g;if(!r||!l.fields||!l.fields[r.key])return t.toLowerCase()==="not set";const c=l.fields[r.key],i=(g=r.dropdownSettings)==null?void 0:g.items,m=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(m?m.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});C.get("/api/companies",async e=>{try{const{results:t}=await e.env.DB.prepare("SELECT key, name, url, pipeline_key, promote_url, network_url, network_sheet_gid, engage_url, notion_url FROM companies ORDER BY name").all();return e.json({companies:t,count:t.length})}catch(t){return console.error("Error fetching companies:",t),e.json({error:"Failed to fetch companies",companies:[],count:0},500)}});C.post("/api/companies",async e=>{try{const t=await e.req.json(),{key:s,name:a,pipeline_key:n,url:r,promote_url:o,network_url:l,network_sheet_gid:c,engage_url:i,notion_url:m}=t;return!s||!a||!n||!r?e.json({error:"Missing required fields: key, name, pipeline_key, url"},400):await e.env.DB.prepare("SELECT key FROM companies WHERE key = ?").bind(s).first()?e.json({error:"Company with this key already exists"},409):(await e.env.DB.prepare(`INSERT INTO companies (key, name, pipeline_key, url, promote_url, network_url, network_sheet_gid, engage_url, notion_url)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,a,n,r,o||null,l||null,c||null,i||null,m||null).run(),e.json({success:!0,message:"Company added successfully",key:s}))}catch(t){return console.error("Error adding company:",t),e.json({error:"Failed to add company"},500)}});C.delete("/api/companies/:key",async e=>{try{const t=e.req.param("key");return await e.env.DB.prepare("SELECT key FROM companies WHERE key = ?").bind(t).first()?(await e.env.DB.prepare("DELETE FROM companies WHERE key = ?").bind(t).run(),e.json({success:!0,message:"Company deleted successfully"})):e.json({error:"Company not found"},404)}catch(t){return console.error("Error deleting company:",t),e.json({error:"Failed to delete company"},500)}});C.put("/api/companies/:key",async e=>{try{const t=e.req.param("key"),s=await e.req.json(),{name:a,pipeline_key:n,url:r,promote_url:o,network_url:l,network_sheet_gid:c,engage_url:i,notion_url:m}=s;return await e.env.DB.prepare("SELECT key FROM companies WHERE key = ?").bind(t).first()?(await e.env.DB.prepare(`UPDATE companies 
       SET name = ?, pipeline_key = ?, url = ?, promote_url = ?, network_url = ?, network_sheet_gid = ?, engage_url = ?, notion_url = ?, updated_at = CURRENT_TIMESTAMP
       WHERE key = ?`).bind(a,n,r,o||null,l||null,c||null,i||null,m||null,t).run(),e.json({success:!0,message:"Company updated successfully"})):e.json({error:"Company not found"},404)}catch(t){return console.error("Error updating company:",t),e.json({error:"Failed to update company"},500)}});C.get("/api/sheets/:companyName/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await ye(e.env.DB,t);if(!s)return e.text("COMPANY_NOT_FOUND");const a=await A(`/pipelines/${s.pipelineKey}/boxes`),n=Array.isArray(a)?a.length:0;return e.text(n.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/:companyName/month/:yearMonth/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=e.req.param("yearMonth"),a=await ye(e.env.DB,t);if(!a)return e.text("COMPANY_NOT_FOUND");const n=await A(`/pipelines/${a.pipelineKey}/boxes`),[r,o]=s.split("-").map(Number),l=Array.isArray(n)?n.filter(c=>{const i=new Date(c.creationTimestamp);return i.getFullYear()===r&&i.getMonth()+1===o}).length:0;return e.text(l.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/:companyName/week/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await ye(e.env.DB,t);if(!s)return e.text("ERROR");const a=await A(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a))return e.text("0");const r=Date.now()-10080*60*1e3,o=a.filter(l=>(l.creationTimestamp||0)>=r).length;return e.text(o.toString())}catch{return e.text("ERROR")}});C.get("/api/sheets/:companyName/duration/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await ye(e.env.DB,t);if(!s)return e.text("0");const a=await A(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a)||a.length===0)return e.text("0");const n=a.map(u=>u.creationTimestamp).filter(u=>u);if(n.length===0)return e.text("0");const r=Math.min(...n),o=new Date(r),l=new Date,c=l.getFullYear()-o.getFullYear(),i=l.getMonth()-o.getMonth(),m=c*12+i+1;return e.text(m.toString())}catch{return e.text("0")}});C.get("/api/sheets/:companyName/monthly-stats",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await ye(e.env.DB,t);if(!s)return e.json({error:"Company not found"},404);const a=await A(`/pipelines/${s.pipelineKey}/boxes`),n=Array.isArray(a)?a:[],r=new Date,o=[];for(let m=11;m>=0;m--){const u=new Date(r.getFullYear(),r.getMonth()-m,1),g=u.getFullYear(),f=u.getMonth()+1,k=n.filter(b=>{const x=new Date(b.creationTimestamp);return x.getFullYear()===g&&x.getMonth()+1===f}).length,w=(k/10*100).toFixed(1);o.push({month:`${g}-${String(f).padStart(2,"0")}`,count:k,objective:10,percentage:parseFloat(w)})}const l=o.reduce((m,u)=>m+u.count,0),c=(l/12).toFixed(1),i=(parseFloat(c)/10*100).toFixed(1);return e.json({company:s.name,companyKey:t,objective:10,monthlyStats:o,summary:{totalLeads:l,average:parseFloat(c),averagePercentage:parseFloat(i)}})}catch(t){return e.json({error:t.message},500)}});C.get("/api/sheets/:companyName/due",async e=>{try{const t=e.req.param("companyName").toLowerCase().replace(/ /g,"-"),s=await ye(e.env.DB,t);if(!s)return e.text("COMPANY_NOT_FOUND");const[a,n]=await Promise.all([A(`/pipelines/${s.pipelineKey}`),A(`/pipelines/${s.pipelineKey}/boxes`)]);if(!Array.isArray(n))return e.text("0");const o=(Array.isArray(a.fields)?a.fields:[]).find(i=>i&&(i.name==="Est Start Date"||i.name==="Due Date"||i.name==="Start Date"));if(!o)return e.text("0");const l=Date.now();let c=0;return n.forEach(i=>{i.fields&&i.fields[o.key]&&i.fields[o.key]&&c++}),e.text(c.toString())}catch(t){return console.error("Error fetching due items:",t),e.text("ERROR")}});C.get("/api/sheets/:companyName/overdue",async e=>{try{const t=e.req.param("companyName").toLowerCase().replace(/ /g,"-"),s=await ye(e.env.DB,t);if(!s)return e.text("COMPANY_NOT_FOUND");const[a,n]=await Promise.all([A(`/pipelines/${s.pipelineKey}`),A(`/pipelines/${s.pipelineKey}/boxes`)]);if(!Array.isArray(n))return e.text("0");const o=(Array.isArray(a.fields)?a.fields:[]).find(i=>i&&(i.name==="Est Start Date"||i.name==="Due Date"||i.name==="Start Date"));if(!o)return e.text("0");const l=Date.now();let c=0;return n.forEach(i=>{if(i.fields&&i.fields[o.key]){const m=i.fields[o.key];m&&m<l&&c++}}),e.text(c.toString())}catch(t){return console.error("Error fetching overdue items:",t),e.text("ERROR")}});C.get("/api/analytics",async e=>{try{const t=e.req.query("company")||"mabsilico",s=await ye(e.env.DB,t);if(!s)return e.json({error:"Invalid company key"},400);const a=s.pipelineKey,[n,r]=await Promise.all([A(`/pipelines/${a}`),A(`/pipelines/${a}/boxes`)]),o=Array.isArray(r)?r.length:0,l={},c={},i={},m={},u={},g={},f={"High (>0.5)":0,"Medium (0.2-0.5)":0,"Low (<0.2)":0},k=n.stageOrder||[],w=Array.isArray(k)?k.map(p=>{var T,W;return{key:p,name:((W=(T=n.stages)==null?void 0:T[p])==null?void 0:W.name)||"Unknown"}}):[],b=Array.isArray(n.fields)?n.fields:[],x=b.find(p=>p&&p.name==="Origin"),N=b.find(p=>p&&p.name===Gt),D=b.find(p=>p&&p.name===$t),ee=b.find(p=>p&&p.name==="Est Start Date"),L=b.find(p=>p&&p.name==="Country"),te=b.find(p=>p&&p.name==="Language");Array.isArray(r)&&r.forEach(p=>{var Y,se,ae,V,z;if(!p)return;const T=w.find(M=>M&&M.key===p.stageKey),W=T?T.name:"Unknown";if(l[W]=(l[W]||0)+1,x&&p.fields&&p.fields[x.key]){const M=p.fields[x.key],R=(Y=x.dropdownSettings)==null?void 0:Y.items,P=Array.isArray(R)?R.find(S=>S&&S.key===M):null,I=P?P.name:"Unknown";c[I]=(c[I]||0)+1}if(N&&p.fields&&p.fields[N.key]){const M=p.fields[N.key],R=(se=N.dropdownSettings)==null?void 0:se.items,P=Array.isArray(R)?R.find(S=>S&&S.key===M):null,I=P?P.name:"Not Set";i[I]=(i[I]||0)+1}else i["Not Set"]=(i["Not Set"]||0)+1;if(D&&p.fields&&p.fields[D.key]){const M=p.fields[D.key],R=(ae=D.dropdownSettings)==null?void 0:ae.items,P=Array.isArray(R)?R.find(S=>S&&S.key===M):null,I=P?P.name:"Not Set";m[I]=(m[I]||0)+1}else m["Not Set"]=(m["Not Set"]||0)+1;if(L&&p.fields&&p.fields[L.key]){const M=p.fields[L.key],R=(V=L.dropdownSettings)==null?void 0:V.items,P=Array.isArray(R)?R.find(S=>S&&S.key===M):null,I=P?P.name:"Unknown";u[I]=(u[I]||0)+1}else u.Unknown=(u.Unknown||0)+1;if(te&&p.fields&&p.fields[te.key]){const M=p.fields[te.key],R=(z=te.dropdownSettings)==null?void 0:z.items,P=Array.isArray(R)?R.find(S=>S&&S.key===M):null,I=P?P.name:"Unknown";g[I]=(g[I]||0)+1}else g.Unknown=(g.Unknown||0)+1;const H=p.freshness||0;H>.5?f["High (>0.5)"]++:H>=.2?f["Medium (0.2-0.5)"]++:f["Low (<0.2)"]++});const Pe={};Object.keys(i).forEach(p=>{Pe[p]=o>0?(i[p]/o*100).toFixed(1):0});const ce={};Object.keys(m).forEach(p=>{ce[p]=o>0?(m[p]/o*100).toFixed(1):0});const G=new Date,je=[],$=10;for(let p=11;p>=0;p--){const T=new Date(G.getFullYear(),G.getMonth()-p,1),W=T.getFullYear(),H=T.getMonth()+1,Y=Array.isArray(r)?r.filter(ae=>{const V=new Date(ae.creationTimestamp);return V.getFullYear()===W&&V.getMonth()+1===H}).length:0,se=(Y/$*100).toFixed(1);je.push({month:`${W}-${String(H).padStart(2,"0")}`,monthName:T.toLocaleString("en-US",{month:"short",year:"numeric"}),count:Y,objective:$,percentage:parseFloat(se),status:Y>=$?"achieved":"pending"})}const st=(je.reduce((p,T)=>p+T.count,0)/12).toFixed(1),Ht=(parseFloat(st)/$*100).toFixed(1);let ct=0,Ue=null;if(Array.isArray(r)&&r.length>0){const p=r.map(T=>T.creationTimestamp).filter(T=>T);if(p.length>0){const T=Math.min(...p);Ue=new Date(T);const W=G.getFullYear()-Ue.getFullYear(),H=G.getMonth()-Ue.getMonth();ct=W*12+H+1}}let dt=null;return s.networkSheetGid&&(dt=await $s(s.networkSheetGid)),e.json({company:s.name,companyKey:t,totalBoxes:o,campaignDurationMonths:ct,firstLeadDate:Ue?Ue.toISOString():null,networkData:dt,stageDistribution:l,originDistribution:c,fitDistribution:i,fitPercentages:Pe,interestDistribution:m,interestPercentages:ce,countryDistribution:u,languageDistribution:g,freshnessDistribution:f,monthlyLeads:je,leadObjective:$,averageLeadsPerMonth:parseFloat(st),averagePercentage:parseFloat(Ht),recentBoxes:Array.isArray(r)?r.filter(p=>{var se,ae;const T=N&&p.fields&&p.fields[N.key],W=D&&p.fields&&p.fields[D.key];let H="Not Set";if(T){const V=p.fields[N.key],z=(se=N.dropdownSettings)==null?void 0:se.items,M=Array.isArray(z)?z.find(R=>R&&R.key===V):null;H=M?M.name:"Not Set"}let Y="Not Set";if(W){const V=p.fields[D.key],z=(ae=D.dropdownSettings)==null?void 0:ae.items,M=Array.isArray(z)?z.find(R=>R&&R.key===V):null;Y=M?M.name:"Not Set"}return H==="High"||Y==="High"}).slice(0,10).map(p=>{var z,M,R,P;const T=w.find(I=>I&&I.key===p.stageKey);let W="Not Set";if(N&&p.fields&&p.fields[N.key]){const I=p.fields[N.key],S=(z=N.dropdownSettings)==null?void 0:z.items,Q=Array.isArray(S)?S.find(X=>X&&X.key===I):null;W=Q?Q.name:"Not Set"}let H="Not Set";if(D&&p.fields&&p.fields[D.key]){const I=p.fields[D.key],S=(M=D.dropdownSettings)==null?void 0:M.items,Q=Array.isArray(S)?S.find(X=>X&&X.key===I):null;H=Q?Q.name:"Not Set"}let Y=null;ee&&p.fields&&p.fields[ee.key]&&(Y=new Date(p.fields[ee.key]).toISOString());let se="Unknown";if(L&&p.fields&&p.fields[L.key]){const I=p.fields[L.key],S=(R=L.dropdownSettings)==null?void 0:R.items,Q=Array.isArray(S)?S.find(X=>X&&X.key===I):null;se=Q?Q.name:"Unknown"}let ae="Unknown";if(te&&p.fields&&p.fields[te.key]){const I=p.fields[te.key],S=(P=te.dropdownSettings)==null?void 0:P.items,Q=Array.isArray(S)?S.find(X=>X&&X.key===I):null;ae=Q?Q.name:"Unknown"}const V=p.freshness||0;return{name:p.name||"Unnamed",key:p.boxKey,stage:T?T.name:"Unknown",fit:W,interest:H,dueDate:Y,country:se,language:ae,freshness:V.toFixed(3),lastUpdated:new Date(p.lastUpdatedTimestamp).toISOString()}}):[]})}catch(t){return e.json({error:t.message},500)}});C.get("/admin",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
                ...
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h1 class="text-4xl font-bold mb-3">
                            ...
                            <span class="text-sm font-normal text-blue-200 ml-3">v1.0.1</span>
                        </h1>
                        <!-- Company Selector -->
  ...
  `));const ht=new Wt,_s=Object.assign({"/src/index.tsx":C});let _t=!1;for(const[,e]of Object.entries(_s))e&&(ht.route("/",e),ht.notFound(e.notFoundHandler),_t=!0);if(!_t)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{ht as default};
