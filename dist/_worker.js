...
`).filter(w=>w.trim()),n=[];for(let w=1;w<r.length;w++){const v=r[w].split(",");if(v.length>=9&&v[3]&&v[3].trim()){const N=parseInt(v[3])||0,D=parseInt(v[4])||0,te=v[7]?v[7].replace("%","").trim():"0",M=parseFloat(te)||0;n.push({week:v[0],from:v[1],to:v[2],invitations:N,messages:D,acceptance:M,opportunities:parseInt(v[8])||0})}}const o=n.reduce((w,b)=>w+b.invitations,0),l=n.reduce((w,b)=>{const v=Math.min(b.acceptance,100);return w+Math.round(b.invitations*v/100)},0),c=n.map(w=>Math.min(w.acceptance,100)),i=c.length>0?c.reduce((w,b)=>w+b,0)/c.length:0,p=20,u=i>0?i/p*100:0,g=n.slice(-4),f=n[n.length-1]||{invitations:0,acceptance:0},I=n[n.length-2]||{invitations:0,acceptance:0};return{totalInvitations:o,totalAccepted:l,avgAcceptanceRate:Math.round(i*10)/10,networkObjective:p,objectiveAchievement:Math.round(u*10)/10,thisWeek:{invitations:f.invitations,acceptance:Math.min(f.acceptance,100)},lastWeek:{invitations:I.invitations,acceptance:Math.min(I.acceptance,100)},recentWeeks:g.map(w=>({...w,acceptance:Math.min(w.acceptance,100)})),allData:n}}catch(t){return console.error("Error fetching network data:",t),{totalInvitations:0,totalAccepted:0,avgAcceptanceRate:0,thisWeek:{invitations:0,acceptance:0},lastWeek:{invitations:0,acceptance:0},recentWeeks:[],allData:[]}}}E.get("/api/pipeline",async e=>{try{const t=await A(`/pipelines/${Y}`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});E.get("/api/boxes",async e=>{try{const t=await A(`/pipelines/${Y}/boxes`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});E.get("/api/boxes/:boxKey",async e=>{try{const t=e.req.param("boxKey"),s=await A(`/boxes/${t}`);return e.json(s)}catch(t){return e.json({error:t.message},500)}});E.get("/api/sheets/stage/:stageName/count",async e=>{try{const t=e.req.param("stageName"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),r=s.stageOrder||[],n=Array.isArray(r)?r.map(l=>{var c,i;return{key:l,name:((i=(c=s.stages)==null?void 0:c[l])==null?void 0:i.name)||"Unknown"}}):[],o=Array.isArray(a)?a.filter(l=>{const c=n.find(i=>i&&i.key===l.stageKey);return c&&c.name.toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/priority/:priorityName/count",async e=>{try{const t=e.req.param("priorityName"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name==="Priority"),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="no priority";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"No Priority").toLowerCase().includes(t.toLowerCase())}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/country/:countryName/count",async e=>{try{const t=e.req.param("countryName"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name==="Country"),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="unknown";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"Unknown").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/total",async e=>{try{const t=await A(`/pipelines/${Y}/boxes`),s=Array.isArray(t)?t.length:0;return e.text(s.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/freshness/:level/count",async e=>{try{const t=e.req.param("level").toLowerCase(),s=await A(`/pipelines/${Y}/boxes`),a=Array.isArray(s)?s.filter(r=>{const n=r.freshness||0;return t==="high"?n>.5:t==="medium"?n>=.2&&n<=.5:t==="low"?n<.2:!1}).length:0;return e.text(a.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/fit/:fitLevel/count",async e=>{try{const t=e.req.param("fitLevel"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name===Bt),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="not set";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/interest/:interestLevel/count",async e=>{try{const t=e.req.param("interestLevel"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name===$t),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="not set";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/companies",async e=>{try{const t=Object.keys(F).map(s=>{var a,r,n;return{key:s,name:F[s].name,url:F[s].url,pipeline_key:F[s].pipelineKey,promote_url:((a=F[s].sources)==null?void 0:a.promote)||null,network_url:((r=F[s].sources)==null?void 0:r.network)||null,network_sheet_gid:F[s].networkSheetGid||null,engage_url:((n=F[s].sources)==null?void 0:n.engage)||null,notion_url:F[s].notionUrl||null}});return e.json({companies:t,count:t.length})}catch(t){return console.error("Error fetching companies:",t),e.json({error:"Failed to fetch companies",companies:[],count:0},500)}});E.post("/api/companies",async e=>{try{const t=await e.req.json(),{key:s,name:a,pipeline_key:r,url:n,promote_url:o,network_url:l,network_sheet_gid:c,engage_url:i,notion_url:p}=t;return!s||!a||!r||!n?e.json({error:"Missing required fields: key, name, pipeline_key, url"},400):F[s]?e.json({error:"Company with this key already exists"},409):(F[s]={name:a,pipelineKey:r,url:n,networkSheetGid:c||null,notionUrl:p||null,sources:{promote:o||"",network:l||"",engage:i||""}},e.json({success:!0,message:"Company added successfully (session only)",key:s}))}catch(t){return console.error("Error adding company:",t),e.json({error:"Failed to add company"},500)}});E.delete("/api/companies/:key",async e=>{try{const t=e.req.param("key");return F[t]?(delete F[t],e.json({success:!0,message:"Company deleted successfully (session only)"})):e.json({error:"Company not found"},404)}catch(t){return console.error("Error deleting company:",t),e.json({error:"Failed to delete company"},500)}});E.put("/api/companies/:key",async e=>{try{const t=e.req.param("key"),s=await e.req.json(),{name:a,pipeline_key:r,url:n,promote_url:o,network_url:l,network_sheet_gid:c,engage_url:i,notion_url:p}=s;return F[t]?(F[t]={name:a,pipelineKey:r,url:n,networkSheetGid:c||null,notionUrl:p||null,sources:{promote:o||"",network:l||"",engage:i||""}},e.json({success:!0,message:"Company updated successfully (session only)"})):e.json({error:"Company not found"},404)}catch(t){return console.error("Error updating company:",t),e.json({error:"Failed to update company"},500)}});E.get("/api/sheets/:companyName/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.text("COMPANY_NOT_FOUND");const a=await A(`/pipelines/${s.pipelineKey}/boxes`),r=Array.isArray(a)?a.length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/:companyName/month/:yearMonth/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=e.req.param("yearMonth"),a=await de(void 0,t);if(!a)return e.text("COMPANY_NOT_FOUND");const r=await A(`/pipelines/${a.pipelineKey}/boxes`),[n,o]=s.split("-").map(Number),l=Array.isArray(r)?r.filter(c=>{const i=new Date(c.creationTimestamp);return i.getFullYear()===n&&i.getMonth()+1===o}).length:0;return e.text(l.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/:companyName/week/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.text("ERROR");const a=await A(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a))return e.text("0");const n=Date.now()-10080*60*1e3,o=a.filter(l=>(l.creationTimestamp||0)>=n).length;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/:companyName/duration/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.text("0");const a=await A(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a)||a.length===0)return e.text("0");const r=a.map(u=>u.creationTimestamp).filter(u=>u);if(r.length===0)return e.text("0");const n=Math.min(...r),o=new Date(n),l=new Date,c=l.getFullYear()-o.getFullYear(),i=l.getMonth()-o.getMonth(),p=c*12+i+1;return e.text(p.toString())}catch{return e.text("0")}});E.get("/api/sheets/:companyName/monthly-stats",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.json({error:"Company not found"},404);const a=await A(`/pipelines/${s.pipelineKey}/boxes`),r=Array.isArray(a)?a:[],n=new Date,o=[];for(let p=11;p>=0;p--){const u=new Date(n.getFullYear(),n.getMonth()-p,1),g=u.getFullYear(),f=u.getMonth()+1,I=r.filter(b=>{const v=new Date(b.creationTimestamp);return v.getFullYear()===g&&v.getMonth()+1===f}).length,w=(I/10*100).toFixed(1);o.push({month:`${g}-${String(f).padStart(2,"0")}`,count:I,objective:10,percentage:parseFloat(w)})}const l=o.reduce((p,u)=>p+u.count,0),c=(l/12).toFixed(1),i=(parseFloat(c)/10*100).toFixed(1);return e.json({company:s.name,companyKey:t,objective:10,monthlyStats:o,summary:{totalLeads:l,average:parseFloat(c),averagePercentage:parseFloat(i)}})}catch(t){return e.json({error:t.message},500)}});E.get("/api/sheets/:companyName/due",async e=>{try{const t=e.req.param("companyName").toLowerCase().replace(/ /g,"-"),s=await de(void 0,t);if(!s)return e.text("COMPANY_NOT_FOUND");const[a,r]=await Promise.all([A(`/pipelines/${s.pipelineKey}`),A(`/pipelines/${s.pipelineKey}/boxes`)]);if(!Array.isArray(r))return e.text("0");const o=(Array.isArray(a.fields)?a.fields:[]).find(i=>i&&(i.name==="Est Start Date"||i.name==="Due Date"||i.name==="Start Date"));if(!o)return e.text("0");const l=Date.now();let c=0;return r.forEach(i=>{i.fields&&i.fields[o.key]&&i.fields[o.key]&&c++}),e.text(c.toString())}catch(t){return console.error("Error fetching due items:",t),e.text("ERROR")}});E.get("/api/sheets/:companyName/overdue",async e=>{try{const t=e.req.param("companyName").toLowerCase().replace(/ /g,"-"),s=await de(void 0,t);if(!s)return e.text("COMPANY_NOT_FOUND");const[a,r]=await Promise.all([A(`/pipelines/${s.pipelineKey}`),A(`/pipelines/${s.pipelineKey}/boxes`)]);if(!Array.isArray(r))return e.text("0");const o=(Array.isArray(a.fields)?a.fields:[]).find(i=>i&&(i.name==="Est Start Date"||i.name==="Due Date"||i.name==="Start Date"));if(!o)return e.text("0");const l=Date.now();let c=0;return r.forEach(i=>{if(i.fields&&i.fields[o.key]){const p=i.fields[o.key];p&&p<l&&c++}}),e.text(c.toString())}catch(t){return console.error("Error fetching overdue items:",t),e.text("ERROR")}});E.get("/api/analytics",async e=>{try{const t=e.req.query("company")||"mabsilico",s=await de(void 0,t);if(!s)return e.json({error:"Invalid company key"},400);const a=s.pipelineKey,[r,n]=await Promise.all([A(`/pipelines/${a}`),A(`/pipelines/${a}/boxes`)]),o=Array.isArray(n)?n.length:0,l={},c={},i={},p={},u={},g={},f={"High (>0.5)":0,"Medium (0.2-0.5)":0,"Low (<0.2)":0},I=r.stageOrder||[],w=Array.isArray(I)?I.map(m=>{var R,G;return{key:m,name:((G=(R=r.stages)==null?void 0:R[m])==null?void 0:G.name)||"Unknown"}}):[],b=Array.isArray(r.fields)?r.fields:[],v=b.find(m=>m&&m.name==="Origin"),N=b.find(m=>m&&m.name===Bt),D=b.find(m=>m&&m.name===$t),te=b.find(m=>m&&m.name==="Est Start Date"),M=b.find(m=>m&&m.name==="Country"),se=b.find(m=>m&&m.name==="Language");Array.isArray(n)&&n.forEach(m=>{var V,ae,ne,Q,z;if(!m)return;const R=w.find(T=>T&&T.key===m.stageKey),G=R?R.name:"Unknown";if(l[G]=(l[G]||0)+1,v&&m.fields&&m.fields[v.key]){const T=m.fields[v.key],L=(V=v.dropdownSettings)==null?void 0:V.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Unknown";c[S]=(c[S]||0)+1}if(N&&m.fields&&m.fields[N.key]){const T=m.fields[N.key],L=(ae=N.dropdownSettings)==null?void 0:ae.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Not Set";i[S]=(i[S]||0)+1}else i["Not Set"]=(i["Not Set"]||0)+1;if(D&&m.fields&&m.fields[D.key]){const T=m.fields[D.key],L=(ne=D.dropdownSettings)==null?void 0:ne.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Not Set";p[S]=(p[S]||0)+1}else p["Not Set"]=(p["Not Set"]||0)+1;if(M&&m.fields&&m.fields[M.key]){const T=m.fields[M.key],L=(Q=M.dropdownSettings)==null?void 0:Q.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Unknown";u[S]=(u[S]||0)+1}else u.Unknown=(u.Unknown||0)+1;if(se&&m.fields&&m.fields[se.key]){const T=m.fields[se.key],L=(z=se.dropdownSettings)==null?void 0:z.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Unknown";g[S]=(g[S]||0)+1}else g.Unknown=(g.Unknown||0)+1;const K=m.freshness||0;K>.5?f["High (>0.5)"]++:K>=.2?f["Medium (0.2-0.5)"]++:f["Low (<0.2)"]++});const je={};Object.keys(i).forEach(m=>{je[m]=o>0?(i[m]/o*100).toFixed(1):0});const pe={};Object.keys(p).forEach(m=>{pe[m]=o>0?(p[m]/o*100).toFixed(1):0});const $=new Date,Ue=[],H=10;for(let m=11;m>=0;m--){const R=new Date($.getFullYear(),$.getMonth()-m,1),G=R.getFullYear(),K=R.getMonth()+1,V=Array.isArray(n)?n.filter(ne=>{const Q=new Date(ne.creationTimestamp);return Q.getFullYear()===G&&Q.getMonth()+1===K}).length:0,ae=(V/H*100).toFixed(1);Ue.push({month:`${G}-${String(K).padStart(2,"0")}`,monthName:R.toLocaleString("en-US",{month:"short",year:"numeric"}),count:V,objective:H,percentage:parseFloat(ae),status:V>=H?"achieved":"pending"})}const at=(Ue.reduce((m,R)=>m+R.count,0)/12).toFixed(1),Yt=(parseFloat(at)/H*100).toFixed(1);let dt=0,We=null;if(Array.isArray(n)&&n.length>0){const m=n.map(R=>R.creationTimestamp).filter(R=>R);if(m.length>0){const R=Math.min(...m);We=new Date(R);const G=$.getFullYear()-We.getFullYear(),K=$.getMonth()-We.getMonth();dt=G*12+K+1}}let pt=null;return s.networkSheetGid&&(pt=await Rs(s.networkSheetGid)),e.json({company:s.name,companyKey:t,totalBoxes:o,campaignDurationMonths:dt,firstLeadDate:We?We.toISOString():null,networkData:pt,stageDistribution:l,originDistribution:c,fitDistribution:i,fitPercentages:je,interestDistribution:p,interestPercentages:pe,countryDistribution:u,languageDistribution:g,freshnessDistribution:f,monthlyLeads:Ue,leadObjective:H,averageLeadsPerMonth:parseFloat(at),averagePercentage:parseFloat(Yt),recentBoxes:Array.isArray(n)?n.filter(m=>{var ae,ne;const R=N&&m.fields&&m.fields[N.key],G=D&&m.fields&&m.fields[D.key];let K="Not Set";if(R){const Q=m.fields[N.key],z=(ae=N.dropdownSettings)==null?void 0:ae.items,T=Array.isArray(z)?z.find(L=>L&&L.key===Q):null;K=T?T.name:"Not Set"}let V="Not Set";if(G){const Q=m.fields[D.key],z=(ne=D.dropdownSettings)==null?void 0:ne.items,T=Array.isArray(z)?z.find(L=>L&&L.key===Q):null;V=T?T.name:"Not Set"}return K==="High"||V==="High"}).slice(0,10).map(m=>{var z,T,L,j;const R=w.find(S=>S&&S.key===m.stageKey);let G="Not Set";if(N&&m.fields&&m.fields[N.key]){const S=m.fields[N.key],C=(z=N.dropdownSettings)==null?void 0:z.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;G=X?X.name:"Not Set"}let K="Not Set";if(D&&m.fields&&m.fields[D.key]){const S=m.fields[D.key],C=(T=D.dropdownSettings)==null?void 0:T.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;K=X?X.name:"Not Set"}let V=null;te&&m.fields&&m.fields[te.key]&&(V=new Date(m.fields[te.key]).toISOString());let ae="Unknown";if(M&&m.fields&&m.fields[M.key]){const S=m.fields[M.key],C=(L=M.dropdownSettings)==null?void 0:L.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;ae=X?X.name:"Unknown"}let ne="Unknown";if(se&&m.fields&&m.fields[se.key]){const S=m.fields[se.key],C=(j=se.dropdownSettings)==null?void 0:j.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;ne=X?X.name:"Unknown"}const Q=m.freshness||0;return{name:m.name||"Unnamed",key:m.boxKey,stage:R?R.name:"Unknown",fit:G,interest:K,dueDate:V,country:ae,language:ne,freshness:Q.toFixed(3),lastUpdated:new Date(m.lastUpdatedTimestamp).toISOString()}}):[]})}catch(t){return e.json({error:t.message},500)}});E.get("/admin",e=>e.html(`
  ...
  `));E.get("/api/test-streak",async e=>{try{const t=await de(void 0,"mabsilico");if(!t)return e.json({error:"Company not found"},404);const s=t.pipelineKey,a=await fetch(`${lt}/pipelines/${s}`,{headers:{Authorization:`Basic ${btoa(`${Gt}:`)}`,"Content-Type":"application/json"}}),r=a.status,n=a.statusText;if(!a.ok){const l=await a.text();return e.json({error:"Streak API failed",status:r,statusText:n,errorText:l,pipelineKey:s,apiBase:lt,endpoint:`/pipelines/${s}`},500)}const o=await a.json();return e.json({success:!0,status:r,company:t.name,pipelineKey:s,pipelineName:o.name||"Unknown",stageCount:o.stageOrder?o.stageOrder.length:0})}catch(t){return e.json({error:t.message,stack:t.stack},500)}});const ft=new Wt,Ms=Object.assign({"/src/index.tsx":E});let Ht=!1;for(const[,e]of Object.entries(Ms))e&&(ft.route("/",e),ft.notFound(e.notFoundHandler),Ht=!0);if(!Ht)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{ft as default};
