var Kt=Object.defineProperty;var mt=e=>{throw TypeError(e)};var Vt=(e,t,s)=>t in e?Kt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var h=(e,t,s)=>Vt(e,typeof t!="symbol"?t+"":t,s),nt=(e,t,s)=>t.has(e)||mt("Cannot "+s);var d=(e,t,s)=>(nt(e,t,"read from private field"),s?s.call(e):t.get(e)),x=(e,t,s)=>t.has(e)?mt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),y=(e,t,s,a)=>(nt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),k=(e,t,s)=>(nt(e,t,"access private method"),s);var ut=(e,t,s,a)=>({set _(r){y(e,t,r,s)},get _(){return d(e,t,a)}});var gt=(e,t,s)=>(a,r)=>{let n=-1;return o(0);async function o(l){if(l<=n)throw new Error("next() called multiple times");n=l;let c,i=!1,p;if(e[l]?(p=e[l][0][0],a.req.routeIndex=l):p=l===e.length&&r||void 0,p)try{c=await p(a,()=>o(l+1))}catch(u){if(u instanceof Error&&t)a.error=u,c=await t(u,a),i=!0;else throw u}else a.finalized===!1&&s&&(c=await s(a));return c&&(a.finalized===!1||i)&&(a.res=c),a}},_t=Symbol(),Qt=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,n=(e instanceof Lt?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?zt(e,{all:s,dot:a}):{}};async function zt(e,t){const s=await e.formData();return s?Xt(s,t):{}}function Xt(e,t){const s=Object.create(null);return e.forEach((a,r)=>{t.all||r.endsWith("[]")?Zt(s,r,a):s[r]=a}),t.dot&&Object.entries(s).forEach(([a,r])=>{a.includes(".")&&(qt(s,a,r),delete s[a])}),s}var Zt=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},qt=(e,t,s)=>{let a=e;const r=t.split(".");r.forEach((n,o)=>{o===r.length-1?a[n]=s:((!a[n]||typeof a[n]!="object"||Array.isArray(a[n])||a[n]instanceof File)&&(a[n]=Object.create(null)),a=a[n])})},Ct=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Jt=e=>{const{groups:t,path:s}=es(e),a=Ct(s);return ts(a,t)},es=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const r=`@${a}`;return t.push([r,s]),r}),{groups:t,path:e}},ts=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let r=e.length-1;r>=0;r--)if(e[r].includes(a)){e[r]=e[r].replace(a,t[s][1]);break}}return e},Xe={},ss=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return Xe[a]||(s[2]?Xe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Xe[a]=[e,s[1],!0]),Xe[a]}return null},ct=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},as=e=>ct(e,decodeURI),At=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const r=t.charCodeAt(a);if(r===37){const n=t.indexOf("?",a),o=t.slice(s,n===-1?void 0:n);return as(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(r===63)break}return t.slice(s,a)},ns=e=>{const t=At(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ie=(e,t,...s)=>(s.length&&(t=Ie(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),St=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))a+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){s.length===0&&a===""?s.push("/"):s.push(a);const n=r.replace("?","");a+="/"+n,s.push(a)}else a+="/"+r}),s.filter((r,n,o)=>o.indexOf(r)===n)},rt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?ct(e,Nt):e):e,It=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const l=e.charCodeAt(o+t.length+1);if(l===61){const c=o+t.length+2,i=e.indexOf("&",c);return rt(e.slice(c,i===-1?void 0:i))}else if(l==38||isNaN(l))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const r={};a??(a=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let l=e.indexOf("=",n);l>o&&o!==-1&&(l=-1);let c=e.slice(n+1,l===-1?o===-1?void 0:o:l);if(a&&(c=rt(c)),n=o,c==="")continue;let i;l===-1?i="":(i=e.slice(l+1,o===-1?void 0:o),a&&(i=rt(i))),s?(r[c]&&Array.isArray(r[c])||(r[c]=[]),r[c].push(i)):r[c]??(r[c]=i)}return t?r[t]:r},rs=It,os=(e,t)=>It(e,t,!0),Nt=decodeURIComponent,yt=e=>ct(e,Nt),Re,_,ce,Rt,Mt,it,me,bt,Lt=(bt=class{constructor(e,t="/",s=[[]]){x(this,ce);h(this,"raw");x(this,Re);x(this,_);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});x(this,me,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const r=Object.keys(t)[0];return r?t[r].then(n=>(r==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,y(this,_,s),y(this,Re,{})}param(e){return e?k(this,ce,Rt).call(this,e):k(this,ce,Mt).call(this)}query(e){return rs(this.url,e)}queries(e){return os(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Qt(this,e))}json(){return d(this,me).call(this,"text").then(e=>JSON.parse(e))}text(){return d(this,me).call(this,"text")}arrayBuffer(){return d(this,me).call(this,"arrayBuffer")}blob(){return d(this,me).call(this,"blob")}formData(){return d(this,me).call(this,"formData")}addValidatedData(e,t){d(this,Re)[e]=t}valid(e){return d(this,Re)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[_t](){return d(this,_)}get matchedRoutes(){return d(this,_)[0].map(([[,e]])=>e)}get routePath(){return d(this,_)[0].map(([[,e]])=>e)[this.routeIndex].path}},Re=new WeakMap,_=new WeakMap,ce=new WeakSet,Rt=function(e){const t=d(this,_)[0][this.routeIndex][1][e],s=k(this,ce,it).call(this,t);return s&&/\%/.test(s)?yt(s):s},Mt=function(){const e={},t=Object.keys(d(this,_)[0][this.routeIndex][1]);for(const s of t){const a=k(this,ce,it).call(this,d(this,_)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?yt(a):a)}return e},it=function(e){return d(this,_)[1]?d(this,_)[1][e]:e},me=new WeakMap,bt),is={Stringify:1},Tt=async(e,t,s,a,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(r?r[0]+=e:r=[e],Promise.all(n.map(l=>l({phase:t,buffer:r,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(c=>Tt(c,t,!1,a,r))).then(()=>r[0]))):Promise.resolve(e)},ls="text/plain; charset=UTF-8",ot=(e,t)=>({"Content-Type":e,...t}),He,Ye,re,Me,oe,B,Ke,Te,De,ve,Ve,_e,ue,Ne,xt,cs=(xt=class{constructor(e,t){x(this,ue);x(this,He);x(this,Ye);h(this,"env",{});x(this,re);h(this,"finalized",!1);h(this,"error");x(this,Me);x(this,oe);x(this,B);x(this,Ke);x(this,Te);x(this,De);x(this,ve);x(this,Ve);x(this,_e);h(this,"render",(...e)=>(d(this,Te)??y(this,Te,t=>this.html(t)),d(this,Te).call(this,...e)));h(this,"setLayout",e=>y(this,Ke,e));h(this,"getLayout",()=>d(this,Ke));h(this,"setRenderer",e=>{y(this,Te,e)});h(this,"header",(e,t,s)=>{this.finalized&&y(this,B,new Response(d(this,B).body,d(this,B)));const a=d(this,B)?d(this,B).headers:d(this,ve)??y(this,ve,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});h(this,"status",e=>{y(this,Me,e)});h(this,"set",(e,t)=>{d(this,re)??y(this,re,new Map),d(this,re).set(e,t)});h(this,"get",e=>d(this,re)?d(this,re).get(e):void 0);h(this,"newResponse",(...e)=>k(this,ue,Ne).call(this,...e));h(this,"body",(e,t,s)=>k(this,ue,Ne).call(this,e,t,s));h(this,"text",(e,t,s)=>!d(this,ve)&&!d(this,Me)&&!t&&!s&&!this.finalized?new Response(e):k(this,ue,Ne).call(this,e,t,ot(ls,s)));h(this,"json",(e,t,s)=>k(this,ue,Ne).call(this,JSON.stringify(e),t,ot("application/json",s)));h(this,"html",(e,t,s)=>{const a=r=>k(this,ue,Ne).call(this,r,t,ot("text/html; charset=UTF-8",s));return typeof e=="object"?Tt(e,is.Stringify,!1,{}).then(a):a(e)});h(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});h(this,"notFound",()=>(d(this,De)??y(this,De,()=>new Response),d(this,De).call(this,this)));y(this,He,e),t&&(y(this,oe,t.executionCtx),this.env=t.env,y(this,De,t.notFoundHandler),y(this,_e,t.path),y(this,Ve,t.matchResult))}get req(){return d(this,Ye)??y(this,Ye,new Lt(d(this,He),d(this,_e),d(this,Ve))),d(this,Ye)}get event(){if(d(this,oe)&&"respondWith"in d(this,oe))return d(this,oe);throw Error("This context has no FetchEvent")}get executionCtx(){if(d(this,oe))return d(this,oe);throw Error("This context has no ExecutionContext")}get res(){return d(this,B)||y(this,B,new Response(null,{headers:d(this,ve)??y(this,ve,new Headers)}))}set res(e){if(d(this,B)&&e){e=new Response(e.body,e);for(const[t,s]of d(this,B).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=d(this,B).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of a)e.headers.append("set-cookie",r)}else e.headers.set(t,s)}y(this,B,e),this.finalized=!0}get var(){return d(this,re)?Object.fromEntries(d(this,re)):{}}},He=new WeakMap,Ye=new WeakMap,re=new WeakMap,Me=new WeakMap,oe=new WeakMap,B=new WeakMap,Ke=new WeakMap,Te=new WeakMap,De=new WeakMap,ve=new WeakMap,Ve=new WeakMap,_e=new WeakMap,ue=new WeakSet,Ne=function(e,t,s){const a=d(this,B)?new Headers(d(this,B).headers):d(this,ve)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,l]of n)o.toLowerCase()==="set-cookie"?a.append(o,l):a.set(o,l)}if(s)for(const[n,o]of Object.entries(s))if(typeof o=="string")a.set(n,o);else{a.delete(n);for(const l of o)a.append(n,l)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??d(this,Me);return new Response(e,{status:r,headers:a})},xt),O="ALL",ds="all",ps=["get","post","put","delete","options","patch"],Dt="Can not add a route since the matcher is already built.",Ot=class extends Error{},ms="__COMPOSED_HANDLER",us=e=>e.text("404 Not Found",404),ht=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},q,P,Pt,J,be,Ze,qe,Oe,gs=(Oe=class{constructor(t={}){x(this,P);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");x(this,q,"/");h(this,"routes",[]);x(this,J,us);h(this,"errorHandler",ht);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(y(this,J,t),this));h(this,"fetch",(t,...s)=>k(this,P,qe).call(this,t,s[1],s[0],t.method));h(this,"request",(t,s,a,r)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ie("/",t)}`,s),a,r)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(k(this,P,qe).call(this,t.request,t,void 0,t.request.method))})});[...ps,ds].forEach(n=>{this[n]=(o,...l)=>(typeof o=="string"?y(this,q,o):k(this,P,be).call(this,n,d(this,q),o),l.forEach(c=>{k(this,P,be).call(this,n,d(this,q),c)}),this)}),this.on=(n,o,...l)=>{for(const c of[o].flat()){y(this,q,c);for(const i of[n].flat())l.map(p=>{k(this,P,be).call(this,i.toUpperCase(),d(this,q),p)})}return this},this.use=(n,...o)=>(typeof n=="string"?y(this,q,n):(y(this,q,"*"),o.unshift(n)),o.forEach(l=>{k(this,P,be).call(this,O,d(this,q),l)}),this);const{strict:a,...r}=t;Object.assign(this,r),this.getPath=a??!0?t.getPath??At:ns}route(t,s){const a=this.basePath(t);return s.routes.map(r=>{var o;let n;s.errorHandler===ht?n=r.handler:(n=async(l,c)=>(await gt([],s.errorHandler)(l,()=>r.handler(l,c))).res,n[ms]=r.handler),k(o=a,P,be).call(o,r.method,r.path,n)}),this}basePath(t){const s=k(this,P,Pt).call(this);return s._basePath=Ie(this._basePath,t),s}mount(t,s,a){let r,n;a&&(typeof a=="function"?n=a:(n=a.optionHandler,a.replaceRequest===!1?r=c=>c:r=a.replaceRequest));const o=n?c=>{const i=n(c);return Array.isArray(i)?i:[i]}:c=>{let i;try{i=c.executionCtx}catch{}return[c.env,i]};r||(r=(()=>{const c=Ie(this._basePath,t),i=c==="/"?0:c.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(i)||"/",new Request(u,p)}})());const l=async(c,i)=>{const p=await s(r(c.req.raw),...o(c));if(p)return p;await i()};return k(this,P,be).call(this,O,Ie(t,"*"),l),this}},q=new WeakMap,P=new WeakSet,Pt=function(){const t=new Oe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,y(t,J,d(this,J)),t.routes=this.routes,t},J=new WeakMap,be=function(t,s,a){t=t.toUpperCase(),s=Ie(this._basePath,s);const r={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,r]),this.routes.push(r)},Ze=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},qe=function(t,s,a,r){if(r==="HEAD")return(async()=>new Response(null,await k(this,P,qe).call(this,t,s,a,"GET")))();const n=this.getPath(t,{env:a}),o=this.router.match(r,n),l=new cs(t,{path:n,matchResult:o,env:a,executionCtx:s,notFoundHandler:d(this,J)});if(o[0].length===1){let i;try{i=o[0][0][0][0](l,async()=>{l.res=await d(this,J).call(this,l)})}catch(p){return k(this,P,Ze).call(this,p,l)}return i instanceof Promise?i.then(p=>p||(l.finalized?l.res:d(this,J).call(this,l))).catch(p=>k(this,P,Ze).call(this,p,l)):i??d(this,J).call(this,l)}const c=gt(o[0],this.errorHandler,d(this,J));return(async()=>{try{const i=await c(l);if(!i.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return i.res}catch(i){return k(this,P,Ze).call(this,i,l)}})()},Oe),Ft=[];function ys(e,t){const s=this.buildAllMatchers(),a=((r,n)=>{const o=s[r]||s[O],l=o[2][n];if(l)return l;const c=n.match(o[0]);if(!c)return[[],Ft];const i=c.indexOf("",1);return[o[1][i],c]});return this.match=a,a(e,t)}var et="[^/]+",Be=".*",$e="(?:|/.*)",Le=Symbol(),hs=new Set(".\\+*[^]$()");function fs(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Be||e===$e?1:t===Be||t===$e?-1:e===et?1:t===et?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,ke,ee,Ae,bs=(Ae=class{constructor(){x(this,we);x(this,ke);x(this,ee,Object.create(null))}insert(t,s,a,r,n){if(t.length===0){if(d(this,we)!==void 0)throw Le;if(n)return;y(this,we,s);return}const[o,...l]=t,c=o==="*"?l.length===0?["","",Be]:["","",et]:o==="/*"?["","",$e]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let i;if(c){const p=c[1];let u=c[2]||et;if(p&&c[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw Le;if(i=d(this,ee)[u],!i){if(Object.keys(d(this,ee)).some(g=>g!==Be&&g!==$e))throw Le;if(n)return;i=d(this,ee)[u]=new Ae,p!==""&&y(i,ke,r.varIndex++)}!n&&p!==""&&a.push([p,d(i,ke)])}else if(i=d(this,ee)[o],!i){if(Object.keys(d(this,ee)).some(p=>p.length>1&&p!==Be&&p!==$e))throw Le;if(n)return;i=d(this,ee)[o]=new Ae}i.insert(l,s,a,r,n)}buildRegExpStr(){const s=Object.keys(d(this,ee)).sort(fs).map(a=>{const r=d(this,ee)[a];return(typeof d(r,ke)=="number"?`(${a})@${d(r,ke)}`:hs.has(a)?`\\${a}`:a)+r.buildRegExpStr()});return typeof d(this,we)=="number"&&s.unshift(`#${d(this,we)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},we=new WeakMap,ke=new WeakMap,ee=new WeakMap,Ae),tt,Qe,vt,xs=(vt=class{constructor(){x(this,tt,{varIndex:0});x(this,Qe,new bs)}insert(e,t,s){const a=[],r=[];for(let o=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const i=`@\\${o}`;return r[o]=[i,c],o++,l=!0,i}),!l)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=r.length-1;o>=0;o--){const[l]=r[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(l)!==-1){n[c]=n[c].replace(l,r[o][1]);break}}return d(this,Qe).insert(n,t,a,d(this,tt),s),a}buildRegExp(){let e=d(this,Qe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,n,o)=>n!==void 0?(s[++t]=Number(n),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),s,a]}},tt=new WeakMap,Qe=new WeakMap,vt),vs=[/^$/,[],Object.create(null)],Je=Object.create(null);function jt(e){return Je[e]??(Je[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ws(){Je=Object.create(null)}function ks(e){var i;const t=new xs,s=[];if(e.length===0)return vs;const a=e.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[g,f])=>p?1:g?-1:u.length-f.length),r=Object.create(null);for(let p=0,u=-1,g=a.length;p<g;p++){const[f,I,w]=a[p];f?r[I]=[w.map(([v])=>[v,Object.create(null)]),Ft]:u++;let b;try{b=t.insert(I,u,f)}catch(v){throw v===Le?new Ot(I):v}f||(s[u]=w.map(([v,N])=>{const D=Object.create(null);for(N-=1;N>=0;N--){const[te,M]=b[N];D[te]=M}return[v,D]}))}const[n,o,l]=t.buildRegExp();for(let p=0,u=s.length;p<u;p++)for(let g=0,f=s[p].length;g<f;g++){const I=(i=s[p][g])==null?void 0:i[1];if(!I)continue;const w=Object.keys(I);for(let b=0,v=w.length;b<v;b++)I[w[b]]=l[I[w[b]]]}const c=[];for(const p in o)c[p]=s[o[p]];return[n,c,r]}function Se(e,t){if(e){for(const s of Object.keys(e).sort((a,r)=>r.length-a.length))if(jt(s).test(t))return[...e[s]]}}var ge,ye,st,Ut,wt,Es=(wt=class{constructor(){x(this,st);h(this,"name","RegExpRouter");x(this,ge);x(this,ye);h(this,"match",ys);y(this,ge,{[O]:Object.create(null)}),y(this,ye,{[O]:Object.create(null)})}add(e,t,s){var l;const a=d(this,ge),r=d(this,ye);if(!a||!r)throw new Error(Dt);a[e]||[a,r].forEach(c=>{c[e]=Object.create(null),Object.keys(c[O]).forEach(i=>{c[e][i]=[...c[O][i]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=jt(t);e===O?Object.keys(a).forEach(i=>{var p;(p=a[i])[t]||(p[t]=Se(a[i],t)||Se(a[O],t)||[])}):(l=a[e])[t]||(l[t]=Se(a[e],t)||Se(a[O],t)||[]),Object.keys(a).forEach(i=>{(e===O||e===i)&&Object.keys(a[i]).forEach(p=>{c.test(p)&&a[i][p].push([s,n])})}),Object.keys(r).forEach(i=>{(e===O||e===i)&&Object.keys(r[i]).forEach(p=>c.test(p)&&r[i][p].push([s,n]))});return}const o=St(t)||[t];for(let c=0,i=o.length;c<i;c++){const p=o[c];Object.keys(r).forEach(u=>{var g;(e===O||e===u)&&((g=r[u])[p]||(g[p]=[...Se(a[u],p)||Se(a[O],p)||[]]),r[u][p].push([s,n-i+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(d(this,ye)).concat(Object.keys(d(this,ge))).forEach(t=>{e[t]||(e[t]=k(this,st,Ut).call(this,t))}),y(this,ge,y(this,ye,void 0)),ws(),e}},ge=new WeakMap,ye=new WeakMap,st=new WeakSet,Ut=function(e){const t=[];let s=e===O;return[d(this,ge),d(this,ye)].forEach(a=>{const r=a[e]?Object.keys(a[e]).map(n=>[n,a[e][n]]):[];r.length!==0?(s||(s=!0),t.push(...r)):e!==O&&t.push(...Object.keys(a[O]).map(n=>[n,a[O][n]]))}),s?ks(t):null},wt),he,ie,kt,Cs=(kt=class{constructor(e){h(this,"name","SmartRouter");x(this,he,[]);x(this,ie,[]);y(this,he,e.routers)}add(e,t,s){if(!d(this,ie))throw new Error(Dt);d(this,ie).push([e,t,s])}match(e,t){if(!d(this,ie))throw new Error("Fatal error");const s=d(this,he),a=d(this,ie),r=s.length;let n=0,o;for(;n<r;n++){const l=s[n];try{for(let c=0,i=a.length;c<i;c++)l.add(...a[c]);o=l.match(e,t)}catch(c){if(c instanceof Ot)continue;throw c}this.match=l.match.bind(l),y(this,he,[l]),y(this,ie,void 0);break}if(n===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(d(this,ie)||d(this,he).length!==1)throw new Error("No active router has been determined yet.");return d(this,he)[0]}},he=new WeakMap,ie=new WeakMap,kt),We=Object.create(null),fe,G,Ee,Pe,U,le,xe,Fe,As=(Fe=class{constructor(t,s,a){x(this,le);x(this,fe);x(this,G);x(this,Ee);x(this,Pe,0);x(this,U,We);if(y(this,G,a||Object.create(null)),y(this,fe,[]),t&&s){const r=Object.create(null);r[t]={handler:s,possibleKeys:[],score:0},y(this,fe,[r])}y(this,Ee,[])}insert(t,s,a){y(this,Pe,++ut(this,Pe)._);let r=this;const n=Jt(s),o=[];for(let l=0,c=n.length;l<c;l++){const i=n[l],p=n[l+1],u=ss(i,p),g=Array.isArray(u)?u[0]:i;if(g in d(r,G)){r=d(r,G)[g],u&&o.push(u[1]);continue}d(r,G)[g]=new Fe,u&&(d(r,Ee).push(u),o.push(u[1])),r=d(r,G)[g]}return d(r,fe).push({[t]:{handler:a,possibleKeys:o.filter((l,c,i)=>i.indexOf(l)===c),score:d(this,Pe)}}),r}search(t,s){var c;const a=[];y(this,U,We);let n=[this];const o=Ct(s),l=[];for(let i=0,p=o.length;i<p;i++){const u=o[i],g=i===p-1,f=[];for(let I=0,w=n.length;I<w;I++){const b=n[I],v=d(b,G)[u];v&&(y(v,U,d(b,U)),g?(d(v,G)["*"]&&a.push(...k(this,le,xe).call(this,d(v,G)["*"],t,d(b,U))),a.push(...k(this,le,xe).call(this,v,t,d(b,U)))):f.push(v));for(let N=0,D=d(b,Ee).length;N<D;N++){const te=d(b,Ee)[N],M=d(b,U)===We?{}:{...d(b,U)};if(te==="*"){const H=d(b,G)["*"];H&&(a.push(...k(this,le,xe).call(this,H,t,d(b,U))),y(H,U,M),f.push(H));continue}const[se,je,pe]=te;if(!u&&!(pe instanceof RegExp))continue;const $=d(b,G)[se],Ue=o.slice(i).join("/");if(pe instanceof RegExp){const H=pe.exec(Ue);if(H){if(M[je]=H[0],a.push(...k(this,le,xe).call(this,$,t,d(b,U),M)),Object.keys(d($,G)).length){y($,U,M);const ze=((c=H[0].match(/\//))==null?void 0:c.length)??0;(l[ze]||(l[ze]=[])).push($)}continue}}(pe===!0||pe.test(u))&&(M[je]=u,g?(a.push(...k(this,le,xe).call(this,$,t,M,d(b,U))),d($,G)["*"]&&a.push(...k(this,le,xe).call(this,d($,G)["*"],t,M,d(b,U)))):(y($,U,M),f.push($)))}}n=f.concat(l.shift()??[])}return a.length>1&&a.sort((i,p)=>i.score-p.score),[a.map(({handler:i,params:p})=>[i,p])]}},fe=new WeakMap,G=new WeakMap,Ee=new WeakMap,Pe=new WeakMap,U=new WeakMap,le=new WeakSet,xe=function(t,s,a,r){const n=[];for(let o=0,l=d(t,fe).length;o<l;o++){const c=d(t,fe)[o],i=c[s]||c[O],p={};if(i!==void 0&&(i.params=Object.create(null),n.push(i),a!==We||r&&r!==We))for(let u=0,g=i.possibleKeys.length;u<g;u++){const f=i.possibleKeys[u],I=p[i.score];i.params[f]=r!=null&&r[f]&&!I?r[f]:a[f]??(r==null?void 0:r[f]),p[i.score]=!0}}return n},Fe),Ce,Et,Ss=(Et=class{constructor(){h(this,"name","TrieRouter");x(this,Ce);y(this,Ce,new As)}add(e,t,s){const a=St(t);if(a){for(let r=0,n=a.length;r<n;r++)d(this,Ce).insert(e,a[r],s);return}d(this,Ce).insert(e,t,s)}match(e,t){return d(this,Ce).search(e,t)}},Ce=new WeakMap,Et),Gt=class extends gs{constructor(e={}){super(e),this.router=e.router??new Cs({routers:[new Es,new Ss]})}},Is=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(s.origin),r=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(s.allowMethods);return async function(o,l){var p;function c(u,g){o.res.headers.set(u,g)}const i=await a(o.req.header("origin")||"",o);if(i&&c("Access-Control-Allow-Origin",i),s.credentials&&c("Access-Control-Allow-Credentials","true"),(p=s.exposeHeaders)!=null&&p.length&&c("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),o.req.method==="OPTIONS"){s.origin!=="*"&&c("Vary","Origin"),s.maxAge!=null&&c("Access-Control-Max-Age",s.maxAge.toString());const u=await r(o.req.header("origin")||"",o);u.length&&c("Access-Control-Allow-Methods",u.join(","));let g=s.allowHeaders;if(!(g!=null&&g.length)){const f=o.req.header("Access-Control-Request-Headers");f&&(g=f.split(/\s*,\s*/))}return g!=null&&g.length&&(c("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};const E=new Gt;E.use("/api/*",Is());const Wt="e77554988b424c6498d85362b0367757",lt="https://www.streak.com/api/v1",F={mabsilico:{name:"MabSilico",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw",networkSheetGid:"910674612",sources:{promote:"",network:"https://docs.google.com/spreadsheets/d/1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw/edit?gid=910674612#gid=910674612",engage:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgOqI26zZCAw"}},"finance-montreal":{name:"Finance Montreal (Steve)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgI7YkpykCQw"},"apm-music":{name:"APM Music",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgIClnNb8gwsM"},ducrocq:{name:"Ducrocq",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgNaSl4OGCww"},milvue:{name:"Milvue",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgMX-7baZCgw"},seekyo:{name:"Seekyo Therapeutics",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgLnYo_uUCww"},altavia:{name:"Altavia",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICFz_elmwgM"},valos:{name:"Valos",pipelineKey:"agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyRAsSDE9yZ2FuaXphdGlvbiIdYWluYS5hbmRyaWFtYW5nYXNvbkBnbWFpbC5jb20MCxIIV29ya2Zsb3cYgICF5ei7lgkM"},"dab-embedded":{name:"DAB-Embedded",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWyqIboCww"},"finance-montreal-noza":{name:"Finance Montreal (Noza)",pipelineKey:"agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw",url:"https://www.streak.com/a/pipelines/agxzfm1haWxmb29nYWVyNwsSDE9yZ2FuaXphdGlvbiIQb2F0dGlhQGdtYWlsLmNvbQwLEghXb3JrZmxvdxiAgKWVvvDkCgw"}},Y=F.mabsilico.pipelineKey;F.mabsilico.name;const Bt="Fit",$t="Interest",Ns="1NzUlKfHTW6v7i-S59GjtBFlzQwTX2AaeK4gQ4fVSAsw",Ls=`https://docs.google.com/spreadsheets/d/${Ns}/export?format=csv`;async function de(e,t){return F[t]}async function A(e){const t=btoa(`${Wt}:`);console.log(`[Streak API] Calling: ${e}`);const s=await fetch(`${lt}${e}`,{headers:{Authorization:`Basic ${t}`,"Content-Type":"application/json"}});if(console.log(`[Streak API] Response status: ${s.status}`),!s.ok){const a=await s.text();throw console.error(`[Streak API] Error: ${s.status} - ${a}`),new Error(`Streak API error: ${s.status} ${s.statusText}`)}return s.json()}async function Rs(e){try{const t=`${Ls}&gid=${e}`,s=await fetch(t);if(!s.ok)throw new Error(`Google Sheets error: ${s.statusText}`);const r=(await s.text()).split(`
`).filter(w=>w.trim()),n=[];for(let w=1;w<r.length;w++){const v=r[w].split(",");if(v.length>=9&&v[3]&&v[3].trim()){const N=parseInt(v[3])||0,D=parseInt(v[4])||0,te=v[7]?v[7].replace("%","").trim():"0",M=parseFloat(te)||0;n.push({week:v[0],from:v[1],to:v[2],invitations:N,messages:D,acceptance:M,opportunities:parseInt(v[8])||0})}}const o=n.reduce((w,b)=>w+b.invitations,0),l=n.reduce((w,b)=>{const v=Math.min(b.acceptance,100);return w+Math.round(b.invitations*v/100)},0),c=n.map(w=>Math.min(w.acceptance,100)),i=c.length>0?c.reduce((w,b)=>w+b,0)/c.length:0,p=20,u=i>0?i/p*100:0,g=n.slice(-4),f=n[n.length-1]||{invitations:0,acceptance:0},I=n[n.length-2]||{invitations:0,acceptance:0};return{totalInvitations:o,totalAccepted:l,avgAcceptanceRate:Math.round(i*10)/10,networkObjective:p,objectiveAchievement:Math.round(u*10)/10,thisWeek:{invitations:f.invitations,acceptance:Math.min(f.acceptance,100)},lastWeek:{invitations:I.invitations,acceptance:Math.min(I.acceptance,100)},recentWeeks:g.map(w=>({...w,acceptance:Math.min(w.acceptance,100)})),allData:n}}catch(t){return console.error("Error fetching network data:",t),{totalInvitations:0,totalAccepted:0,avgAcceptanceRate:0,thisWeek:{invitations:0,acceptance:0},lastWeek:{invitations:0,acceptance:0},recentWeeks:[],allData:[]}}}E.get("/api/pipeline",async e=>{try{const t=await A(`/pipelines/${Y}`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});E.get("/api/boxes",async e=>{try{const t=await A(`/pipelines/${Y}/boxes`);return e.json(t)}catch(t){return e.json({error:t.message},500)}});E.get("/api/boxes/:boxKey",async e=>{try{const t=e.req.param("boxKey"),s=await A(`/boxes/${t}`);return e.json(s)}catch(t){return e.json({error:t.message},500)}});E.get("/api/sheets/stage/:stageName/count",async e=>{try{const t=e.req.param("stageName"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),r=s.stageOrder||[],n=Array.isArray(r)?r.map(l=>{var c,i;return{key:l,name:((i=(c=s.stages)==null?void 0:c[l])==null?void 0:i.name)||"Unknown"}}):[],o=Array.isArray(a)?a.filter(l=>{const c=n.find(i=>i&&i.key===l.stageKey);return c&&c.name.toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/priority/:priorityName/count",async e=>{try{const t=e.req.param("priorityName"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name==="Priority"),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="no priority";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"No Priority").toLowerCase().includes(t.toLowerCase())}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/country/:countryName/count",async e=>{try{const t=e.req.param("countryName"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name==="Country"),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="unknown";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"Unknown").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/total",async e=>{try{const t=await A(`/pipelines/${Y}/boxes`),s=Array.isArray(t)?t.length:0;return e.text(s.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/freshness/:level/count",async e=>{try{const t=e.req.param("level").toLowerCase(),s=await A(`/pipelines/${Y}/boxes`),a=Array.isArray(s)?s.filter(r=>{const n=r.freshness||0;return t==="high"?n>.5:t==="medium"?n>=.2&&n<=.5:t==="low"?n<.2:!1}).length:0;return e.text(a.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/fit/:fitLevel/count",async e=>{try{const t=e.req.param("fitLevel"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name===Bt),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="not set";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/interest/:interestLevel/count",async e=>{try{const t=e.req.param("interestLevel"),[s,a]=await Promise.all([A(`/pipelines/${Y}`),A(`/pipelines/${Y}/boxes`)]),n=(Array.isArray(s.fields)?s.fields:[]).find(l=>l&&l.name===$t),o=Array.isArray(a)?a.filter(l=>{var g;if(!n||!l.fields||!l.fields[n.key])return t.toLowerCase()==="not set";const c=l.fields[n.key],i=(g=n.dropdownSettings)==null?void 0:g.items,p=Array.isArray(i)?i.find(f=>f&&f.key===c):null;return(p?p.name:"Not Set").toLowerCase()===t.toLowerCase()}).length:0;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/companies",async e=>{try{const t=Object.keys(F).map(s=>{var a,r,n;return{key:s,name:F[s].name,url:F[s].url,pipeline_key:F[s].pipelineKey,promote_url:((a=F[s].sources)==null?void 0:a.promote)||null,network_url:((r=F[s].sources)==null?void 0:r.network)||null,network_sheet_gid:F[s].networkSheetGid||null,engage_url:((n=F[s].sources)==null?void 0:n.engage)||null,notion_url:F[s].notionUrl||null}});return e.json({companies:t,count:t.length})}catch(t){return console.error("Error fetching companies:",t),e.json({error:"Failed to fetch companies",companies:[],count:0},500)}});E.post("/api/companies",async e=>{try{const t=await e.req.json(),{key:s,name:a,pipeline_key:r,url:n,promote_url:o,network_url:l,network_sheet_gid:c,engage_url:i,notion_url:p}=t;return!s||!a||!r||!n?e.json({error:"Missing required fields: key, name, pipeline_key, url"},400):F[s]?e.json({error:"Company with this key already exists"},409):(F[s]={name:a,pipelineKey:r,url:n,networkSheetGid:c||null,notionUrl:p||null,sources:{promote:o||"",network:l||"",engage:i||""}},e.json({success:!0,message:"Company added successfully (session only)",key:s}))}catch(t){return console.error("Error adding company:",t),e.json({error:"Failed to add company"},500)}});E.delete("/api/companies/:key",async e=>{try{const t=e.req.param("key");return F[t]?(delete F[t],e.json({success:!0,message:"Company deleted successfully (session only)"})):e.json({error:"Company not found"},404)}catch(t){return console.error("Error deleting company:",t),e.json({error:"Failed to delete company"},500)}});E.put("/api/companies/:key",async e=>{try{const t=e.req.param("key"),s=await e.req.json(),{name:a,pipeline_key:r,url:n,promote_url:o,network_url:l,network_sheet_gid:c,engage_url:i,notion_url:p}=s;return F[t]?(F[t]={name:a,pipelineKey:r,url:n,networkSheetGid:c||null,notionUrl:p||null,sources:{promote:o||"",network:l||"",engage:i||""}},e.json({success:!0,message:"Company updated successfully (session only)"})):e.json({error:"Company not found"},404)}catch(t){return console.error("Error updating company:",t),e.json({error:"Failed to update company"},500)}});E.get("/api/sheets/:companyName/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.text("COMPANY_NOT_FOUND");const a=await A(`/pipelines/${s.pipelineKey}/boxes`),r=Array.isArray(a)?a.length:0;return e.text(r.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/:companyName/month/:yearMonth/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=e.req.param("yearMonth"),a=await de(void 0,t);if(!a)return e.text("COMPANY_NOT_FOUND");const r=await A(`/pipelines/${a.pipelineKey}/boxes`),[n,o]=s.split("-").map(Number),l=Array.isArray(r)?r.filter(c=>{const i=new Date(c.creationTimestamp);return i.getFullYear()===n&&i.getMonth()+1===o}).length:0;return e.text(l.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/:companyName/week/count",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.text("ERROR");const a=await A(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a))return e.text("0");const n=Date.now()-10080*60*1e3,o=a.filter(l=>(l.creationTimestamp||0)>=n).length;return e.text(o.toString())}catch{return e.text("ERROR")}});E.get("/api/sheets/:companyName/duration/total",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.text("0");const a=await A(`/pipelines/${s.pipelineKey}/boxes`);if(!Array.isArray(a)||a.length===0)return e.text("0");const r=a.map(u=>u.creationTimestamp).filter(u=>u);if(r.length===0)return e.text("0");const n=Math.min(...r),o=new Date(n),l=new Date,c=l.getFullYear()-o.getFullYear(),i=l.getMonth()-o.getMonth(),p=c*12+i+1;return e.text(p.toString())}catch{return e.text("0")}});E.get("/api/sheets/:companyName/monthly-stats",async e=>{try{const t=e.req.param("companyName").toLowerCase(),s=await de(void 0,t);if(!s)return e.json({error:"Company not found"},404);const a=await A(`/pipelines/${s.pipelineKey}/boxes`),r=Array.isArray(a)?a:[],n=new Date,o=[];for(let p=11;p>=0;p--){const u=new Date(n.getFullYear(),n.getMonth()-p,1),g=u.getFullYear(),f=u.getMonth()+1,I=r.filter(b=>{const v=new Date(b.creationTimestamp);return v.getFullYear()===g&&v.getMonth()+1===f}).length,w=(I/10*100).toFixed(1);o.push({month:`${g}-${String(f).padStart(2,"0")}`,count:I,objective:10,percentage:parseFloat(w)})}const l=o.reduce((p,u)=>p+u.count,0),c=(l/12).toFixed(1),i=(parseFloat(c)/10*100).toFixed(1);return e.json({company:s.name,companyKey:t,objective:10,monthlyStats:o,summary:{totalLeads:l,average:parseFloat(c),averagePercentage:parseFloat(i)}})}catch(t){return e.json({error:t.message},500)}});E.get("/api/sheets/:companyName/due",async e=>{try{const t=e.req.param("companyName").toLowerCase().replace(/ /g,"-"),s=await de(void 0,t);if(!s)return e.text("COMPANY_NOT_FOUND");const[a,r]=await Promise.all([A(`/pipelines/${s.pipelineKey}`),A(`/pipelines/${s.pipelineKey}/boxes`)]);if(!Array.isArray(r))return e.text("0");const o=(Array.isArray(a.fields)?a.fields:[]).find(i=>i&&(i.name==="Est Start Date"||i.name==="Due Date"||i.name==="Start Date"));if(!o)return e.text("0");const l=Date.now();let c=0;return r.forEach(i=>{i.fields&&i.fields[o.key]&&i.fields[o.key]&&c++}),e.text(c.toString())}catch(t){return console.error("Error fetching due items:",t),e.text("ERROR")}});E.get("/api/sheets/:companyName/overdue",async e=>{try{const t=e.req.param("companyName").toLowerCase().replace(/ /g,"-"),s=await de(void 0,t);if(!s)return e.text("COMPANY_NOT_FOUND");const[a,r]=await Promise.all([A(`/pipelines/${s.pipelineKey}`),A(`/pipelines/${s.pipelineKey}/boxes`)]);if(!Array.isArray(r))return e.text("0");const o=(Array.isArray(a.fields)?a.fields:[]).find(i=>i&&(i.name==="Est Start Date"||i.name==="Due Date"||i.name==="Start Date"));if(!o)return e.text("0");const l=Date.now();let c=0;return r.forEach(i=>{if(i.fields&&i.fields[o.key]){const p=i.fields[o.key];p&&p<l&&c++}}),e.text(c.toString())}catch(t){return console.error("Error fetching overdue items:",t),e.text("ERROR")}});E.get("/api/analytics",async e=>{try{const t=e.req.query("company")||"mabsilico",s=await de(void 0,t);if(!s)return e.json({error:"Invalid company key"},400);const a=s.pipelineKey,[r,n]=await Promise.all([A(`/pipelines/${a}`),A(`/pipelines/${a}/boxes`)]),o=Array.isArray(n)?n.length:0,l={},c={},i={},p={},u={},g={},f={"High (>0.5)":0,"Medium (0.2-0.5)":0,"Low (<0.2)":0},I=r.stageOrder||[],w=Array.isArray(I)?I.map(m=>{var R,W;return{key:m,name:((W=(R=r.stages)==null?void 0:R[m])==null?void 0:W.name)||"Unknown"}}):[],b=Array.isArray(r.fields)?r.fields:[],v=b.find(m=>m&&m.name==="Origin"),N=b.find(m=>m&&m.name===Bt),D=b.find(m=>m&&m.name===$t),te=b.find(m=>m&&m.name==="Est Start Date"),M=b.find(m=>m&&m.name==="Country"),se=b.find(m=>m&&m.name==="Language");Array.isArray(n)&&n.forEach(m=>{var V,ae,ne,Q,z;if(!m)return;const R=w.find(T=>T&&T.key===m.stageKey),W=R?R.name:"Unknown";if(l[W]=(l[W]||0)+1,v&&m.fields&&m.fields[v.key]){const T=m.fields[v.key],L=(V=v.dropdownSettings)==null?void 0:V.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Unknown";c[S]=(c[S]||0)+1}if(N&&m.fields&&m.fields[N.key]){const T=m.fields[N.key],L=(ae=N.dropdownSettings)==null?void 0:ae.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Not Set";i[S]=(i[S]||0)+1}else i["Not Set"]=(i["Not Set"]||0)+1;if(D&&m.fields&&m.fields[D.key]){const T=m.fields[D.key],L=(ne=D.dropdownSettings)==null?void 0:ne.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Not Set";p[S]=(p[S]||0)+1}else p["Not Set"]=(p["Not Set"]||0)+1;if(M&&m.fields&&m.fields[M.key]){const T=m.fields[M.key],L=(Q=M.dropdownSettings)==null?void 0:Q.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Unknown";u[S]=(u[S]||0)+1}else u.Unknown=(u.Unknown||0)+1;if(se&&m.fields&&m.fields[se.key]){const T=m.fields[se.key],L=(z=se.dropdownSettings)==null?void 0:z.items,j=Array.isArray(L)?L.find(C=>C&&C.key===T):null,S=j?j.name:"Unknown";g[S]=(g[S]||0)+1}else g.Unknown=(g.Unknown||0)+1;const K=m.freshness||0;K>.5?f["High (>0.5)"]++:K>=.2?f["Medium (0.2-0.5)"]++:f["Low (<0.2)"]++});const je={};Object.keys(i).forEach(m=>{je[m]=o>0?(i[m]/o*100).toFixed(1):0});const pe={};Object.keys(p).forEach(m=>{pe[m]=o>0?(p[m]/o*100).toFixed(1):0});const $=new Date,Ue=[],H=10;for(let m=11;m>=0;m--){const R=new Date($.getFullYear(),$.getMonth()-m,1),W=R.getFullYear(),K=R.getMonth()+1,V=Array.isArray(n)?n.filter(ne=>{const Q=new Date(ne.creationTimestamp);return Q.getFullYear()===W&&Q.getMonth()+1===K}).length:0,ae=(V/H*100).toFixed(1);Ue.push({month:`${W}-${String(K).padStart(2,"0")}`,monthName:R.toLocaleString("en-US",{month:"short",year:"numeric"}),count:V,objective:H,percentage:parseFloat(ae),status:V>=H?"achieved":"pending"})}const at=(Ue.reduce((m,R)=>m+R.count,0)/12).toFixed(1),Yt=(parseFloat(at)/H*100).toFixed(1);let dt=0,Ge=null;if(Array.isArray(n)&&n.length>0){const m=n.map(R=>R.creationTimestamp).filter(R=>R);if(m.length>0){const R=Math.min(...m);Ge=new Date(R);const W=$.getFullYear()-Ge.getFullYear(),K=$.getMonth()-Ge.getMonth();dt=W*12+K+1}}let pt=null;return s.networkSheetGid&&(pt=await Rs(s.networkSheetGid)),e.json({company:s.name,companyKey:t,totalBoxes:o,campaignDurationMonths:dt,firstLeadDate:Ge?Ge.toISOString():null,networkData:pt,stageDistribution:l,originDistribution:c,fitDistribution:i,fitPercentages:je,interestDistribution:p,interestPercentages:pe,countryDistribution:u,languageDistribution:g,freshnessDistribution:f,monthlyLeads:Ue,leadObjective:H,averageLeadsPerMonth:parseFloat(at),averagePercentage:parseFloat(Yt),recentBoxes:Array.isArray(n)?n.filter(m=>{var ae,ne;const R=N&&m.fields&&m.fields[N.key],W=D&&m.fields&&m.fields[D.key];let K="Not Set";if(R){const Q=m.fields[N.key],z=(ae=N.dropdownSettings)==null?void 0:ae.items,T=Array.isArray(z)?z.find(L=>L&&L.key===Q):null;K=T?T.name:"Not Set"}let V="Not Set";if(W){const Q=m.fields[D.key],z=(ne=D.dropdownSettings)==null?void 0:ne.items,T=Array.isArray(z)?z.find(L=>L&&L.key===Q):null;V=T?T.name:"Not Set"}return K==="High"||V==="High"}).slice(0,10).map(m=>{var z,T,L,j;const R=w.find(S=>S&&S.key===m.stageKey);let W="Not Set";if(N&&m.fields&&m.fields[N.key]){const S=m.fields[N.key],C=(z=N.dropdownSettings)==null?void 0:z.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;W=X?X.name:"Not Set"}let K="Not Set";if(D&&m.fields&&m.fields[D.key]){const S=m.fields[D.key],C=(T=D.dropdownSettings)==null?void 0:T.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;K=X?X.name:"Not Set"}let V=null;te&&m.fields&&m.fields[te.key]&&(V=new Date(m.fields[te.key]).toISOString());let ae="Unknown";if(M&&m.fields&&m.fields[M.key]){const S=m.fields[M.key],C=(L=M.dropdownSettings)==null?void 0:L.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;ae=X?X.name:"Unknown"}let ne="Unknown";if(se&&m.fields&&m.fields[se.key]){const S=m.fields[se.key],C=(j=se.dropdownSettings)==null?void 0:j.items,X=Array.isArray(C)?C.find(Z=>Z&&Z.key===S):null;ne=X?X.name:"Unknown"}const Q=m.freshness||0;return{name:m.name||"Unnamed",key:m.boxKey,stage:R?R.name:"Unknown",fit:W,interest:K,dueDate:V,country:ae,language:ne,freshness:Q.toFixed(3),lastUpdated:new Date(m.lastUpdatedTimestamp).toISOString()}}):[]})}catch(t){return e.json({error:t.message},500)}});E.get("/admin",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `));E.get("/api/test-streak",async e=>{try{const t=await de(void 0,"mabsilico");if(!t)return e.json({error:"Company not found"},404);const s=t.pipelineKey,a=await fetch(`${lt}/pipelines/${s}`,{headers:{Authorization:`Basic ${btoa(`${Wt}:`)}`,"Content-Type":"application/json"}}),r=a.status,n=a.statusText;if(!a.ok){const l=await a.text();return e.json({error:"Streak API failed",status:r,statusText:n,errorText:l,pipelineKey:s,apiBase:lt,endpoint:`/pipelines/${s}`},500)}const o=await a.json();return e.json({success:!0,status:r,company:t.name,pipelineKey:s,pipelineName:o.name||"Unknown",stageCount:o.stageOrder?o.stageOrder.length:0})}catch(t){return e.json({error:t.message,stack:t.stack},500)}});const ft=new Gt,Ms=Object.assign({"/src/index.tsx":E});let Ht=!1;for(const[,e]of Object.entries(Ms))e&&(ft.route("/",e),ft.notFound(e.notFoundHandler),Ht=!0);if(!Ht)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{ft as default};
